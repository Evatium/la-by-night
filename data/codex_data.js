window.CODEX_DATA = {
  "title": "LA by Night — Kindred Codex",
  "subtitle": "Los Angeles Chronicle Companion",
  "chronicle_year": "2024",
  "npcs": [
    {
      "id": 4,
      "name": "—\"—B—i—g—\"— —E—d— —H—u—r—l—e—y— ——— —S—e—n—e—s—c—h—a—l— —o—f— —L—o—s— —A—n—g—e—l—e—s—",
      "aliases": "—T—h—e— —P—r—i—n—c—e—'—s— —S—h—i—e—l—d—,— —T—h—e— —H—o—n—e—s—t— —B—r—u—j—a—h—,— —T—h—e— —U—n—i—o—n— —M—a—n—",
      "concept": "—L—o—y—a—l— —9—t—h—-—g—e—n—e—r—a—t—i—o—n— —B—r—u—j—a—h— —S—e—n—e—s—c—h—a—l— —o—f— —L—o—s— —A—n—g—e—l—e—s—;— —f—o—r—m—e—r— —u—n—i—o—n— —o—r—g—a—n—i—z—e—r— —w—h—o— —s—e—r—v—e—s— —a—s— —P—r—i—n—c—e— —M—e—r—e—d—i—t—h—'—s— —i—r—o—n— —s—h—i—e—l—d— —a—g—a—i—n—s—t— —S—e—t—h— —C—y—n—t—a—c—h—'—s— —s—h—a—d—o—w— —m—a—n—i—p—u—l—a—t—i—o—n—s—.—",
      "faction": "Camarilla",
      "clan": "Brujah",
      "portrait": "portraits/npc_4.webp",
      "tropes": [
        "—T—h—e— —H—o—n—e—s—t— —M—a—n— —i—n— —a— —D—e—n— —o—f— —L—i—a—r—s—",
        "—T—h—e— —W—o—r—k—i—n—g—-—C—l—a—s—s— —E—l—d—e—r—",
        "—T—h—e— —S—h—i—e—l—d— —W—h—o— —H—a—s— —O—p—i—n—i—o—n—s—"
      ],
      "functions": [
        "—R—e—l—i—a—b—l—e— —N—P—C— —a—l—l—y— —f—o—r— —P—C—s— —w—i—t—h— —i—n—t—e—g—r—i—t—y—.— —H—i—s— —s—u—p—p—o—r—t— —c—o—m—e—s— —w—i—t—h—o—u—t— —h—i—d—d—e—n— —a—g—e—n—d—a—s—.—",
        "—R—e—s—o—u—r—c—e— —f—o—r— —p—r—a—c—t—i—c—a—l— —h—e—l—p— ——— —v—e—h—i—c—l—e—s—,— —s—a—f—e— —h—o—u—s—e—s—,— —m—e—c—h—a—n—i—c—a—l— —e—x—p—e—r—t—i—s—e—.—",
        "—H—i—s— —w—a—t—c—h—f—u—l— —e—y—e— —o—n— —S—e—t—h— —m—a—k—e—s— —h—i—m— —a— —n—a—t—u—r—a—l— —c—o—n—s—p—i—r—a—t—o—r— —f—o—r— —l—i—m—i—t—i—n—g— —S—e—t—h—'—s— —p—o—w—e—r—.—",
        "—A—s— —S—e—n—e—s—c—h—a—l—,— —s—p—e—a—k—s— —w—i—t—h— —t—h—e— —P—r—i—n—c—e—'—s— —a—u—t—h—o—r—i—t—y— —i—n— —h—e—r— —a—b—s—e—n—c—e—.—"
      ]
    },
    {
      "id": 3,
      "name": "—A—m—a—n—d—a— —B—y—e—r—s— ——— —K—e—e—p—e—r— —o—f— —E—l—y—s—i—u—m—",
      "aliases": "—T—h—e— —I—n—v—i—s—i—b—l—e— —S—e—c—r—e—t—a—r—y—,— —T—h—e— —A—r—c—h—i—v—i—s—t—,— —T—h—e— —W—o—m—a—n— —o—f— —a— —T—h—o—u—s—a—n—d— —N—o—t—e—s—",
      "concept": "—S—h—a—r—p—,— —v—i—g—i—l—a—n—t— —1—1—t—h—-—g—e—n—e—r—a—t—i—o—n— —C—i—t—y— —G—a—n—g—r—e—l— —K—e—e—p—e—r— —o—f— —E—l—y—s—i—u—m—;— —f—i—e—r—c—e—l—y— —l—o—y—a—l— —t—o— —P—r—i—n—c—e— —M—e—r—e—d—i—t—h— —a—n—d— —d—e—d—i—c—a—t—e—d— —t—o— —k—e—e—p—i—n—g— —c—o—u—r—t— —g—r—o—u—n—d—s— —s—e—c—u—r—e— —f—r—o—m— —S—e—t—h— —C—y—n—t—a—c—h—'—s— —s—h—a—d—o—w— —r—e—a—c—h—.—",
      "faction": "Camarilla",
      "clan": "City Gangrel",
      "portrait": "portraits/npc_3.webp",
      "tropes": [
        "—T—h—e— —W—o—m—a—n— —W—h—o— —S—e—e—s— —E—v—e—r—y—t—h—i—n—g—",
        "—P—o—w—e—r— —T—h—r—o—u—g—h— —I—n—v—i—s—i—b—i—l—i—t—y—",
        "—T—h—e— —A—r—c—h—i—v—i—s—t— —a—s— —T—h—r—e—a—t—"
      ],
      "functions": [
        "—I—n—f—o—r—m—a—t—i—o—n— —b—r—o—k—e—r— ——— —r—e—c—o—r—d—s— —o—n— —e—v—e—r—y— —K—i—n—d—r—e—d— —i—n—t—e—r—a—c—t—i—o—n— —a—t— —E—l—y—s—i—u—m—.— —H—e—r— —a—r—c—h—i—v—e— —s—p—a—n—s— —d—e—c—a—d—e—s—.—",
        "—G—a—t—e—w—a—y— —t—o— —t—h—e— —P—r—i—n—c—e—.— —I—m—p—r—e—s—s—i—n—g— —o—r— —d—e—c—e—i—v—i—n—g— —h—e—r— —i—s— —r—e—q—u—i—r—e—d— —b—e—f—o—r—e— —g—a—i—n—i—n—g— —a—n— —a—u—d—i—e—n—c—e— —w—i—t—h— —M—e—r—e—d—i—t—h—.—",
        "—E—i—d—e—t—i—c— —M—e—m—o—r—y— —m—e—a—n—s— —s—h—e— —n—e—v—e—r— —f—o—r—g—e—t—s— —a— —s—l—i—g—h—t— —o—r— —a— —s—e—c—r—e—t—.— —D—a—n—g—e—r—o—u—s— —e—n—e—m—y—,— —i—n—v—a—l—u—a—b—l—e— —a—l—l—y—.—",
        "—C—o—n—t—r—o—l—s— —a—c—c—e—s—s— —t—o— —t—h—e— —D—o—r—o—t—h—y— —C—h—a—n—d—l—e—r— —P—a—v—i—l—i—o—n— ——— —t—h—e— —c—i—t—y—'—s— —p—r—i—m—a—r—y— —E—l—y—s—i—u—m—.—"
      ]
    },
    {
      "id": 2,
      "name": "—A—n—t—h—o—h—i—m—o—n—d—r—o—n—a— —T—s—u—o—r—a—n—o—a—n—n—d—d—y— ——— —S—h—e—r—i—f—f— —o—f— —L—o—s— —A—n—g—e—l—e—s—",
      "aliases": "—T—h—e— —I—m—p—l—a—c—a—b—l—e— —E—x—e—c—u—t—i—o—n—e—r—,— —T—h—e— —N—a—g—l—o—p—e—r—,— —T—h—e— —E—l—d—e—r—'—s— —H—o—u—n—d—",
      "concept": "—T—e—r—r—i—f—y—i—n—g— —7—t—h—-—g—e—n—e—r—a—t—i—o—n— —N—a—g—l—o—p—e—r— —S—h—e—r—i—f—f— —o—f— —L—o—s— —A—n—g—e—l—e—s—;— —m—o—n—s—t—r—o—u—s— —b—l—o—o—d—l—i—n—e— —e—n—f—o—r—c—e—r— —s—e—c—r—e—t—l—y— —l—o—y—a—l— —t—o— —S—e—t—h— —C—y—n—t—a—c—h— —w—h—o— —g—r—a—n—t—e—d— —h—i—m— —s—t—a—t—u—s—,— —t—i—t—l—e—s—,— —a—n—d— —a— —s—e—t—t—l—e—d— —u—n—l—i—f—e—.—",
      "faction": "Camarilla",
      "clan": "Nagloper (Tzimisce bloodline)",
      "portrait": "portraits/npc_2.webp",
      "tropes": [
        "—T—h—e— —U—n—s—t—o—p—p—a—b—l—e— —E—n—f—o—r—c—e—r—",
        "—T—h—e— —M—o—n—s—t—e—r— —i—n— —S—e—r—v—i—c—e—",
        "—T—h—e— —W—e—a—p—o—n— —W—i—t—h— —a— —S—e—c—r—e—t— —M—a—s—t—e—r—"
      ],
      "functions": [
        "—P—r—i—m—a—r—y— —p—h—y—s—i—c—a—l— —t—h—r—e—a—t— —o—f— —t—h—e— —C—a—m—a—r—i—l—l—a— ——— —t—h—e— —a—n—s—w—e—r— —t—o— —a—n—y— —c—h—a—l—l—e—n—g—e— —t—h—a—t— —c—a—n—n—o—t— —b—e— —a—n—s—w—e—r—e—d— —w—i—t—h— —w—o—r—d—s—.—",
        "—H—i—s— —s—e—c—r—e—t— —b—o—n—d— —i—s— —a— —l—o—n—g—-—b—u—r—n—i—n—g— —p—l—o—t— —b—o—m—b—.— —W—h—o—e—v—e—r— —c—o—n—t—r—o—l—s— —h—i—s— —h—i—d—d—e—n— —m—a—s—t—e—r— —c—o—n—t—r—o—l—s— —t—h—e— —c—i—t—y—'—s— —l—a—w— —e—n—f—o—r—c—e—m—e—n—t—.—",
        "—P—C—s— —w—h—o— —d—i—s—c—o—v—e—r— —h—i—s— —b—o—n—d—a—g—e— —g—a—i—n— —i—m—m—e—n—s—e— —l—e—v—e—r—a—g—e— —o—v—e—r— —t—h—e— —C—a—m—a—r—i—l—l—a—;— —t—h—o—s—e— —w—h—o— —d—o— —n—o—t— —a—r—e— —i—n— —c—o—n—s—t—a—n—t— —d—a—n—g—e—r—.—",
        "—H—i—s— —f—o—r—e—n—s—i—c— —s—k—i—l—l—s— —m—a—k—e— —h—i—m— —m—o—r—e— —t—h—a—n— —a— —b—r—u—t—e— ——— —h—e— —c—a—n— —t—r—a—c—k—,— —a—n—a—l—y—z—e—,— —a—n—d— —d—e—d—u—c—e— —w—i—t—h— —t—e—r—r—i—f—y—i—n—g— —p—r—e—c—i—s—i—o—n—.—"
      ]
    },
    {
      "id": 33,
      "name": "—A—r—m—a—n—d—o— —\"—N—i—n—e—s—\"— —R—o—d—r—i—g—u—e—z— ——— —A—n—a—r—c—h— —B—a—r—o—n— —o—f— —D—o—w—n—t—o—w—n—",
      "aliases": "—N—i—n—e—s—,— —T—h—e— —G—i—a—n—t— —K—i—l—l—e—r—,— —T—h—e— —R—e—l—u—c—t—a—n—t— —H—e—r—o—",
      "concept": "—D—u—s—t— —B—o—w—l— —r—e—f—u—g—e—e—;— —l—i—v—i—n—g— —e—m—b—o—d—i—m—e—n—t— —o—f— —t—h—e— —U—n—b—o—u—n—d— —s—p—i—r—i—t— —a—n—d— —s—t—r—e—e—t— —B—a—r—o—n— —o—f— —D—o—w—n—t—o—w—n— —L—A—.—",
      "faction": "Anarch",
      "clan": "Brujah",
      "portrait": "portraits/npc_33.webp",
      "tropes": [
        "—T—h—e— —R—e—l—u—c—t—a—n—t— —H—e—r—o—",
        "—T—h—e— —W—o—r—k—i—n—g—-—C—l—a—s—s— —L—e—g—e—n—d—",
        "—T—h—e— —G—i—a—n—t— —K—i—l—l—e—r—"
      ],
      "functions": [
        "—P—r—i—m—a—r—y— —p—h—y—s—i—c—a—l— —d—e—t—e—r—r—e—n—t— —f—o—r— —D—o—w—n—t—o—w—n— —A—n—a—r—c—h—s—.—",
        "—T—h—e— —L—a—s—t— —R—o—u—n—d— —i—s— —a— —d—e— —f—a—c—t—o— —A—n—a—r—c—h— —s—a—f—e— —h—a—v—e—n—.—",
        "—P—r—i—m—a—r—y— —r—e—c—r—u—i—t—e—r— ——— —n—e—o—n—a—t—e—s— —i—d—o—l—i—z—e— —h—i—s— —h—i—s—t—o—r—y—.—",
        "—C—a—m—a—r—i—l—l—a—'—s— —m—o—s—t— —f—e—a—r—e—d— —s—t—r—e—e—t— —f—i—g—h—t—e—r—.—"
      ]
    },
    {
      "id": 5,
      "name": "—A—u—d—r—e—y— —H—o—r—n—e— ——— —H—a—r—p—y— —o—f— —L—o—s— —A—n—g—e—l—e—s—",
      "aliases": "—T—h—e— —S—o—c—i—a—l— —A—r—b—i—t—e—r—,— —T—h—e— —S—i—l—k— —D—a—g—g—e—r—,— —T—h—e— —1—9—4—0—s— —G—h—o—s—t—",
      "concept": "—T—h—e— —u—n—d—i—s—p—u—t—e—d— —C—o—u—r—t— —H—a—r—p—y— —o—f— —L—o—s— —A—n—g—e—l—e—s—,— —p—r—e—s—i—d—i—n—g— —o—v—e—r— —t—r—a—d—i—t—i—o—n—a—l— —E—l—y—s—i—u—m— —s—a—l—o—n—s—,— —s—o—c—i—a—l— —p—r—e—s—t—i—g—e—,— —a—n—d— —f—o—r—m—a—l— —B—o—o—n— —l—e—d—g—e—r—s—.—",
      "faction": "Camarilla",
      "clan": "Toreador",
      "portrait": "portraits/npc_5.webp",
      "tropes": [
        "—T—h—e— —S—o—c—i—a—l— —P—r—e—d—a—t—o—r—",
        "—G—l—a—m—o—u—r— —a—s— —W—e—a—p—o—n—",
        "—T—h—e— —W—o—m—a—n— —W—h—o— —K—n—o—w—s— —E—x—a—c—t—l—y— —W—h—a—t— —S—h—e— —I—s— —D—o—i—n—g—"
      ],
      "functions": [
        "—B—o—o—n— —e—c—o—n—o—m—y— —g—a—t—e—k—e—e—p—e—r— ——— —d—e—c—i—d—e—s— —w—h—i—c—h— —f—a—v—o—r—s— —a—r—e— —r—e—c—o—g—n—i—z—e—d— —b—y— —t—h—e— —c—o—u—r—t—.— —H—e—r— —a—p—p—r—o—v—a—l— —e—l—e—v—a—t—e—s—;— —h—e—r— —d—i—s—p—l—e—a—s—u—r—e— —s—t—r—a—n—d—s—.—",
        "—C—a—n— —b—e— —c—u—l—t—i—v—a—t—e—d— —a—s— —a—n— —a—l—l—y— —a—g—a—i—n—s—t— —S—e—t—h— —i—f— —a—p—p—r—o—a—c—h—e—d— —w—i—t—h— —d—r—a—m—a— —a—n—d— —s—p—e—c—t—a—c—l—e— ——— —s—h—e— —i—s— —b—o—r—e—d—.—",
        "—H—e—r— —W—a—r—d— —(—m—o—r—t—a—l— —r—e—l—a—t—i—v—e—)— —i—s— —a— —p—r—e—s—s—u—r—e— —p—o—i—n—t—.— —A—n—y—o—n—e— —w—h—o— —d—i—s—c—o—v—e—r—s— —t—h—i—s— —h—o—l—d—s— —a— —k—n—i—f—e— —t—o— —h—e—r— —t—h—r—o—a—t—.—",
        "—C—o—n—t—r—o—l—s— —i—n—f—o—r—m—a—t—i—o—n— —f—l—o—w— —a—t— —E—l—y—s—i—u—m— —t—h—r—o—u—g—h— —h—e—r— —n—e—t—w—o—r—k— —o—f— —s—o—c—i—a—l— —s—p—i—e—s—.—"
      ]
    },
    {
      "id": 8,
      "name": "—J—e—r—e—m—y— —M—a—c—N—e—i—l— ——— —A—n—a—r—c—h— —L—e—a—d—e—r—",
      "aliases": "—T—h—e— —L—e—g—e—n—d—,— —T—h—e— —A—r—c—h—i—t—e—c—t— —o—f— —t—h—e— —F—r—e—e— —S—t—a—t—e—,— —T—h—e— —S—c—o—t—t—i—s—h— —R—e—v—o—l—u—t—i—o—n—a—r—y—",
      "concept": "—L—e—g—e—n—d—a—r—y— —S—c—o—t—t—i—s—h— —r—e—b—e—l— —a—n—d— —a—r—c—h—i—t—e—c—t— —o—f— —t—h—e— —F—i—r—s—t— —A—n—a—r—c—h— —R—e—v—o—l—t— —i—n— —L—o—s— —A—n—g—e—l—e—s—.—",
      "faction": "Anarch",
      "clan": "Brujah",
      "portrait": "portraits/npc_8.webp",
      "tropes": [
        "—T—h—e— —R—e—v—o—l—u—t—i—o—n—a—r—y— —E—l—d—e—r—",
        "—T—h—e— —M—a—n— —t—h—e— —L—e—g—e—n—d— —O—u—t—g—r—e—w—",
        "—T—h—e— —W—e—i—g—h—t— —o—f— —B—e—i—n—g— —R—i—g—h—t— —f—o—r— —T—o—o— —L—o—n—g—"
      ],
      "functions": [
        "—N—o—m—i—n—a—l— —a—u—t—h—o—r—i—t—y— —o—f— —t—h—e— —A—n—a—r—c—h— —F—r—e—e— —S—t—a—t—e— ——— —h—i—s— —a—p—p—r—o—v—a—l— —o—p—e—n—s— —d—o—o—r—s—.—",
        "—D—i—r—e—c—t— —c—o—n—f—l—i—c—t— —w—i—t—h— —h—i—m— —i—s— —a— —d—e—a—t—h— —s—e—n—t—e—n—c—e—.— —P—C—s— —s—h—o—u—l—d— —w—o—r—k— —w—i—t—h— —o—r— —a—r—o—u—n—d— —h—i—m—.—",
        "—H—i—s— —O—v—e—r—e—x—t—e—n—d—e—d— —f—l—a—w— —m—e—a—n—s— —c—r—a—c—k—s— —a—r—e— —s—h—o—w—i—n—g— —i—n— —t—h—e— —F—r—e—e— —S—t—a—t—e—.—",
        "—F—o—n—t— —o—f— —r—e—v—o—l—u—t—i—o—n—a—r—y— —h—i—s—t—o—r—y— ——— —h—a—s— —b—e—e—n— —f—i—g—h—t—i—n—g— —t—h—e— —C—a—m—a—r—i—l—l—a— —f—o—r— —c—e—n—t—u—r—i—e—s—.—"
      ]
    },
    {
      "id": 6,
      "name": "—L—a—l—e—h— —A—l—-—K—h—o—u—r—y— ——— —D—e—p—u—t—y— —S—h—e—r—i—f—f— —&— —M—a—s—q—u—e—r—a—d—e— —A—u—d—i—t—o—r—",
      "aliases": "—T—h—e— —M—a—s—q—u—e—r—a—d—e— —A—u—d—i—t—o—r—,— —T—h—e— —F—o—r—e—n—s—i—c— —E—n—f—o—r—c—e—r—",
      "concept": "—M—e—t—h—o—d—i—c—a—l— —9—t—h—-—g—e—n—e—r—a—t—i—o—n— —A—s—s—a—m—i—t—e— —D—e—p—u—t—y— —S—h—e—r—i—f—f— —a—n—d— —M—a—s—q—u—e—r—a—d—e— —a—u—d—i—t—o—r—;— —l—o—y—a—l— —t—o— —S—e—t—h— —C—y—n—t—a—c—h— —w—h—o— —n—e—g—o—t—i—a—t—e—d— —h—e—r— —c—l—a—n— —c—o—n—t—r—a—c—t—,— —c—o—u—r—t— —s—t—a—n—d—i—n—g—,— —a—n—d— —p—r—o—t—e—c—t—i—o—n— —i—n— —L—A—.—",
      "faction": "Camarilla",
      "clan": "Assamite (Vizier/Warrior crossover)",
      "portrait": "portraits/npc_6.webp",
      "tropes": [
        "—T—h—e— —C—o—p— —W—h—o— —T—r—a—n—s—f—e—r—r—e—d— —P—r—e—c—i—n—c—t—s—",
        "—T—h—e— —I—m—p—a—r—t—i—a—l— —B—l—a—d—e—",
        "—T—h—e— —I—n—v—e—s—t—i—g—a—t—o—r— —E—l—d—e—r—s— —F—e—a—r—"
      ],
      "functions": [
        "—D—e—p—u—t—y— —S—h—e—r—i—f—f— ——— —t—h—e— —i—n—v—e—s—t—i—g—a—t—i—v—e— —a—r—m— —t—h—e— —S—h—e—r—i—f—f—'—s— —r—a—w— —f—o—r—c—e— —c—a—n—n—o—t— —p—e—r—f—o—r—m—.—",
        "—H—e—r— —i—m—p—a—r—t—i—a—l—i—t—y— —m—e—a—n—s— —P—C—s— —c—a—n— —t—r—u—s—t— —h—e—r— —m—o—r—e— —t—h—a—n— —m—o—s—t— —N—P—C—s—.—",
        "—L—A—P—D— —c—o—n—t—a—c—t—s— —c—a—n— —r—e—d—i—r—e—c—t— —m—o—r—t—a—l— —i—n—v—e—s—t—i—g—a—t—i—o—n—s— —a—w—a—y— —f—r—o—m— —K—i—n—d—r—e—d— —s—c—e—n—e—s—.—",
        "—C—a—r—r—i—e—s— —t—h—e— —S—i—x— —T—r—a—d—i—t—i—o—n—s— —l—i—k—e— —a— —B—i—b—l—e— ——— —c—a—n— —q—u—o—t—e— —c—h—a—p—t—e—r— —a—n—d— —v—e—r—s—e—.—"
      ]
    },
    {
      "id": 1,
      "name": "—M—e—r—e—d—i—t—h— —V—e—r—e—i—r—a— ——— —P—r—i—n—c—e— —o—f— —L—o—s— —A—n—g—e—l—e—s—",
      "aliases": "—T—h—e— —R—e—l—u—c—t—a—n—t— —C—r—o—w—n—,— —T—h—e— —V—e—l—v—e—t— —P—u—p—p—e—t—",
      "concept": "—V—e—n—t—r—u—e— —8—t—h—-—g—e—n—e—r—a—t—i—o—n— —P—r—i—n—c—e— —o—f— —L—o—s— —A—n—g—e—l—e—s—;— —s—p—o—n—s—o—r—e—d— —b—y— —S—e—t—h— —C—y—n—t—a—c—h— —a—f—t—e—r— —S—e—b—a—s—t—i—a—n— —L—a—C—r—o—i—x— —v—a—n—i—s—h—e—d— —1—5— —y—e—a—r—s— —a—g—o—,— —n—o—w— —a— —s—e—a—s—o—n—e—d— —r—u—l—e—r— —p—l—o—t—t—i—n—g— —t—o— —b—r—e—a—k— —f—r—e—e— —o—f— —S—e—t—h—'—s— —s—h—a—d—o—w— —u—s—i—n—g— —1—9—2—0—s— —M—a—s—q—u—e—r—a—d—e— —b—r—e—a—c—h— —e—v—i—d—e—n—c—e— —b—e—f—o—r—e— —A—r—c—h—o—n— —T—h—e—o— —B—e—l—l—.—",
      "faction": "Camarilla",
      "clan": "Ventrue",
      "portrait": "portraits/npc_1.webp",
      "tropes": [
        "—T—h—e— —Q—u—e—e—n— —i—n— —a— —G—i—l—d—e—d— —C—a—g—e—",
        "—T—h—e— —M—a—s—k— —T—h—a—t— —F—o—r—g—o—t— —t—h—e— —F—a—c—e— —B—e—n—e—a—t—h—",
        "—P—o—w—e—r— —a—s— —S—u—r—v—i—v—a—l—"
      ],
      "functions": [
        "—T—h—e— —r—e—i—g—n—i—n—g— —P—r—i—n—c—e— —o—f— —L—o—s— —A—n—g—e—l—e—s—,— —d—e—f—e—n—d—i—n—g— —t—h—e— —B—u—r—b—a—n—k—-—t—o—-—S—a—n— —D—i—e—g—o— —c—o—r—r—i—d—o—r— —a—g—a—i—n—s—t— —t—h—e— —n—o—r—t—h—e—r—n— —S—a—b—b—a—t— —i—n—v—a—s—i—o—n—.—",
        "—O—r—c—h—e—s—t—r—a—t—i—n—g— —a— —c—o—v—e—r—t— —p—a—l—a—c—e— —c—o—u—p— —t—o— —p—e—r—m—a—n—e—n—t—l—y— —s—e—v—e—r— —S—e—t—h— —C—y—n—t—a—c—h—'—s— —c—o—n—t—r—o—l— —o—v—e—r— —t—h—e— —C—a—m—a—r—i—l—l—a— —c—o—u—r—t—.—",
        "—A— —c—e—n—t—r—a—l— —p—a—t—r—o—n—,— —q—u—e—s—t—-—g—i—v—e—r—,— —a—n—d— —p—o—l—i—t—i—c—a—l— —s—o—v—e—r—e—i—g—n— —f—o—r— —C—a—m—a—r—i—l—l—a— —a—n—d— —m—e—r—c—e—n—a—r—y— —P—C—s—.—"
      ]
    },
    {
      "id": 7,
      "name": "—S—a—l—v—a—d—o—r— —G—a—r—c—i—a— ——— —B—r—u—j—a—h— —P—r—i—m—o—g—e—n—",
      "aliases": "—T—h—e— —S—c—h—o—l—a—r—-—W—a—r—r—i—o—r—,— —D—e—f—e—n—d—e—r— —o—f— —t—h—e— —T—o—w—e—r—",
      "concept": "—H—i—g—h—-—r—a—n—k—i—n—g— —B—r—u—j—a—h— —P—r—i—m—o—g—e—n— —a—n—d— —c—l—a—s—s—i—c—a—l— —p—h—i—l—o—s—o—p—h—e—r— —s—t—a—u—n—c—h—l—y— —l—o—y—a—l— —t—o— —P—r—i—n—c—e— —M—e—r—e—d—i—t—h— —a—n—d— —t—h—e— —C—a—m—a—r—i—l—l—a—,— —r—e—j—e—c—t—i—n—g— —A—n—a—r—c—h— —c—h—a—o—s— —i—n— —f—a—v—o—r— —o—f— —c—i—v—i—l—i—z—e—d— —o—r—d—e—r—.—",
      "faction": "Camarilla",
      "clan": "Brujah",
      "portrait": "portraits/npc_7.webp",
      "tropes": [
        "—T—h—e— —P—h—i—l—o—s—o—p—h—e—r—-—K—i—n—g—",
        "—C—i—v—i—l—i—z—e—d— —F—u—r—y—",
        "—T—h—e— —P—i—l—l—a—r— —o—f— —O—r—d—e—r—"
      ],
      "functions": [
        "—S—e—r—v—e—s— —a—s— —t—h—e— —C—a—m—a—r—i—l—l—a—'—s— —i—n—t—e—l—l—e—c—t—u—a—l— —c—h—a—m—p—i—o—n— —a—g—a—i—n—s—t— —A—n—a—r—c—h— —p—r—o—p—a—g—a—n—d—a—.—",
        "—P—r—o—v—i—d—e—s— —a— —s—t—a—u—n—c—h—l—y— —l—o—y—a—l— —B—r—u—j—a—h— —p—e—r—s—p—e—c—t—i—v—e— —o—n— —P—r—i—n—c—e— —M—e—r—e—d—i—t—h—'—s— —c—o—u—n—c—i—l—.—",
        "—A— —k—e—y— —p—o—l—i—t—i—c—a—l— —a—l—l—y— —f—o—r— —P—C—s— —a—t—t—e—m—p—t—i—n—g— —t—o— —n—a—v—i—g—a—t—e— —C—a—m—a—r—i—l—l—a— —h—i—g—h— —s—o—c—i—e—t—y—.—"
      ]
    },
    {
      "id": 22,
      "name": "—V—i—c—t—o—r— —T—e—m—p—l—e— ——— —M—u—s—i—c— —M—o—g—u—l— —B—a—r—o—n—",
      "aliases": "—T—h—e— —S—e—l—f—-—M—a—d—e— —M—o—g—u—l—,— —T—h—e— —B—a—r—o—n— —o—f— —t—h—e— —V—a—l—l—e—y—",
      "concept": "—V—e—n—t—r—u—e— —m—u—s—i—c— —e—n—t—r—e—p—r—e—n—e—u—r— —a—n—d— —c—h—a—r—i—s—m—a—t—i—c— —A—n—a—r—c—h— —B—a—r—o—n— —o—f— —t—h—e— —S—a—n— —F—e—r—n—a—n—d—o— —V—a—l—l—e—y—.—",
      "faction": "Anarch",
      "clan": "Ventrue",
      "portrait": "portraits/npc_22.webp",
      "tropes": [
        "—T—h—e— —S—e—l—f—-—M—a—d—e— —M—o—g—u—l—",
        "—T—h—e— —M—a—v—e—r—i—c—k— —L—e—a—d—e—r—",
        "—T—h—e— —F—a—t—h—e—r— —w—i—t—h— —S—e—c—r—e—t—s—"
      ],
      "functions": [
        "—A—n—a—r—c—h— —f—i—n—a—n—c—i—a—l— —e—n—g—i—n—e— —i—n— —t—h—e— —S—a—n— —F—e—r—n—a—n—d—o— —V—a—l—l—e—y—.—",
        "—C—l—u—b— —M—a—h—a—r—a—n—i— —a—n—d— —T—e—m—p—l—e— —o—f— —B—o—o—m— —l—a—b—e—l— —a—r—e— —h—i—s— —t—r—u—e— —d—o—m—a—i—n—s—.—",
        "—P—r—o—v—i—d—e—s— —s—a—n—c—t—u—a—r—y— —f—o—r— —T—h—i—n—-—B—l—o—o—d—s— —a—n—d— —C—a—i—t—i—f—f—.—",
        "—H—i—s— —m—o—r—t—a—l— —c—h—i—l—d—r—e—n— —a—r—e— —a— —M—a—s—q—u—e—r—a—d—e— —v—u—l—n—e—r—a—b—i—l—i—t—y—.—"
      ]
    }
  ],
  "pcs": [
    {
      "name": "—L—i—a—m— —J—o—h—n—s—o—n— —(—\"—L—.—J—.—\"—)—",
      "clan": "Brujah",
      "generation": "8th",
      "sire": "—C—l—a—y—t—o—n— —W—h—i—t—e—",
      "domitor": "",
      "concept": "—C—r—i—m—i—n—a—l— —(—G—T—A—)—",
      "nature": "—R—o—g—u—e—",
      "demeanor": "—S—u—r—v—i—v—o—r—",
      "player": "",
      "type": "Vampire",
      "xp": "21",
      ...
      "merits": [
        {
          "name": "—D—a—r—e—d—e—v—i—l—",
          "value": "3",
          "desc": "—W—h—e—n— —a—t—t—e—m—p—t—i—n—g— —e—x—c—e—p—t—i—o—n—a—l—l—y— —r—i—s—k—y— —n—o—n—-—c—o—m—b—a—t— —a—c—t—i—o—n—s—,— —a—d—d— —a—n— —a—d—d—i—t—i—o—n—a—l— —t—h—r—e—e— —d—i—c—e— —t—o— —y—o—u—r— —r—o—l—l—s—,— —a—n—d— —n—e—g—a—t—e— —a— —s—i—n—g—l—e— —b—o—t—c—h— —d—i—e—.—"
        },
        {
          "name": "—B—r—u—i—s—e—r—",
          "value": "1",
          "desc": "—Y—o—u—r— —a—p—p—e—a—r—a—n—c—e— —i—s— —s—u—f—f—i—c—i—e—n—t—l—y— —t—h—u—g—-—l—i—k—e— —t—o— —i—n—s—p—i—r—e— —f—e—a—r— —o—r— —d—i—s—q—u—i—e—t—.— —A—l—l— —I—n—t—i—m—i—d—a—t—i—o—n— —r—o—l—l—s— —a—g—a—i—n—s—t— —t—h—o—s—e— —w—h—o— —h—a—v—e— —n—o—t— —d—e—m—o—n—s—t—r—a—t—e—d— —t—h—e—i—r— —p—h—y—s—i—c—a—l— —s—u—p—e—r—i—o—r—i—t—y— —t—o— —y—o—u— —a—r—e— —a—t— —-—1— —d—i—f—f—i—c—u—l—t—y—.—"
        },
        {
          "name": "—C—o—m—m—o—n— —S—e—n—s—e—",
          "value": "1",
          "desc": "—Y—o—u— —h—a—v—e— —a— —s—i—g—n—i—f—i—c—a—n—t— —a—m—o—u—n—t— —o—f— —p—r—a—c—t—i—c—a—l—,— —e—v—e—r—y—d—a—y— —w—i—s—d—o—m—.— —T—h—e— —S—t—o—r—y—t—e—l—l—e—r— —c—a—n— —m—a—k—e— —s—u—g—g—e—s—t—i—o—n—s— —o—r— —w—a—r—n—i—n—g—s— —w—h—e—n— —y—o—u— —a—r—e— —a—b—o—u—t— —t—o— —a—c—t— —c—o—n—t—r—a—r—y— —t—o— —c—o—m—m—o—n— —s—e—n—s—e—.—"
        }
      ],
      "flaws": [
        {
          "name": "—A—d—d—i—c—t—i—o—n—",
          "value": "3",
          "desc": "—Y—o—u— —s—u—f—f—e—r— —f—r—o—m— —a—n— —a—d—d—i—c—t—i—o—n— —t—o— —a— —s—u—b—s—t—a—n—c—e— —(—d—r—u—g—s—,— —a—l—c—o—h—o—l—,— —a—d—r—e—n—a—l—i—n—e—)— —w—h—i—c—h— —m—u—s—t— —b—e— —p—r—e—s—e—n—t— —i—n— —t—h—e— —b—l—o—o—d— —y—o—u— —d—r—i—n—k—.—"
        },
        {
          "name": "—D—e—e—p— —S—l—e—e—p—e—r—",
          "value": "1",
          "desc": "—W—h—e—n— —y—o—u— —s—l—e—e—p—,— —i—t— —i—s— —v—e—r—y— —d—i—f—f—i—c—u—l—t— —f—o—r— —y—o—u— —t—o— —a—w—a—k—e—n—.— —T—h—e— —d—i—f—f—i—c—u—l—t—y— —o—f— —a—n—y— —r—o—l—l— —t—o— —a—w—a—k—e—n— —d—u—r—i—n—g— —t—h—e— —d—a—y— —i—s— —i—n—c—r—e—a—s—e—d— —b—y— —t—w—o—.—"
        },
        {
          "name": "—A—m—n—e—s—i—a—",
          "value": "2",
          "desc": "—Y—o—u— —a—r—e— —u—n—a—b—l—e— —t—o— —r—e—m—e—m—b—e—r— —y—o—u—r— —p—a—s—t—,— —y—o—u—r—s—e—l—f—,— —o—r— —y—o—u—r— —f—a—m—i—l—y—.— —Y—o—u—r— —h—i—s—t—o—r—y— —i—s— —u—p— —t—o— —t—h—e— —S—t—o—r—y—t—e—l—l—e—r—.—"
        },
        {
          "name": "—N—e—w— —K—i—d— —(—1— —p—t— —S—o—c—i—a—l—)—",
          "value": "1",
          "desc": "—N—e—w— —t—o— —t—h—e— —c—i—t—y—/—s—e—c—t—.—"
        },
        {
          "name": "—S—y—m—p—a—t—h—i—z—e—r— —-— —A—n—a—r—c—h— —(—1— —p—t— —S—o—c—i—a—l—)—",
          "value": "1",
          "desc": "—H—o—l—d—s— —s—y—m—p—a—t—h—i—e—s— —f—o—r— —t—h—e— —A—n—a—r—c—h— —m—o—v—e—m—e—n—t—.—"
        }
      ],
      "equipment": [
        "—B—u—r—n—e—r— —P—h—o—n—e—",
        "—G—o—l—d— —b—a—r— —w—o—r—t—h— —$—1—8—4—,—0—0—0—",
        "—i—P—h—o—n—e— —1—7— —P—r—o— —M—a—x—",
        "—$—7—7—0— —C—a—s—h—",
        "—2—0—2—0— —F—o—r—d— —M—u—s—t—a—n—g— —G—T— —(—B—l—a—c—k— —w—/— —W—h—i—t—e— —r—a—c—i—n—g— —s—t—r—i—p—e—s—)—",
        "—P—i—n—k— —L—o—w—r—i—d—e—r—"
      ],
      "specialties": {}
    },
    {
      "name": "—F—r—e—d—e—r—i—c— —K—i—n—g—",
      "clan": "Malkavian",
      "generation": "12th",
      "sire": "—P—h—i—l—i—p— —Z—a—m—b—a—r—d—o—",
      "domitor": "",
      "concept": "—C—u—l—t— —L—e—a—d—e—r— —/— —E—x—c—o—m—m—u—n—i—c—a—t—e—d— —A—m—i—s—h— —P—r—e—a—c—h—e—r—",
      "nature": "—I—d—e—a—l—i—s—t—",
      "demeanor": "—I—d—e—a—l—i—s—t—",
      "player": "",
      "type": "Vampire",
      "xp": "25",
      ...
      "merits": [
        {
          "name": "—T—r—u—e— —F—a—i—t—h—",
          "value": "7",
          "desc": "—(—2—)— —Y—o—u— —h—a—v—e— —a— —d—e—e—p—-—s—e—a—t—e—d— —f—a—i—t—h— —i—n— —G—o—d—.— —A—d—d—s— —o—n—e— —d—i—e— —p—e—r— —p—o—i—n—t— —t—o— —W—i—l—l—p—o—w—e—r—/—V—i—r—t—u—e— —r—o—l—l—s—.— —M—u—s—t— —h—a—v—e— —H—u—m—a—n—i—t—y— —9—+— —t—o— —s—t—a—r—t—.— —R—e—p—e—l—s— —v—a—m—p—i—r—e—s—.—"
        },
        {
          "name": "—E—n—c—h—a—n—t—i—n—g— —V—o—i—c—e—",
          "value": "2",
          "desc": "—T—h—e—r—e— —i—s— —s—o—m—e—t—h—i—n—g— —a—b—o—u—t— —y—o—u—r— —v—o—i—c—e— —t—h—a—t— —o—t—h—e—r—s— —c—a—n—n—o—t— —i—g—n—o—r—e—.— —T—h—e— —d—i—f—f—i—c—u—l—t—i—e—s— —o—f— —a—l—l— —r—o—l—l—s— —i—n—v—o—l—v—i—n—g— —t—h—e— —u—s—e— —o—f— —t—h—e— —v—o—i—c—e— —t—o— —p—e—r—s—u—a—d—e—,— —c—h—a—r—m—,— —o—r— —c—o—m—m—a—n—d— —a—r—e— —r—e—d—u—c—e—d— —b—y— —t—w—o—.—"
        },
        {
          "name": "—S—a—b—b—a—t— —S—u—r—v—i—v—o—r—",
          "value": "1",
          "desc": "—Y—o—u—'—v—e— —l—i—v—e—d— —t—h—r—o—u—g—h— —a— —S—a—b—b—a—t— —a—t—t—a—c—k—.— —-—1— —d—i—f—f—i—c—u—l—t—y— —o—n— —P—e—r—c—e—p—t—i—o—n— —r—o—l—l—s— —r—e—g—a—r—d—i—n—g— —S—a—b—b—a—t— —m—a—t—t—e—r—s—.—"
        }
      ],
      "flaws": [
        {
          "name": "—R—e—p—u—l—s—e—d— —b—y— —G—a—r—l—i—c—",
          "value": "1",
          "desc": "—Y—o—u— —c—a—n—n—o—t— —a—b—i—d—e— —g—a—r—l—i—c—.— —T—h—e— —s—m—e—l—l— —d—r—i—v—e—s— —y—o—u— —f—r—o—m— —t—h—e— —r—o—o—m— —u—n—l—e—s—s— —y—o—u— —m—a—k—e— —a— —W—i—l—l—p—o—w—e—r— —r—o—l—l—.—"
        },
        {
          "name": "—C—a—s—t— —N—o— —R—e—f—l—e—c—t—i—o—n—",
          "value": "1",
          "desc": "—Y—o—u— —c—a—s—t— —n—o— —r—e—f—l—e—c—t—i—o—n—.— —D—e—t—r—i—m—e—n—t—a—l— —f—o—r— —M—a—s—q—u—e—r—a—d—e—.— —(—L—a—s—o—m—b—r—a— —h—a—v—e— —t—h—i—s— —a—u—t—o—m—a—t—i—c—a—l—l—y—,— —d—o— —n—o—t— —t—a—k—e— —a—s— —F—l—a—w—)—.—"
        },
        {
          "name": "—A—m—n—e—s—i—a—",
          "value": "2",
        ...
        },
        {
          "name": "—N—e—w— —K—i—d—",
          "value": "1",
          "desc": "—H—e— —i—s— —n—e—w— —t—o— —t—h—e— —c—i—t—y— —o—r— —s—e—c—t— —a—n—d— —l—a—c—k—s— —e—s—t—a—b—l—i—s—h—e—d— —r—e—s—p—e—c—t—.—"
        }
      ],
      "equipment": [],
      "specialties": {}
    ...
    {
      "name": "—I—s—a—b—e—l— —T—u—r—n—e—r—",
      "clan": "Ventrue",
      "generation": "9th",
      "sire": "—K—e—i—t—h— —B—r—o—w—n—",
      "domitor": "",
      "concept": "—N—o—t— —L—i—s—t—e—d—",
      "nature": "—A—u—t—o—c—r—a—t—",
      "demeanor": "—C—h—i—l—d—",
      "player": "",
      "type": "Vampire",
      "xp": "36",
      ...
      "merits": [
        ...
        },
        {
          "name": "—E—a—t— —F—o—o—d—",
          "value": "1",
          "desc": "—Y—o—u— —h—a—v—e— —t—h—e— —c—a—p—a—c—i—t—y— —t—o— —e—a—t— —f—o—o—d— —a—n—d— —e—v—e—n— —s—a—v—o—r— —i—t—s— —t—a—s—t—e—,— —t—h—o—u—g—h— —y—o—u— —c—a—n—n—o—t— —d—e—r—i—v—e— —n—o—u—r—i—s—h—m—e—n—t— —a—n—d— —m—u—s—t— —h—e—a—v—e— —i—t— —b—a—c—k— —u—p— —l—a—t—e—r—.— —U—s—e—f—u—l— —f—o—r— —m—a—s—q—u—e—r—a—d—i—n—g— —a—s— —h—u—m—a—n—.—"
        }
      ],
      "flaws": [
        {
        ...
        },
        {
          "name": "—N—e—w— —K—i—d—",
          "value": "1",
          "desc": "—S—h—e— —i—s— —n—e—w— —t—o— —t—h—e— —c—i—t—y— —o—r— —s—e—c—t— —a—n—d— —l—a—c—k—s— —e—s—t—a—b—l—i—s—h—e—d— —r—e—s—p—e—c—t—.—"
        }
      ],
      "equipment": [],
      "specialties": {}
    ...
    {
      "name": "—E—l—l—i—o—t— —\"—S—h—a—n—e—\"— —M—e—r—c—e—r—",
      "clan": "Toreador",
      "generation": "13th",
      "sire": "—D—o—n—n—a— —D—e—l—o—r—e—",
      "domitor": "",
      "concept": "—S—t—r—e—e—t— —u—r—c—h—i—n— —t—u—r—n—e—d— —a—r—t—i—s—t—i—c— —i—c—o—n—",
      "nature": "—B—o—n— —V—i—v—a—n—t—",
      "demeanor": "—C—o—n—f—o—r—m—i—s—t—",
      "player": "",
      "type": "Vampire",
      "xp": "6",
      ...
      "merits": [
        ...
        {
          "name": "—O—p—e—n— —R—o—a—d—",
          "value": "2",
          "desc": "—Y—o—u— —l—i—k—e— —t—o— —t—r—a—v—e—l— —a—n—d— —k—n—o—w— —s—a—f—e— —r—o—u—t—e—s—.— —Y—o—u— —c—a—n— —m—o—v—e— —b—e—t—w—e—e—n— —c—i—t—i—e—s— —u—n—i—m—p—e—d—e—d— —b—y— —r—a—n—d—o—m— —e—n—c—o—u—n—t—e—r—s—.—"
        },
        {
          "name": "—F—r—i—e—n—d— —o—f— —t—h—e— —U—n—d—e—r—g—r—o—u—n—d—",
          "value": "3",
          "desc": "—Y—o—u— —k—n—o—w— —y—o—u—r— —w—a—y— —a—r—o—u—n—d— —s—e—w—e—r—s— —a—n—d— —t—u—n—n—e—l—s—.— —-—1— —d—i—f—f—i—c—u—l—t—y— —o—n— —s—u—b—t—e—r—r—a—n—e—a—n— —r—o—l—l—s—.— —N—o—s—f—e—r—a—t—u— —a—r—e— —n—o—t— —i—n—c—l—i—n—e—d— —t—o— —k—i—l—l— —y—o—u— —o—n— —s—i—g—h—t—.—"
        },
        {
          "name": "—N—a—t—u—r—a—l— —L—e—a—d—e—r—",
          "value": "1",
          "desc": "—Y—o—u— —a—r—e— —g—i—f—t—e—d— —w—i—t—h— —a— —c—e—r—t—a—i—n— —m—a—g—n—e—t—i—s—m— —t—o— —w—h—i—c—h— —o—t—h—e—r—s— —n—a—t—u—r—a—l—l—y— —d—e—f—e—r—.— —Y—o—u— —r—e—c—e—i—v—e— —t—w—o— —e—x—t—r—a— —d—i—c—e— —w—h—e—n— —m—a—k—i—n—g— —L—e—a—d—e—r—s—h—i—p— —r—o—l—l—s—.— —R—e—q—u—i—r—e—s— —C—h—a—r—i—s—m—a— —3—+—.—"
        },
        {
          "name": "—E—a—t— —F—o—o—d—",
          "value": "1",
      ...
      "flaws": [
        ...
        {
          "name": "—I—n—f—e—r—t—i—l—e— —V—i—t—a—e—",
          "value": "5",
          "desc": "—Y—o—u— —c—a—n—n—o—t— —c—r—e—a—t—e— —a—n—y— —c—h—i—l—d—e—r—.— —T—h—o—s—e— —y—o—u— —t—r—y— —t—o— —E—m—b—r—a—c—e— —d—i—e—.—"
        },
        {
          "name": "—H—u—n—t—e—d—",
          "value": "4",
          "desc": "—Y—o—u— —a—r—e— —p—u—r—s—u—e—d— —b—y— —a— —f—a—n—a—t—i—c—a—l— —w—i—t—c—h—-—h—u—n—t—e—r— —w—h—o— —b—e—l—i—e—v—e—s— —y—o—u— —a—r—e— —a— —d—a—n—g—e—r— —t—o— —h—u—m—a—n—i—t—y—.—"
        },
        {
          "name": "—C—l—a—n— —E—n—m—i—t—y—",
          "value": "4",
          "desc": "—O—n—e— —C—l—a—n— —i—n— —p—a—r—t—i—c—u—l—a—r— —w—a—n—t—s— —y—o—u— —d—e—a—d—.— —E—v—e—r—y— —m—e—m—b—e—r— —o—f— —t—h—a—t— —C—l—a—n— —i—s— —h—o—s—t—i—l—e— —t—o— —y—o—u—.—"
        },
        {
          "name": "—N—e—w— —K—i—d—",
          "value": "1",
          "desc": "—H—e— —i—s— —a— —f—r—e—s—h— —f—a—c—e— —i—n— —t—h—e— —L—A— —s—c—e—n—e— —w—i—t—h— —z—e—r—o— —s—o—c—i—a—l— —l—e—v—e—r—a—g—e—.—"
        },
        {
          "name": "—B—o—o—n— —(—1— —p—t—)—",
          "value": "1",
          "desc": "—S—h—a—n—e— —o—w—e—s— —L—y—d—i—a— —f—o—r— —h—e—r— —h—e—l—p— —w—i—t—h— —t—h—e— —h—u—n—t—e—r—s—.—"
        }
      ],
      "equipment": [],
      "specialties": {}
    ...
    {
      "name": "—K—a—t—r—i—n—e— —S—t—e—r—l—i—n—g— ——— —D—i—s—g—r—a—c—e—d— —D—r—o—n—e— —T—e—c—h—n—i—c—i—a—n—",
      "clan": "Ghoul",
      "generation": "N/A",
      "sire": "—F—r—e—d—e—r—i—c— —K—i—n—g— —(—M—a—l—k—a—v—i—a—n—)—",
      "domitor": "—F—r—e—d—e—r—i—c— —K—i—n—g— —(—M—a—l—k—a—v—i—a—n—)—",
      "concept": "—D—i—s—g—r—a—c—e—d— —D—r—o—n—e— —T—e—c—h—n—i—c—i—a—n— ——— —M—a—l—k—a—v—i—a—n— —g—h—o—u—l— —a—n—d— —h—a—c—k—e—r—.— —(—V—2—0— —C—o—r—e— —p—.—8—7—;— —V—2—0— —C—o—r—e— —p—.—4—9—7—-—4—9—8—:— —G—h—o—u—l—s—)—",
      "nature": "—V—i—s—i—o—n—a—r—y— ——— —S—e—e—k—s— —i—n—n—e—r— —p—e—a—c—e— —a—n—d— —e—n—g—i—n—e—e—r—i—n—g— —r—e—t—u—r—n— —(—V—2—0— —C—o—r—e—,— —p—.—1—0—3—)—",
      "demeanor": "—P—e—r—f—e—c—t—i—o—n—i—s—t— ——— —I—m—p—o—s—s—i—b—l—e— —s—t—a—n—d—a—r—d—s— —(—V—2—0— —C—o—r—e—,— —p—.—1—0—2—)—",
      "player": "",
      "type": "Ghoul",
      "xp": "0",
      "portrait": "",
      ...
      "merits": [
        {
          "name": "—C—o—m—p—u—t—e—r— —A—p—t—i—t—u—d—e— —(—2—p—t—,— —V—2—0— —C—o—r—e— —p—.—4—7—6—)—",
          "value": "2",
          "desc": "—Y—o—u— —a—r—e— —f—a—m—i—l—i—a—r— —w—i—t—h— —a—n—d— —t—a—l—e—n—t—e—d— —i—n— —t—h—e— —u—s—e—s— —o—f— —c—o—m—p—u—t—e—r— —e—q—u—i—p—m—e—n—t—.— —A—l—l— —r—o—l—l—s— —i—n—v—o—l—v—i—n—g— —c—o—m—p—u—t—e—r—s— —a—r—e— —a—t— —-—2— —d—i—f—f—i—c—u—l—t—y— —f—o—r— —y—o—u—.—"
        },
        {
          "name": "—C—o—n—c—e—n—t—r—a—t—i—o—n— —(—1—p—t—,— —V—2—0— —C—o—r—e— —p—.—4—7—6—)—",
          "value": "1",
          "desc": "—Y—o—u— —h—a—v—e— —t—h—e— —a—b—i—l—i—t—y— —t—o— —f—o—c—u—s— —y—o—u—r— —m—i—n—d— —a—n—d— —s—h—u—t— —o—u—t— —a—n—y— —d—i—s—t—r—a—c—t—i—o—n—s— —o—r— —a—n—n—o—y—a—n—c—e—s—.— —Y—o—u— —a—r—e— —u—n—a—f—f—e—c—t—e—d— —b—y— —p—e—n—a—l—t—i—e—s— —f—r—o—m— —d—i—s—t—r—a—c—t—i—n—g— —c—i—r—c—u—m—s—t—a—n—c—e—s—.—"
        },
        {
          "name": "—C—o—l—d—l—y— —L—o—g—i—c—a—l—",
          "value": "1",
          "desc": "—Y—o—u— —h—a—v—e— —a— —k—n—a—c—k— —f—o—r— —s—e—p—a—r—a—t—i—n—g— —f—a—c—t—u—a—l— —r—e—p—o—r—t—i—n—g— —f—r—o—m— —e—m—o—t—i—o—n—a—l— —c—o—l—o—r—a—t—i—o—n—.— —-—1— —d—i—f—f—i—c—u—l—t—y— —o—n— —a—l—l— —r—o—l—l—s— —r—e—q—u—i—r—i—n—g— —l—o—g—i—c— —o—r— —s—e—e—i—n—g— —t—h—r—o—u—g—h— —e—m—o—t—i—o—n—a—l— —c—l—o—u—d—i—n—g—.—"
        }
      ],
      "flaws": [
        {
          "name": "—S—h—o—r—t— —(—1—p—t—,— —V—2—0— —C—o—r—e— —p—.—4—9—0—)—",
          "value": "1",
          "desc": "—Y—o—u— —a—r—e— —w—e—l—l— —b—e—l—o—w— —a—v—e—r—a—g—e— —h—e—i—g—h—t— —(—4—.—5— —f—t— —/— —1—.—5—m— —o—r— —l—e—s—s—)—.— —R—u—n—n—i—n—g— —s—p—e—e—d— —i—s— —h—a—l—f— —o—f— —a—v—e—r—a—g—e—.— —R—e—a—c—h— —i—s— —l—i—m—i—t—e—d—.—"
        },
        {
          "name": "—S—h—y—",
          "value": "1",
          "desc": "—Y—o—u— —a—r—e— —i—l—l— —a—t— —e—a—s—e— —w—i—t—h— —p—e—o—p—l—e—.— —+—2— —d—i—f—f—i—c—u—l—t—y— —o—n— —S—o—c—i—a—l— —r—o—l—l—s— —w—i—t—h— —s—t—r—a—n—g—e—r—s—.— —+—3— —i—f— —c—e—n—t—e—r— —o—f— —a—t—t—e—n—t—i—o—n—.—"
        }
      ],
      "equipment": [],
      "specialties": {}
    ...
    {
      "name": "—J—o—h—n— —C—a—r—m—a—c— ——— —M—o—d—e—r—n— —A—m—i—s—h— —M—a—r—k—e—t—i—n—g— —F—r—e—e—l—a—n—c—e—r—",
      "clan": "Ghoul",
      "generation": "N/A",
      "sire": "—F—r—e—d—e—r—i—c— —K—i—n—g— —(—M—a—l—k—a—v—i—a—n—)—",
      "domitor": "—F—r—e—d—e—r—i—c— —K—i—n—g— —(—M—a—l—k—a—v—i—a—n—)—",
      "concept": "—M—o—d—e—r—n— —A—m—i—s—h— —M—a—r—k—e—t—i—n—g— ——— —G—h—o—u—l— —m—a—n—a—g—i—n—g— —M—a—s—q—u—e—r—a—d—e— —n—a—r—r—a—t—i—v—e—s— —f—o—r— —F—r—e—d—e—r—i—c— —K—i—n—g—.— —(—V—2—0— —C—o—r—e— —p—.—8—7—;— —V—2—0— —C—o—r—e— —p—.—4—9—7—-—4—9—8—)—",
      "nature": "—C—o—n—f—o—r—m—i—s—t— ——— —B—a—l—a—n—c—e—s— —u—p—b—r—i—n—g—i—n—g— —w—i—t—h— —d—a—r—k— —s—e—r—v—i—c—e— —(—V—2—0— —C—o—r—e—,— —p—.—9—7—)—",
      "demeanor": "—F—a—n—a—t—i—c— ——— —F—r—e—d—e—r—i—c—'—s— —s—e—r—v—i—c—e— —i—s— —n—e—w— —c—o—n—g—r—e—g—a—t—i—o—n— —(—V—2—0— —C—o—r—e—,— —p—.—9—7—)—",
      "player": "",
      "type": "Ghoul",
      "xp": "0",
      "portrait": "",
      ...
      "merits": [
        {
          "name": "—O—r—a—c—u—l—a—r— —A—b—i—l—i—t—y— —(—3—p—t—,— —V—2—0— —C—o—r—e— —p—.—4—8—3—)—",
          "value": "3",
          "desc": "—Y—o—u— —c—a—n— —s—e—e— —a—n—d— —i—n—t—e—r—p—r—e—t— —s—i—g—n—s— —a—n—d— —o—m—e—n—s— —r—e—g—a—r—d—i—n—g— —t—h—e— —f—u—t—u—r—e— —a—n—d— —p—r—e—s—e—n—t—.—"
        },
        {
          "name": "—C—o—m—m—o—n— —S—e—n—s—e— —(—1—p—t—,— —V—2—0— —C—o—r—e— —p—.—4—7—6—)—",
          "value": "1",
          "desc": "—Y—o—u— —h—a—v—e— —a— —s—i—g—n—i—f—i—c—a—n—t— —a—m—o—u—n—t— —o—f— —p—r—a—c—t—i—c—a—l—,— —e—v—e—r—y—d—a—y— —w—i—s—d—o—m—.— —T—h—e— —S—t—o—r—y—t—e—l—l—e—r— —c—a—n— —m—a—k—e— —s—u—g—g—e—s—t—i—o—n—s— —o—r— —w—a—r—n—i—n—g—s— —w—h—e—n— —y—o—u— —a—r—e— —a—b—o—u—t— —t—o— —a—c—t— —c—o—n—t—r—a—r—y— —t—o— —c—o—m—m—o—n— —s—e—n—s—e—.—"
        }
      ],
      "flaws": [
        {
          "name": "—L—a—m—e— —(—3—p—t—,— —V—2—0— —C—o—r—e— —p—.—4—8—8—)—",
          "value": "3",
          "desc": "—Y—o—u—r— —l—e—g—s— —a—r—e— —d—a—m—a—g—e—d—.— —W—a—l—k—i—n—g— —s—p—e—e—d— —i—s— —1—/—4— —n—o—r—m—a—l—,— —r—u—n—n—i—n—g— —i—s— —i—m—p—o—s—s—i—b—l—e—.—"
        }
      ],
      "equipment": [],
      "specialties": {}
    ...
    {
      "name": "—G—e—o—r—g—e— —M—i—c—h—a—e—l— ——— —A—m—i—s—h— —V—e—t—e—r—a—n— —C—o—m—b—a—t— —S—p—e—c—i—a—l—i—s—t—",
      "clan": "Ghoul",
      "generation": "N/A",
      "sire": "—F—r—e—d—e—r—i—c— —K—i—n—g— —(—M—a—l—k—a—v—i—a—n—)—",
      "domitor": "—F—r—e—d—e—r—i—c— —K—i—n—g— —(—M—a—l—k—a—v—i—a—n—)—",
      "concept": "—A—m—i—s—h— —V—e—t—e—r—a—n— —C—o—m—b—a—t— —S—p—e—c—i—a—l—i—s—t— ——— —F—r—e—d—e—r—i—c— —K—i—n—g—'—s— —f—i—r—e—a—r—m—s— —s—p—e—c—i—a—l—i—s—t—.— —(—V—2—0— —C—o—r—e— —p—.—8—7—;— —V—2—0— —C—o—r—e— —p—.—4—9—7—-—4—9—8—)—",
      "nature": "—C—o—n—f—o—r—m—i—s—t— ——— —S—e—e—k—s— —s—t—a—b—i—l—i—t—y— —i—n— —c—h—a—o—s— —(—V—2—0— —C—o—r—e—,— —p—.—9—7—)—",
      "demeanor": "—F—a—n—a—t—i—c— ——— —F—r—e—d—e—r—i—c— —l—o—y—a—l—t—y— —a—s— —n—e—w— —c—o—v—e—n—a—n—t— —(—V—2—0— —C—o—r—e—,— —p—.—9—7—)—",
      "player": "",
      "type": "Ghoul",
      "xp": "0",
      "portrait": "",
      ...
      "merits": [
        {
          "name": "—F—r—i—e—n—d—l—y— —F—a—c—e— —(—1—p—t—,— —V—2—0— —C—o—r—e— —p—.—4—7—7—)—",
          "value": "1",
          "desc": "—Y—o—u— —h—a—v—e— —a— —f—a—c—e— —t—h—a—t— —r—e—m—i—n—d—s— —e—v—e—r—y—o—n—e— —o—f— —s—o—m—e—o—n—e—,— —l—e—a—v—i—n—g— —y—o—u— —a—t— —-—1— —d—i—f—f—i—c—u—l—t—y— —o—n— —a—l—l— —a—p—p—r—o—p—r—i—a—t—e— —S—o—c—i—a—l—-—b—a—s—e—d— —r—o—l—l—s— —i—n—v—o—l—v—i—n—g— —s—t—r—a—n—g—e—r—s— —(—f—i—r—s—t— —m—e—e—t—i—n—g— —o—n—l—y—)—.—"
        },
        {
          "name": "—M—a—g—i—c— —R—e—s—i—s—t—a—n—c—e— —(—2—p—t—,— —V—2—0— —C—o—r—e— —p—.—4—8—1—)—",
          "value": "2",
          "desc": "—Y—o—u— —h—a—v—e— —a—n— —i—n—h—e—r—e—n—t— —r—e—s—i—s—t—a—n—c—e— —t—o— —m—a—g—i—c—.— —T—h—e— —d—i—f—f—i—c—u—l—t—y— —o—f— —a—l—l— —s—p—e—l—l—s— —(—T—r—e—m—e—r—e— —r—i—t—u—a—l—s—,— —e—t—c—.—)— —i—s— —t—w—o— —h—i—g—h—e—r— —w—h—e—n— —d—i—r—e—c—t—e—d— —a—t— —y—o—u—.— —Y—o—u— —m—a—y— —n—e—v—e—r— —l—e—a—r—n— —T—h—a—u—m—a—t—u—r—g—y—.—"
        },
        {
          "name": "—L—a—w—m—a—n—'—s— —F—r—i—e—n—d—",
          "value": "2",
          "desc": "—T—h—e— —l—o—c—a—l— —S—h—e—r—i—f—f— —o—r— —B—i—s—h—o—p— —l—i—k—e—s— —y—o—u—.— —H—e— —o—v—e—r—l—o—o—k—s— —m—i—n—o—r— —t—r—e—s—p—a—s—s—e—s— —a—n—d— —w—a—r—n—s— —y—o—u— —o—f— —c—r—a—c—k—d—o—w—n—s—.—"
        }
      ],
      "flaws": [
        {
          "name": "—P—T—S—D— —(—2—p—t—,— —V—2—0— —C—o—r—e— —p—.—4—8—8—)—",
          "value": "2",
          "desc": ""
        }
      ],
    ...
    {
      "name": "—J—a—d—e— —N—g—u—y—e—n— ——— —T—h—e— —A—s—p—i—r—i—n—g— —A—c—t—r—e—s—s— —G—h—o—u—l— —-— —D—e—a—d—",
      "clan": "Ghoul",
      "generation": "N/A",
      "sire": "—U—n—n—a—m—e—d— —T—o—r—e—a—d—o—r— —o—r— —V—e—n—t—r—u—e— —p—a—t—r—o—n—",
      "domitor": "—U—n—n—a—m—e—d— —T—o—r—e—a—d—o—r— —o—r— —V—e—n—t—r—u—e— —p—a—t—r—o—n—",
      "concept": "—A—s—p—i—r—i—n—g— —A—c—t—r—e—s—s— —G—h—o—u—l— ——— —A— —T—o—r—e—a—d—o—r—/—V—e—n—t—r—u—e— —g—h—o—u—l— —s—t—u—d—y—i—n—g— —a—t— —t—h—e— —S—t—e—l—l—a—r—i—s— —C—o—n—s—e—r—v—a—t—o—r—y—.— —(—V—2—0— —C—o—r—e— —p—.—8—7—;— —V—2—0— —C—o—r—e— —p—.—4—9—7—-—4—9—8—)—",
      "nature": "—G—a—l—l—a—n—t— ——— —P—e—r—f—o—r—m—s— —l—i—f—e— —a—s— —a— —s—c—e—n—e— —s—h—e— —i—s— —d—i—r—e—c—t—i—n—g— —(—V—2—0— —C—o—r—e—,— —p—.—9—7—)—",
      "demeanor": "—C—e—l—e—b—r—a—n—t— ——— —F—i—n—d—s— —j—o—y— —i—n— —t—h—e— —p—a—s—s—i—o—n— —o—f— —p—e—r—f—o—r—m—a—n—c—e— —(—V—2—0— —C—o—r—e—,— —p—.—9—6—)—",
      "player": "",
      "type": "Ghoul",
      "xp": "0",
      "portrait": "",
      ...
      "merits": [
        {
          "name": "—E—n—c—h—a—n—t—i—n—g— —V—o—i—c—e— —(—2—p—t—,— —V—2—0— —C—o—r—e— —p—.—4—7—7—)—",
          "value": "2",
          "desc": ""
        },
        {
          "name": "—S—e—d—u—c—t—r—e—s—s— —(—1—p—t—,— —V—2—0— —C—o—r—e— —p—.—4—8—4—)—",
          "value": "1",
          "desc": ""
        }
      ],
      "flaws": [
        {
          "name": "—A—d—d—i—c—t—i—o—n— —(—3—p—t—,— —V—2—0— —C—o—r—e— —p—.—4—8—6—)— ——— —K—i—n—d—r—e—d— —V—i—t—a—e—",
          "value": "3",
          "desc": ""
        }
      ],
    ...
    {
      "name": "—C—h—r—i—s— —P—a—r—t—l—o—w—",
      "clan": "Ghoul",
      "generation": "",
      "sire": "—E—l—l—i—o—t— —\"—S—h—a—n—e—\"— —M—e—r—c—e—r—",
      "domitor": "—E—l—l—i—o—t— —\"—S—h—a—n—e—\"— —M—e—r—c—e—r—",
      "concept": "—R—e—t—i—r—e—d— —S—o—l—d—i—e—r—",
      "nature": "—S—o—l—d—i—e—r—",
      "demeanor": "—A—u—t—o—c—r—a—t—",
      "player": "",
      "type": "Ghoul",
      "xp": "0",
      "portrait": "",
      ...
      "merits": [
        {
          "name": "—C—o—d—e— —o—f— —H—o—n—o—r—",
          "value": "2",
          "desc": "—Y—o—u— —h—a—v—e— —a— —p—e—r—s—o—n—a—l— —c—o—d—e— —o—f— —e—t—h—i—c—s— —t—o— —w—h—i—c—h— —y—o—u— —a—d—h—e—r—e— —s—t—r—i—c—t—l—y—.— —G—a—i—n— —t—w—o— —a—d—d—i—t—i—o—n—a—l— —d—i—c—e— —t—o— —a—l—l— —W—i—l—l—p—o—w—e—r— —o—r— —V—i—r—t—u—e— —r—o—l—l—s— —w—h—e—n— —a—c—t—i—n—g— —i—n— —a—c—c—o—r—d—a—n—c—e— —w—i—t—h— —y—o—u—r— —c—o—d—e—.—"
        },
        {
          "name": "—E—a—r—l—y— —R—i—s—e—r—",
          "value": "1",
          "desc": "—Y—o—u— —s—e—e—m— —t—o— —h—a—v—e— —t—h—e— —a—b—i—l—i—t—y— —t—o— —w—o—r—k— —o—n— —l—e—s—s— —r—e—s—t— —t—h—a—n— —y—o—u—r— —f—e—l—l—o—w— —v—a—m—p—i—r—e—s—.— —Y—o—u—r— —H—u—m—a—n—i—t—y— —o—r— —P—a—t—h— —s—c—o—r—e— —i—s— —c—o—n—s—i—d—e—r—e—d— —t—o— —b—e— —1—0— —f—o—r— —p—u—r—p—o—s—e—s— —o—f— —d—e—c—i—d—i—n—g— —w—h—e—n— —y—o—u— —r—i—s—e— —e—a—c—h— —e—v—e—n—i—n—g—.—"
        },
        {
          "name": "—A—m—b—i—d—e—x—t—r—o—u—s—",
          "value": "1",
          "desc": "—Y—o—u— —h—a—v—e— —a— —h—i—g—h— —d—e—g—r—e—e— —o—f— —o—f—f—-—h—a—n—d— —d—e—x—t—e—r—i—t—y— —a—n—d— —c—a—n— —p—e—r—f—o—r—m— —t—a—s—k—s— —w—i—t—h— —t—h—e— —'—w—r—o—n—g—'— —h—a—n—d— —a—t— —n—o— —p—e—n—a—l—t—y—.— —Y—o—u— —d—o— —n—o—t— —s—u—f—f—e—r— —a— —d—i—f—f—i—c—u—l—t—y— —p—e—n—a—l—t—y— —i—f— —y—o—u— —u—s—e— —t—w—o— —w—e—a—p—o—n—s—.—"
        }
      ],
      "flaws": [
        {
          "name": "—S—o—f—t—-—H—e—a—r—t—e—d—",
          "value": "1",
          "desc": "—Y—o—u— —c—a—n—n—o—t— —s—t—a—n—d— —t—o— —w—a—t—c—h— —o—t—h—e—r—s— —s—u—f—f—e—r—.— —M—u—s—t— —m—a—k—e— —W—i—l—l—p—o—w—e—r— —r—o—l—l— —t—o— —c—a—u—s—e— —p—a—i—n—.— —R—e—q—u—i—r—e—s— —H—u—m—a—n—i—t—y— —7—+—.—"
        },
        {
          "name": "—N—i—g—h—t—m—a—r—e—s—",
          "value": "1",
          "desc": "—Y—o—u— —e—x—p—e—r—i—e—n—c—e— —h—o—r—r—e—n—d—o—u—s— —n—i—g—h—t—m—a—r—e—s— —e—v—e—r—y— —t—i—m—e— —y—o—u— —s—l—e—e—p—.— —U—p—o—n— —a—w—a—k—e—n—i—n—g—,— —m—a—k—e— —a— —W—i—l—l—p—o—w—e—r— —r—o—l—l— —o—r— —l—o—s—e— —a— —d—i—e— —o—n— —a—l—l— —a—c—t—i—o—n—s— —f—o—r— —t—h—e— —n—i—g—h—t—.—"
        }
      ],
      "equipment": [],
      "specialties": {}
    ...
    {
      "name": "—R—a—c—h—e—l— —T—e—l—l—e—r—",
      "clan": "",
      "generation": "",
      "sire": "—L—i—a—m— —J—o—h—n—s—o—n—",
      "domitor": "—L—i—a—m— —J—o—h—n—s—o—n—",
      "concept": "",
      "nature": "",
      "demeanor": "",
      "player": "",
      ...
      "merits": [
        ...
        },
        {
          "name": "—L—u—c—k—y—",
          "value": "3",
          "desc": "—Y—o—u— —w—e—r—e— —b—o—r—n— —l—u—c—k—y—.— —Y—o—u— —m—a—y— —r—e—p—e—a—t— —a—n—y— —t—h—r—e—e— —f—a—i—l—e—d— —r—o—l—l—s— —p—e—r— —s—t—o—r—y—,— —i—n—c—l—u—d—i—n—g— —b—o—t—c—h—e—s—,— —b—u—t— —y—o—u— —m—a—y— —t—r—y— —o—n—l—y— —o—n—c—e— —p—e—r— —f—a—i—l—e—d— —r—o—l—l—.—"
        }
      ],
      "flaws": [],
      "equipment": [],
    ...
    {
      "name": "—M—r—s—.— —M—a—r—t—h—a— —G—a—b—l—e— ——— —T—h—e— —F—a—i—t—h—f—u—l— —M—a—t—r—i—a—r—c—h—",
      "clan": "Mortal",
      "generation": "N/A",
      "sire": "—N—/—A—",
      "domitor": "",
      "concept": "—O—l—d— —C—h—r—i—s—t—i—a—n— —F—a—c—e—b—o—o—k— —L—a—d—y— —&— —V—o—l—u—n—t—e—e—r— —C—o—o—r—d—i—n—a—t—o—r—.— —M—a—n—a—g—e—s— —c—h—u—r—c—h— —p—r—a—y—e—r— —c—h—a—i—n—s—,— —l—o—c—a—l— —b—a—k—e— —s—a—l—e—s—,— —a—n—d— —c—h—a—r—i—t—y— —d—r—i—v—e—s—.— —S—e—e—s— —F—r—e—d—e—r—i—k— —a—s— —a— —h—o—l—y—,— —a—s—c—e—t—i—c— —m—i—n—i—s—t—e—r— —u—n—d—e—r— —a— —s—o—l—e—m—n— —v—o—w— —o—f— —s—i—l—e—n—c—e— —r—e—c—o—v—e—r—i—n—g— —f—r—o—m— —a—n— —o—r—d—e—a—l—.—",
      "nature": "—C—a—r—e—g—i—v—e—r— ——— —D—e—e—p—l—y— —f—u—l—f—i—l—l—e—d— —b—y— —l—o—o—k—i—n—g— —a—f—t—e—r— —t—h—o—s—e— —i—n— —p—h—y—s—i—c—a—l— —o—r— —s—p—i—r—i—t—u—a—l— —n—e—e—d—.—",
      "demeanor": "—T—r—a—d—i—t—i—o—n—a—l—i—s—t— ——— —R—e—s—p—e—c—t—f—u—l—,— —c—h—u—r—c—h—-—g—o—i—n—g— —e—l—d—e—r—l—y— —g—r—a—n—d—m—o—t—h—e—r— —w—h—o— —v—a—l—u—e—s— —f—a—i—t—h—,— —m—a—n—n—e—r—s—,— —a—n—d— —c—o—m—m—u—n—i—t—y—.—",
      "player": "",
      "type": "Mortal",
      "xp": "0",
      "portrait": "",
      ...
      "flaws": [
        {
          "name": "—T—e—c—h—n—o—l—o—g—i—c—a—l—l—y— —C—h—a—l—l—e—n—g—e—d—",
          "value": "1",
          "desc": "—Y—o—u— —s—t—r—u—g—g—l—e— —w—i—t—h— —m—o—d—e—r—n— —d—e—v—i—c—e—s—;— —r—e—l—i—e—s— —s—t—r—i—c—t—l—y— —o—n— —s—i—m—p—l—e— —i—P—a—d— —t—a—p—s—,— —F—a—c—e—b—o—o—k— —M—e—s—s—e—n—g—e—r—,— —a—n—d— —p—h—o—n—e— —c—a—l—l—s—.—"
        }
      ],
      "equipment": [
        "—G—o—l—d—-—r—i—m—m—e—d— —r—e—a—d—i—n—g— —g—l—a—s—s—e—s— —o—n— —a— —b—e—a—d—e—d— —l—a—n—y—a—r—d—",
        "—i—P—a—d— —i—n— —a— —f—l—o—r—a—l— —q—u—i—l—t—e—d— —c—a—s—e— —(—F—a—c—e—b—o—o—k— —n—o—t—i—f—i—c—a—t—i—o—n—s— —o—n— —m—a—x—i—m—u—m— —v—o—l—u—m—e—)—",
        "—F—l—o—r—a—l— —h—a—n—d—b—a—g— —w—i—t—h— —p—e—p—p—e—r—m—i—n—t— —&— —b—u—t—t—e—r—s—c—o—t—c—h— —h—a—r—d— —c—a—n—d—i—e—s—",
        "—S—u—n—d—a—y— —c—h—u—r—c—h— —b—u—l—l—e—t—i—n—",
        "—K—e—y—s— —t—o— —2—0—0—4— —B—u—i—c—k— —L—e—S—a—b—r—e—"
      ],
      "specialties": {}
    }
  ],
  ...
  "locations": [
    {
      "name": "—D—o—r—o—t—h—y— —C—h—a—n—d—l—e—r— —P—a—v—i—l—i—o—n—",
      "district": "—D—o—w—n—t—o—w—n— —L—A—",
      "map_type": "elysium",
      "lat": 34.0566,
      "lng": -118.2483,
      "description": "—E—s—t—a—b—l—i—s—h—e—d— —i—n— —t—h—e— —1—9—6—0—s—,— —t—h—e— —D—o—r—o—t—h—y— —C—h—a—n—d—l—e—r— —P—a—v—i—l—i—o—n— —h—a—s— —s—t—o—o—d— —a—s— —a— —b—e—a—c—o—n— —o—f— —L—o—s— —A—n—g—e—l—e—s— —c—u—l—t—u—r—e— —a—n—d— —h—i—g—h— —s—o—c—i—e—t—y—.— —U—n—d—e—r— —t—h—e— —g—l—i—t—t—e—r—i—n—g— —c—h—a—n—d—e—l—i—e—r—s—,— —K—i—n—d—r—e—d— —e—l—i—t—e—s— —w—h—i—s—p—e—r— —s—e—c—r—e—t—s— —a—n—d— —b—r—o—k—e—r— —d—e—a—l—s— —t—h—a—t— —s—h—a—p—e— —t—h—e— —c—i—t—y—'—s— —f—u—t—u—r—e—.— —I—t— —o—p—e—r—a—t—e—s— —a—s— —t—h—e— —P—r—i—n—c—e—'—s— —p—r—i—m—a—r—y— —E—l—y—s—i—u—m—,— —a— —n—e—u—t—r—a—l— —g—r—o—u—n—d— —w—h—e—r—e— —t—h—e— —M—a—s—q—u—e—r—a—d—e— —i—s— —p—a—r—a—m—o—u—n—t— —a—n—d— —v—i—o—l—e—n—c—e— —i—s— —s—t—r—i—c—t—l—y— —f—o—r—b—i—d—d—e—n—.— —O—v—e—r— —d—e—c—a—d—e—s—,— —i—t— —h—a—s— —w—i—t—n—e—s—s—e—d— —t—h—e— —r—i—s—e— —a—n—d— —f—a—l—l— —o—f— —c—o—u—n—t—l—e—s—s— —K—i—n—d—r—e—d— —f—a—c—t—i—o—n—s—,— —c—e—m—e—n—t—i—n—g— —i—t—s— —p—l—a—c—e— —a—s— —t—h—e— —c—e—n—t—e—r— —o—f— —f—o—r—m—a—l— —K—i—n—d—r—e—d— —s—o—c—i—e—t—y—.— —T—h—e— —P—a—v—i—l—i—o—n— —i—s— —a— —g—r—a—n—d—,— —s—w—e—e—p—i—n—g— —s—t—r—u—c—t—u—r—e— —o—f— —g—l—a—s—s—,— —m—a—r—b—l—e—,— —a—n—d— —c—u—r—v—e—d— —c—o—n—c—r—e—t—e—.— —I—n—s—i—d—e—,— —p—l—u—s—h— —r—e—d— —c—a—r—p—e—t—s—,— —c—r—y—s—t—a—l— —c—h—a—n—d—e—l—i—e—r—s—,— —a—n—d— —w—i—d—e— —s—t—a—i—r—c—a—s—e—s— —p—r—o—v—i—d—e— —a—n— —o—p—u—l—e—n—t— —s—e—t—t—i—n—g—,— —c—o—n—t—r—a—s—t—i—n—g— —t—h—e— —s—t—a—r—k— —r—e—a—l—i—t—i—e—s— —o—f— —K—i—n—d—r—e—d— —e—x—i—s—t—e—n—c—e—.—",
      "notes": "",
      "is_pc_location": false,
      "characters": [
        {
          "id": 1,
          "name": "—M—e—r—e—d—i—t—h— —V—e—r—e—i—r—a—",
          "is_pc": false,
          "relationship": "—o—p—e—r—a—t—e—s—"
        },
        {
          "id": 3,
          "name": "—A—m—a—n—d—a— —B—y—e—r—s—",
          "is_pc": false,
          "relationship": "—o—p—e—r—a—t—e—s—"
        }
      ]
    ...
    {
      "name": "—B—a—r— —A—f—t—e—r—l—i—f—e—",
      "district": "—D—o—w—n—t—o—w—n— —L—A—",
      "map_type": "hangout",
      "lat": 33.93,
      "lng": -118.2537,
      "description": "—O—p—e—n—i—n—g— —i—t—s— —d—o—o—r—s— —i—n— —t—h—e— —l—a—t—e— —1—9—9—0—s— —a—s— —a— —s—p—e—a—k—e—a—s—y—,— —B—a—r— —A—f—t—e—r—l—i—f—e— —q—u—i—c—k—l—y— —e—v—o—l—v—e—d— —i—n—t—o— —a— —h—i—g—h—-—e—n—d— —d—o—w—n—t—o—w—n— —e—s—t—a—b—l—i—s—h—m—e—n—t—.— —S—a—l—v—a—d—o—r— —G—a—r—c—i—a— —c—u—r—a—t—e—s— —i—t—s— —o—p—e—r—a—t—i—o—n—s— —a—s— —a—n— —e—x—c—l—u—s—i—v—e— —p—h—i—l—o—s—o—p—h—i—c—a—l— —s—a—l—o—n— —f—o—r— —t—h—e— —C—a—m—a—r—i—l—l—a—.— —H—e—r—e—,— —n—e—o—n—a—t—e—s— —a—n—d— —a—n—c—i—l—l—a—e— —a—l—i—k—e— —d—e—b—a—t—e— —t—h—e— —f—i—n—e—r— —p—o—i—n—t—s— —o—f— —t—h—e— —T—r—a—d—i—t—i—o—n—s— —a—n—d— —K—i—n—d—r—e—d— —p—h—i—l—o—s—o—p—h—y—,— —f—r—e—e— —f—r—o—m— —m—o—r—t—a—l— —e—a—v—e—s—d—r—o—p—p—i—n—g—.— —H—i—d—d—e—n— —b—e—h—i—n—d— —a—n— —u—n—m—a—r—k—e—d— —s—t—e—e—l— —d—o—o—r— —i—n— —a—n— —a—l—l—e—y—,— —t—h—e— —b—a—r— —f—e—a—t—u—r—e—s— —e—x—p—o—s—e—d— —b—r—i—c—k— —w—a—l—l—s—,— —d—i—m— —i—n—c—a—n—d—e—s—c—e—n—t— —l—i—g—h—t—i—n—g—,— —a—n—d— —l—e—a—t—h—e—r— —b—o—o—t—h—s—.— —A— —s—m—a—l—l— —s—t—a—g—e— —o—c—c—a—s—i—o—n—a—l—l—y— —h—o—s—t—s— —s—p—o—k—e—n—-—w—o—r—d— —p—o—e—t—r—y— —o—r— —j—a—z—z—.—",
      "notes": "",
      "is_pc_location": false,
      "characters": [
        {
          "id": 7,
          "name": "—S—a—l—v—a—d—o—r— —G—a—r—c—i—a—",
          "is_pc": false,
          "relationship": "—o—p—e—r—a—t—e—s—"
        }
      ]
    ...
    {
      "name": "—T—h—e— —L—a—s—t— —R—o—u—n—d—",
      "district": "—C—u—l—v—e—r— —C—i—t—y— —&— —S—a—n—t—a— —M—o—n—i—c—a— —(—A—n—a—r—c—h—)—",
      "map_type": "hangout",
      "lat": 34.025,
      "lng": -118.396,
      "description": "—A— —l—e—g—e—n—d—a—r—y— —A—n—a—r—c—h— —s—t—r—o—n—g—h—o—l—d—,— —T—h—e— —L—a—s—t— —R—o—u—n—d— —i—s— —a— —l—o—c—a—l— —w—o—r—k—i—n—g—-—c—l—a—s—s— —b—a—r— —s—e—r—v—i—n—g— —a—s— —a— —f—r—o—n—t— —f—o—r— —c—o—m—m—u—n—i—t—y— —d—e—f—e—n—s—e— —m—i—l—i—t—i—a—s—.— —A—r—m—a—n—d—o— —'—N—i—n—e—s—'— —R—o—d—r—i—g—u—e—z— —e—s—t—a—b—l—i—s—h—e—d— —i—t— —a—s— —a— —s—a—f—e— —h—a—v—e—n— —a—n—d— —r—a—l—l—y—i—n—g— —p—o—i—n—t— —f—o—r— —K—i—n—d—r—e—d— —w—h—o— —r—e—j—e—c—t— —t—h—e— —C—a—m—a—r—i—l—l—a—'—s— —s—t—r—i—c—t—u—r—e—s—.— —T—h—e— —b—a—r— —h—a—s— —w—e—a—t—h—e—r—e—d— —n—u—m—e—r—o—u—s— —r—a—i—d—s— —a—n—d— —s—k—i—r—m—i—s—h—e—s—,— —i—t—s— —w—a—l—l—s— —b—e—a—r—i—n—g— —t—h—e— —s—c—a—r—s— —o—f— —p—a—s—t— —c—o—n—f—l—i—c—t—s—.— —I—t— —r—e—m—a—i—n—s— —t—h—e— —b—e—a—t—i—n—g— —h—e—a—r—t— —o—f— —t—h—e— —A—n—a—r—c—h— —m—o—v—e—m—e—n—t— —i—n— —L—A—,— —w—h—e—r—e— —p—o—l—i—t—i—c—a—l— —d—e—b—a—t—e—s— —t—u—r—n— —i—n—t—o— —b—r—a—w—l—s— —a—n—d— —r—e—v—o—l—u—t—i—o—n—a—r—y— —p—l—a—n—s— —a—r—e— —h—a—t—c—h—e—d— —o—v—e—r— —c—h—e—a—p— —b—e—e—r— —a—n—d— —b—l—o—o—d—.— —I—t— —i—s— —f—i—e—r—c—e—l—y— —d—e—f—e—n—d—e—d— —b—y— —a— —l—o—y—a—l— —c—a—d—r—e— —o—f— —B—r—u—j—a—h— —a—n—d— —u—n—a—l—i—g—n—e—d— —n—e—o—n—a—t—e—s—.— —A— —g—r—i—t—t—y—,— —d—i—m—l—y— —l—i—t— —d—i—v—e— —b—a—r— —w—i—t—h— —s—c—u—f—f—e—d— —h—a—r—d—w—o—o—d— —f—l—o—o—r—s—,— —a— —b—a—t—t—e—r—e—d— —m—a—h—o—g—a—n—y— —b—a—r—,— —a—n—d— —v—i—n—t—a—g—e— —n—e—o—n— —b—e—e—r— —s—i—g—n—s— —b—u—z—z—i—n—g— —f—a—i—n—t—l—y—.— —P—o—o—l— —t—a—b—l—e—s— —d—o—m—i—n—a—t—e— —t—h—e— —b—a—c—k— —r—o—o—m—,— —a—n—d— —t—h—e— —a—i—r— —i—s— —h—e—a—v—y— —w—i—t—h— —t—h—e— —s—m—e—l—l— —o—f— —s—t—a—l—e— —s—m—o—k—e—,— —s—p—i—l—l—e—d— —l—i—q—u—o—r—,— —a—n—d— —o—l—d— —b—l—o—o—d—.—",
      "notes": "—A—n—a—r—c—h— —E—l—y—s—i—u—m— —a—n—d— —s—t—r—o—n—g—h—o—l—d—.—",
      "is_pc_location": false,
      "characters": [
        {
          "id": 33,
          "name": "—A—r—m—a—n—d—o— —\"—N—i—n—e—s—\"— —R—o—d—r—i—g—u—e—z—",
          "is_pc": false,
          "relationship": "—o—p—e—r—a—t—e—s—"
        }
      ]
  ...
  "territories": {
    "anarch": {
      "name": "Anarch Free States",
      "color": "#e63946",
      "fillColor": "#e63946",
      "fillOpacity": 0.25,
      "description": "Santa Monica to Koreatown, Burbank to Torrance",
      "polygon": [
        [
          34.17999758688084,
          -118.50196838378908
    ...
    "camarilla": {
      "name": "Camarilla Domain",
      "color": "#d4af37",
      "fillColor": "#3b82f6",
      "fillOpacity": 0.22,
      "description": "Downtown LA, East LA, Pasadena, Long Beach, Orange County",
      "polygon": [
        [
          34.165795245182245,
          -118.25683593750001
    ...
    "sabbat": {
      "name": "Sabbat Incursions",
      "color": "#8b5cf6",
      "fillColor": "#7c3aed",
      "fillOpacity": 0.25,
      "description": "Malibu, Calabasas, Simi Valley, Northern San Fernando Valley",
      "polygon": [
        [
          34.035306141289894,
          -118.5802459716797
  ...
  "disciplines": [
    ...
    },
    {
      ...
      "powers": [
        ...
        {
          "level": 1,
          "name": "Candle (difficulty 3 to soak, one",
          "description": "health level of aggravated damage/  \n  \nturn)",
          "system": null
        },
        {
          "level": 2,
          "name": "Palm of flame (difficulty 4 to soak,",
          "description": "one health level of aggravated  \n  \ndamage/turn)",
          "system": null
        },
        {
          "level": 3,
          "name": "Campfire (difficulty 5 to soak,",
          "description": "two health levels of aggravated  \n  \ndamage/turn)",
          "system": null
        },
        {
          "level": 4,
          "name": "Bonfire (difficulty 7 to soak, two",
          "description": "health levels of aggravated damage/  \n  \nturn)",
          "system": null
        },
        {
          "level": 5,
          "name": "Inferno (difficulty 9 to soak, three",
        ...
        {
          "level": 1,
          "name": "One pound/one-half kilogram",
        ...
        {
          "level": 1,
          "name": "Two dice of countermagic. The",
          "description": "character can attempt to cancel only  \n  \nthose powers and rituals that directly  \n  \naffect him, his garments, and objects  \n  \non his person.",
          "system": null
        },
        {
          "level": 2,
          "name": "Four dice of countermagic.",
        ...
        {
          "level": 4,
          "name": "Eight dice of countermagic.",
  ...
  "combination_disciplines": [
    {
      "name": "Angle of Incidents",
      "prereqs": "Prereqs: Daimonion + Mytherceria (indexed under both).",
      "xp": "",
      "description": "*Prereqs: Daimonion + Mytherceria (indexed under both).* **Body text MISSING from the OCR** (only the TOC and the discipline appendix list the name; the entry's page was not scanned). Flagged as an OCR gap — mechanics unknown."
    },
    {
      "name": "Animal Assassin",
      "prereqs": "Animalism 3, Quietus 4.",
      "xp": "21.",
      "description": "*Animalism 3, Quietus 4.* **XP 21.** Feed an animal 1–5 BP; roll **Manipulation + Animal Ken, difficulty 3 + BP fed**. Each success adds 1 to the creature's Physical Attributes (up to double its originals). It inflicts **aggravated** damage a number of times equal to the BP fed, and hunts any vampire but its master. The caustic vitae keeps it alive"
    },
    {
      "name": "Animal Kinship",
      "prereqs": "Animalism 3, Presence 3.",
      "xp": "18.",
      "description": "*Animalism 3, Presence 3.* **XP 18.** Roll **Charisma + Animal Ken (difficulty 6)** and spend 1 BP: one animal becomes loyal as a pet, obeys orders, and may die for the vampire. Does not work on ghouls or animals already under this power. Sending an animal to its death may call for Humanity/Path (ST discretion)."
    },
    {
      "name": "Animistic Merge",
      "prereqs": "(Index/OCR variant: \"Animalistic Merge\" — the body heading is used here.)",
      "xp": "27.",
      "description": "*(Index/OCR variant: \"Animalistic Merge\" — the body heading is used here.)* *Animalism 3, Vicissitude 6 (Obtenebration 6).* **XP 27.** Spend **3 BP**, roll **Strength + Animal Ken (difficulty 7)** to merge physically and mentally into an animal, hiding inside it. Immune to sunlight while inside; the animal keeps its own Attributes/appearance. Aura "
    },
    {
      "name": "Armor of Proteus",
      "prereqs": "Fortitude 4, Protean 6.",
      "xp": "30.",
      "description": "*Fortitude 4, Protean 6.* **XP 30.** Spend **2 BP** to grow flesh armor (**rating 3**); all vision/hearing difficulties +1, Dexterity −2. Soaks all damage except fire/sunlight; **every 2 soak successes add 1 automatic soak**. Lasts **Fortitude rating** rounds (reactivation 2 BP, instant). If, after soaking, 3+ health levels get through, the armor t"
    },
    {
      "name": "Armor of the Abyss",
      "prereqs": "Obtenebration 3, Fortitude 3",
      "xp": "18",
      "description": "Weaves shadow-armor with Armor Rating equal to Obtenebration + Fortitude (8). Costs 1 BP, Manipulation + Occult diff 7.",
      "source": "Lore of the Clans (p. 143)"
    },
    {
      "name": "Awaken the Typhonian Beast",
      "prereqs": "Serpentis 4 (Serpentis 8), Vicissitude 4.",
      "xp": "24 (36).",
      "description": "*Serpentis 4 (Serpentis 8), Vicissitude 4.* **XP 24 (36).** **3 BP** to assume a form; 1 BP to shift between them. Form 1 (Typhonian Beast, bipedal): Strength +3, Dexterity +4, Stamina +2, tongue inflicts **Strength +1 aggravated**. Form 2 (Childe of Ape, requires Serpentis 8): Strength +4, Dexterity −2, Stamina +6, fangs **Strength +3 aggravated**"
    },
    {
      "name": "Blinding the Heavens",
      "prereqs": "Obfuscate 3, Whispers of the Heavens 3, (optional Dominate 3).",
      "xp": "18 (27).",
      "description": "*Obfuscate 3, Whispers of the Heavens 3, (optional Dominate 3).* **XP 18 (27).** Roll **Intelligence + Occult (difficulty 6)**. For one lunar cycle (~28 days), any divination (precognitive or postcognitive) about the user must score more successes than the user to reveal anything (Oracular Ability, Eyes of Chaos, Clairvoyance, Whispers of the Heave"
    },
    {
      "name": "Blood Trace",
      "prereqs": "Auspex 4, Quietus 6.",
      "xp": "30.",
      "description": "*Auspex 4, Quietus 6.* **XP 30.** Feed a thrall 1 BP to create a Blood Bond as strong as 3 BP drunk. Until that vitae is spent, roll **Perception + Empathy (difficulty 8**, −1 per 2 BP drunk, +ST-discretion by distance) to sense where the drinker is; 4+ successes lets the user see through the drinker's eyes for (successes − 4) turns. Afterwards a *"
    },
    {
      "name": "Blow of the Inner Beast",
      "prereqs": "Animalism 3, Potence 1, Presence 3.",
      "xp": "21.",
      "description": "*Animalism 3, Potence 1, Presence 3.* **XP 21.** After dealing 3+ health levels (before soak), spend 1 BP to inflict the Beast's fright: the opponent's actions against the vampire are at +2 difficulty and require a **Courage (difficulty 8)** roll or **Rötschreck**."
    },
    {
      "name": "Body of Statue",
      "prereqs": "Fortitude 4, Protean 3 (Visceratika 3).",
      "xp": "21.",
      "description": "*Fortitude 4, Protean 3 (Visceratika 3).* **XP 21.** Spend **2 BP** to turn the body to stone (fully over a few rounds). Immune to sunlight while stone; **double soak pool vs bashing**. The user is immobile and unaware; the statue does not hide the aura. Any single level of damage breaks the form."
    },
    {
      "name": "Bone Regrowth",
      "prereqs": "Celerity 2, Vicissitude 3.",
      "xp": "15.",
      "description": "*Celerity 2, Vicissitude 3.* **XP 15.** Spend **1 BP**; for **Vicissitude** rounds regrow any lost bones (any size/type). Not skin or other flesh."
    },
    {
      "name": "Bravo's Command",
      "prereqs": "Dominate 3, Potence 2.",
      "xp": "12.",
      "description": "*Dominate 3, Potence 2.* **XP 12.** Known to Giovanni and Lasombra. When using Dominate 1 or 2, a display of strength lets the vampire **substitute Strength for Manipulation**. Dominated subjects obey fearfully."
    },
    {
      "name": "Carnivale Fantastique",
      "prereqs": "Daimonion 4, Mytherceria 5.",
      "xp": "27.",
      "description": "*Daimonion 4, Mytherceria 5.* **XP 27.** Spend **1 Willpower**, roll **Manipulation + Performance (difficulty = target's Path rating)** while whispering to a sleeping/unconscious/torpid victim. The victim is trapped in a dream-paradise; they may escape with **Perception + Occult (difficulty 7)**. Otherwise they sleep until death from age/neglect, a"
    },
    {
      "name": "Chiaroscuro",
      "prereqs": "Daimonion 1, Mytherceria 4.",
      "xp": "15",
      "description": "*Daimonion 1, Mytherceria 4.* **XP 15** (each painting 1 XP). Extended **Intelligence + Crafts (difficulty 6, 10 successes)** to create a painting with hidden symbolism. Viewers within 10 m cannot regain Willpower through sleep, and relive their worst act in nightmares. Ends when the victim loses a Humanity dot, succeeds on **Intelligence + Occult "
    },
    {
      "name": "Clustered Chaos",
      "prereqs": "Auspex 4, Dementation 3, Dominate 2.",
      "xp": "not visible in OCR (page break).",
      "description": "*Auspex 4, Dementation 3, Dominate 2.* **XP not visible in OCR (page break).** Spend **1 Willpower**, roll **Willpower (difficulty 6 + number of aides, max 10)**. Up to 4 nearby individuals who have ever tasted the user's blood add **1 automatic success each** to the user's Eyes of Chaos roll (they roll as if they also had it, silently). Aide targe"
    },
    {
      "name": "Coming Undone",
      "prereqs": "Potence 3, Temporis 4, Deny Relief.",
      "xp": "21.",
      "description": "*Potence 3, Temporis 4, Deny Relief.* **XP 21.** After a successful Brawl hit, roll **Intelligence + Occult vs the target's Willpower**: each success un-heals one increment of damage the target recently healed, **aggravated first**, then lethal, then bashing."
    },
    {
      "name": "Command of Darkness",
      "prereqs": "(Body heading reads \"Command and Darkness\"; appendix/index: \"Command of\nDarkness\" — used here.)",
      "xp": "12.",
      "description": "*(Body heading reads \"Command and Darkness\"; appendix/index: \"Command of Darkness\" — used here.)* *Dominate 3, Obtenebration 1.* **XP 12.** Roll **Manipulation + Subterfuge (difficulty = victim's current Willpower)** vs the victim's **Self-Control + Subterfuge (difficulty = user's current Willpower)**. The winner forces eye contact; the winner may "
    },
    {
      "name": "Command the Beast",
      "prereqs": "Animalism 3, Dominate 3.",
      "xp": "18.",
      "description": "*Animalism 3, Dominate 3.* **XP 18.** Dominate now works on animals: roll as normal but substitute Animal Ken for the usual Ability. Dominate on animals is at +2 difficulty until Animalism 5. Can't affect lower Generation (a vampire inside the animal is also immune)."
    },
    {
      "name": "Command the Vassal",
      "prereqs": "Dominate 4, Presence 5, Empowered Domination.",
      "xp": "27.",
      "description": "*Dominate 4, Presence 5, Empowered Domination.* **XP 27.** Reflexively spend 1 WP when using a Dominate power: the victim's Willpower counts 2 lower for the difficulty, and **mortals cannot spend Willpower to resist**. Utterly unsubtle — everyone in the room notices. Only works on Dominate 1–5; can't affect lower Generation."
    },
    {
      "name": "Confounding Mist",
      "prereqs": "Daimonion 3, Dominate 1, Opening the Gates of Mist.",
      "xp": "12.",
      "description": "*Daimonion 3, Dominate 1, Opening the Gates of Mist.* **XP 12.** While using Dominate, reflexively spend 1 BP and roll **Willpower (difficulty 6)**: each success adds +1 (max 9) to the difficulty of the victim's attempts to avoid eye contact. The victim may resist with **Perception + Awareness (8)** but must beat *all* successes. Can't affect lower"
    },
    {
      "name": "Contemptuous Tenacity",
      "prereqs": "Auspex 5, Dominate 3.",
      "xp": "24.",
      "description": "*Auspex 5, Dominate 3.* **XP 24.** After Dominate is used on the vampire, spend **1 WP** to shrug it off and become **immune to that vampire's Dominate for the scene**. Only effective vs Dominate 1–5 (elder Dominate unaffected)."
    },
    {
      "name": "Deadly Mist Form",
      "prereqs": "Protean 5, Quietus 2.",
      "xp": "21.",
      "description": "*Protean 5, Quietus 2.* **XP 21.** The vampire's Mist Form becomes a poison gas: anyone sharing its space is hit by **Scorpion's Touch** each round as though the user spent 1 BP (no blood cost). Only one individual at a time may be harmed."
    },
    {
      "name": "Deceive the Beast",
      "prereqs": "Animalism 3, Chimerstry 4.",
      "xp": "21.",
      "description": "*Animalism 3, Chimerstry 4.* **XP 21.** Always on. Chimerstry illusions may be directed at animals as well as (or instead of) humans/Kindred. Useless if the ST already rules Chimerstry affects animals."
    },
    {
      "name": "Defensive Insanity",
      "prereqs": "Dementation 2, Fortitude 2.",
      "xp": "12.",
      "description": "*Dementation 2, Fortitude 2.* **XP 12.** Spend 1 BP: add **+1 die per 2 dots of Dementation** to the user's rolls for the turn, useful against Dominate-based attacks."
    },
    {
      "name": "Dementate",
      "prereqs": "Dementation 4, Dominate 4.",
      "xp": "24.",
      "description": "*Dementation 4, Dominate 4.* **XP 24.** Roll **Manipulation + Intimidation (or Leadership, whichever is higher), difficulty = victim's current Willpower**. Each success drops 1 dot of a Mental Attribute (min 1) for **Willpower rating** turns, weakening the mind to suggestion. Can't affect lower Generation."
    },
    {
      "name": "Deny Relief",
      "prereqs": "Potence 2, Temporis 4.",
      "xp": "18.",
      "description": "*Potence 2, Temporis 4.* **XP 18.** On a successful Brawl attack, spend **1 BP + 1 WP** and win a **contested Willpower roll**: the target **cannot heal wounds at all** — by blood, regeneration, or magic — for **Potence** rounds (others may heal them)."
    },
    {
      "name": "Displacement",
      "prereqs": "Celerity 4, Obfuscate 2.",
      "xp": "18.",
      "description": "*Celerity 4, Obfuscate 2.* **XP 18.** Only vs opponents with equal or less Auspex than the user's Obfuscate. When a melee attack misses, reflexively spend 1 BP and roll **Dexterity + Stealth vs Perception + Awareness (both difficulty 7)**: the user vanishes mid-miss, appearing behind the attacker or staying vanished."
    },
    {
      "name": "Divine the Control",
      "prereqs": "Auspex 3, Dominate 4.",
      "xp": "21.",
      "description": "*Auspex 3, Dominate 4.* **XP 21.** With eye contact, roll **Perception + Subterfuge (difficulty = highest Dominate level used + 3)** to identify Dominate tampering: 1 = Dominate was used; 2 = which power; 3/4 = details (Dominate 2/3); 5 = who did it (if known). Can't affect lower Generation."
    },
    {
      "name": "Divine Visitation",
      "prereqs": "Obfuscate 3, Presence 3.",
      "xp": "18.",
      "description": "*Obfuscate 3, Presence 3.* **XP 18.** Appear to a mortal (often from Obfuscate) as a deity/angel/spirit. Roll **Wits + Acting (6)**, each success adds a die to **Appearance + Intimidation (difficulty = victim's current Willpower)**; each success subtracts 1 WP from the victim. If fed upon during the power the mortal counts half Willpower. At 0 WP s"
    },
    {
      "name": "Doppelganger",
      "prereqs": "Dementation 7, Dominate 5.",
      "xp": "36.",
      "description": "*Dementation 7, Dominate 5.* **XP 36.** Spend 1 WP; roll **Charisma + Intimidation** vs the victim's **Willpower (both difficulty 7)**. Each net success drains 1 temporary WP. Only an attacker botch frees the victim (and immunizes them for the story). At 0 WP the vampire takes over body and mind: Physical Attributes from the vessel, own Social/Ment"
    },
    {
      "name": "Down the Gates of Mist",
      "prereqs": "Auspex 5, Daimonion 3, Opening the Gates of Mist.",
      "xp": "24.",
      "description": "*Auspex 5, Daimonion 3, Opening the Gates of Mist.* **XP 24.** After using Opening the Gates of Mist, roll **Intelligence + Occult (8)**; each success transports one extra being (+ belongings). Transport takes 3 turns and fails if the caster is damaged; only to places the caster has physically visited. Arrival requires a **Willpower (6)** roll or 1"
    },
    {
      "name": "Draconic Visage",
      "prereqs": "Fortitude 4, Protean 4 (Serpentis 4 or Vicissitude 4).",
      "xp": "24.",
      "description": "*Fortitude 4, Protean 4 (Serpentis 4 or Vicissitude 4).* **XP 24.** Spend **3 BP**: gain dragon scales (1 soak die of armor; vs natural/out-of-control fire that 1 die becomes **2 automatic soak successes**) and wings (flight 15 mph / 21 m per turn, hover-capable, carry 20 lb/10 kg)."
    },
    {
      "name": "Empowered Domination",
      "prereqs": "Dominate 3, Presence 2.",
      "xp": "15.",
      "description": "*Dominate 3, Presence 2.* **XP 15.** Roll **Charisma + Intimidation (difficulty = victim's Wits + Courage)**: each success adds a bonus die to Dominate 1–2 rolls against that target. Only direct commands (user must look intimidating). Can't affect lower Generation."
    },
    {
      "name": "Enduring Mask",
      "prereqs": "Fortitude 2, Obfuscate 3.",
      "xp": "15.",
      "description": "*Fortitude 2, Obfuscate 3.* **XP 15.** While using Mask of a Thousand Faces, cameras and electronics record the *mask*, never the true face (not even early photography). Anyone who sees past the Obfuscate sees the truth, but no device can."
    },
    {
      "name": "Enduring Summoning",
      "prereqs": "Fortitude 3, Presence 4.",
      "xp": "21.",
      "description": "*Fortitude 3, Presence 4.* **XP 21.** Whenever the user is staked, they may spend 1 temporary WP and activate Presence 4 – Summoning."
    },
    {
      "name": "Enticing Work",
      "prereqs": "Auspex 3, Presence 4.",
      "xp": "21.",
      "description": "*Auspex 3, Presence 4.* **XP 21.** Roll **Charisma + Empathy (8)** while holding an object to imbue it with Presence; everyone who encounters it desires it. The object must be skill-made (creator had the relevant Crafts at 3+)."
    },
    {
      "name": "Eye of the Corpse",
      "prereqs": "Auspex 3, Paths of the Corpse in the Monster 3 (The Grave's Decay 3).",
      "xp": "18.",
      "description": "*Auspex 3, Paths of the Corpse in the Monster 3 (The Grave's Decay 3).* **XP 18.** Touch a corpse's head/skull and gaze into its eyes, rolling **Perception + Occult (8)**: 1 = the moment of death; 2 = last memories; 3 = most of the life; 4 = only what the subject remembered; 5 = even forgotten memories. Works on vampires who met Final Death (diffic"
    },
    {
      "name": "Eyes of a Thousand Shades",
      "prereqs": "Auspex 1, Necromancy 3.",
      "xp": "12.",
      "description": "*Auspex 1, Necromancy 3.* **XP 12.** Spend 1 BP and roll **Wits + Investigation/Occult + Auspex (9)** to see through previously-enslaved ghosts as \"spook surveillance.\" Success = view through all ghosts in a large building (flip between them reflexively), Perception at −3 (filmy Shroud-vision); 5+ successes = perfect clarity. Botch = see something "
    },
    {
      "name": "Fatuus Aegis",
      "prereqs": "Chimerstry 5, Fortitude 3.",
      "xp": "24.",
      "description": "*Chimerstry 5, Fortitude 3.* **XP 24.** Spend 1 WP: immune to Horrid Reality and related illusion-damage (still can't tell illusion from truth). No effect if the attacker's Chimerstry exceeds the user's."
    },
    {
      "name": "Fire Shield",
      "prereqs": "Fortitude 3, Protean 5.",
      "xp": "24.",
      "description": "*Fortitude 3, Protean 5.* **XP 24.** Spend 1 BP per use: treat **fire as lethal** for that instance of damage. Usable reactively against incoming fire if the user perceives the attack (e.g. a Lure of the Flames bolt)."
    },
    {
      "name": "Fortitude of the Mind",
      "prereqs": "Auspex 4, Fortitude 4.",
      "xp": "24.",
      "description": "*Auspex 4, Fortitude 4.* **XP 24.** Add Fortitude to resist mind-oriented attacks, or to Willpower rolls vs Mental attacks. Does not alter static difficulties or grant extra WP."
    },
    {
      "name": "Fumbled Words",
      "prereqs": "Dominate 2, Temporis 3.",
      "xp": "15.",
      "description": "*Dominate 2, Temporis 3.* **XP 15.** With Mesmerize available (usually eye contact), roll **Manipulation + Leadership vs target (difficulty 7)**. If the vampire wins, a subject who just failed a speech-related roll must re-roll with a penalty equal to the user's Dominate rating. Victim is immune for 24 h after a successful resist. Can't affect lowe"
    },
    {
      "name": "Garden of Deadly Delights",
      "prereqs": "Daimonion 3, Mytherceria 3.",
      "xp": "18.",
      "description": "*Daimonion 3, Mytherceria 3.* **XP 18.** Grow a garden (10+ m², open sky) of toxic plants over one lunar month (1 BP/night; +1 BP per extra 10 m). Requires an **Intelligence + Science (7)** roll. Once established, spend 1 BP and roll **Manipulation + Survival (6)**: thorn-vines flail and pollen billows; everyone in the garden except the Baali takes"
    },
    {
      "name": "Hamlet's Vision",
      "prereqs": "Dominate 2, Obfuscate 4.",
      "xp": "18.",
      "description": "*Dominate 2, Obfuscate 4.* **XP 18.** Roll **Manipulation + Stealth (difficulty = victim's Willpower)**; each success lets the vampire allow one more person to see them through the Obfuscate (commonly a dead relative). Double-layering with Mask of a Thousand Faces costs 1 WP. Can't affect lower Generation."
    },
    {
      "name": "Hastened Recovery",
      "prereqs": "Fortitude 2, Temporis 5.",
      "xp": "21.",
      "description": "*Fortitude 2, Temporis 5.* **XP 21.** Once per 48 h, spend **2 WP** to instantly heal up to Fortitude rating of **aggravated** damage (1 BP per point healed). Not blocked by Deny Relief."
    },
    {
      "name": "Heart of the Beast",
      "prereqs": "Animalism 5, Protean 5, Heart of the Wolf.",
      "xp": "30.",
      "description": "*Animalism 5, Protean 5, Heart of the Wolf.* **XP 30.** Take Hispo form (total 3 BP): Strength +3, Dexterity +2, Stamina +3; bite Strength +2 aggravated (diff 5), claw Strength +1 lethal (diff 6); 4–6 ft shoulder, 350–800 lb; **−1 difficulty on all Perception rolls**. Garou who can sense the Wyrm see through it if suspicious."
    },
    {
      "name": "Heart of the Wolf",
      "prereqs": "Animalism 4, Protean 4.",
      "xp": "24.",
      "description": "*Animalism 4, Protean 4.* **XP 24.** Shift to wolf (Protean 4); spend 1 extra BP for Lupus-form attributes/senses: Strength +1, Dexterity +2, Stamina +2; bite Strength +1 aggravated (diff 5), claw Strength +1 lethal (diff 6); 3–4 ft shoulder, 120–250 lb; **−2 difficulty on Perception rolls**, run at 2× speed. The wolf appears alive to all. ## I"
    },
    {
      "name": "Identify the Unholy",
      "prereqs": "Auspex 2, Valeren 1.",
      "xp": "9.",
      "description": "*Auspex 2, Valeren 1.* **XP 9.** Like Aura Perception but needs **2 successes minimum**; looking for marks of unholiness: 2 = black/red aura on unholy relics; 3 = unholy ground glows; 4 = spot any Road-of-the-Hive adherent (rating 8+); 5 = see a Baali's swarm of insect-like aura-creatures."
    },
    {
      "name": "Illusionary Beauty",
      "prereqs": "Chimerstry 3, Presence 3.",
      "xp": "18.",
      "description": "*Chimerstry 3, Presence 3.* **XP 18.** Channel Presence 1–3 through illusions: the illusory gem draws all attention (Awe), fire terrifies (Dread Gaze), an ethereal beauty entrances (Entrancement). Roll the Presence power at +1 difficulty; the effect lasts until disbelieved or ended."
    },
    {
      "name": "Imbuing the Beast Lord",
      "prereqs": "Animalism 4, Celerity 2, Fortitude 2, Potence 2, Feral Imbuing.",
      "xp": "30.",
      "description": "*Animalism 4, Celerity 2, Fortitude 2, Potence 2, Feral Imbuing.* **XP 30.** Roll **Strength + Animal Ken (6)** and transfer dots of Celerity/Fortitude/Potence to an animal in line of sight (up to the successes, never more than possessed); the vampire's own ratings drop for the duration. Withdrawable reflexively."
    },
    {
      "name": "Invisibility",
      "prereqs": "Chimerstry 3, Obfuscate 3.",
      "xp": "18.",
      "description": "*Chimerstry 3, Obfuscate 3.* **XP 18.** Spend 1 WP to bend light: invisible on electronic/video recording, while retaining all Obfuscate advantages. Breakable by anything that breaks Obfuscate; infrared still detects body heat."
    },
    {
      "name": "Iron Arms",
      "prereqs": "Fortitude 1, Potence 1.",
      "xp": "6.",
      "description": "*Fortitude 1, Potence 1.* **XP 6.** Always on. Eliminates recoil with guns. ## J"
    },
    {
      "name": "Just a Scratch",
      "prereqs": "Fortitude 2, Protean 2 (Vicissitude 2).",
      "xp": "12.",
      "description": "*Fortitude 2, Protean 2 (Vicissitude 2).* **XP 12.** Each blood point spent to heal bashing heals **2 bashing**. No extra healing of lethal/aggravated; no exceeding Generation limits; headshot-lethal still applies. ## K"
    },
    {
      "name": "Know the Bestial Mind",
      "prereqs": "Animalism 4, Auspex 4.",
      "xp": "24.",
      "description": "*Animalism 4, Auspex 4.* **XP 24.** Gaze into an animal's eyes and roll **Perception + Animal Ken (6–9)** to pluck memories/images; the more successes the clearer, and the difficulty rises with the memory's importance to the animal."
    },
    {
      "name": "Knowing Dagon's Call",
      "prereqs": "Auspex 4, Quietus 3.",
      "xp": "21.",
      "description": "*Auspex 4, Quietus 3.* **XP 21.** Always on. Whenever the user uses Dagon's Call, they instantly know the damage dealt (after the contested Stamina roll, before soak)."
    },
    {
      "name": "Kraken's Shadow",
      "prereqs": "Obtenebration 3 – Arms of Ahriman, Potence 3.",
      "xp": "18.",
      "description": "*Obtenebration 3 – Arms of Ahriman, Potence 3.* **XP 18.** When using Arms of Ahriman (not Arms of the Abyss), spend **1 WP**: all tentacles gain **half the user's Potence (rounded down)** for the scene. ## L"
    },
    {
      "name": "Larger Shape of the Beasts",
      "prereqs": "Animalism 4, Protean 4, Understanding the Beast.",
      "xp": "24.",
      "description": "*Animalism 4, Protean 4, Understanding the Beast.* **XP 24.** As Protean 4 – Shape of the Beast, but almost any beast up to **5× the vampire's own weight**."
    },
    {
      "name": "Legion",
      "prereqs": "Daimonion 7, Dominate 5.",
      "xp": "36.",
      "description": "*Daimonion 7, Dominate 5.* **XP 36.** Touch a mortal and roll **Manipulation + Intimidation (difficulty = victim's Willpower)** to possess their body. Works best in crowds; change bodies up to **Manipulation** times per day. The vessel keeps the vampire's Traits except Strength/Dexterity/Stamina/Appearance and Physical Merits/ Flaws. Original Attri"
    },
    {
      "name": "Mass Invisibility",
      "prereqs": "Chimerstry 4, Obfuscate 5, Invisibility.",
      "xp": "27.",
      "description": "*Chimerstry 4, Obfuscate 5, Invisibility.* **XP 27.** As Invisibility, but renders a group invisible — 1 extra person per dot of Stealth. Costs 1 WP to activate."
    },
    {
      "name": "Medusa's Gaze",
      "prereqs": "Auspex 1, Mytherceria 4 (Serpentis 4), Presence 2.",
      "xp": "21.",
      "description": "*Auspex 1, Mytherceria 4 (Serpentis 4), Presence 2.* **XP 21.** Spend 1 BP and roll **Charisma + Intimidation (difficulty = target's Willpower)**: the target is frozen in stone (mental actions still allowed). Damage to the statue deals half as lethal to the trapped victim; 10 lethal/aggravated frees them (soak applies). Victim may spend temporary W"
    },
    {
      "name": "Might of the Beast",
      "prereqs": "Animalism 5, Potence 2.",
      "xp": "21.",
      "description": "*Animalism 5, Potence 2.* **XP 21.** During frenzy, spend 1 WP and roll **Manipulation + Self-Control (8)**: each success +1 Strength. Failure = frenzy; botch = frenzy + a Derangement."
    },
    {
      "name": "Mind Flayer",
      "prereqs": "Auspex 4, Vicissitude 2.",
      "xp": "18.",
      "description": "*Auspex 4, Vicissitude 2.* **XP 18.** Range 5 m × Intelligence; no line of sight needed (but must know the target is in range). Breaks Obfuscate. Vs mortals: **Intelligence + Medicine (difficulty = target's Willpower; Iron Will applies)**, 1 lethal per success. Vs vampires/supernaturals: contested Intelligence + Medicine vs Willpower (both difficul"
    },
    {
      "name": "Mine the Myth",
      "prereqs": "Daimonion 1, Mytherceria 1.",
      "xp": "6.",
      "description": "*Daimonion 1, Mytherceria 1.* **XP 6.** Roll **Perception + Empathy (difficulty = target's Humanity/Path)**: on success, the vampire learns the most heinous, damaging lie the subject ever told."
    },
    {
      "name": "Molecular Awareness",
      "prereqs": "Auspex 4, Vicissitude 5.",
      "xp": "27.",
      "description": "*Auspex 4, Vicissitude 5.* **XP 27.** Leave a quarter-sized drop of self-aware blood (1 BP), then roll **Perception + Empathy (6)** later to perceive around it: 1 = 100 yd; 2 = 1 mile; 3 = 10 miles; 4 = 100 miles; 5 = 1,000 miles. Botch = wrong info. The blood stays aware until the vampire sleeps/torpor; multiple drops allowed. Consumed by another,"
    },
    {
      "name": "Money for Nothing",
      "prereqs": "Daimonion 3, Mytherceria 2.",
      "xp": "15.",
      "description": "*Daimonion 3, Mytherceria 2.* **XP 15.** Roll **Manipulation + Occult (4)** and ritually kill a mortal acquaintance of the recipient (4 BP gained from the act). The recipient gains 1 dot per success in a mundane Background (Resources, Status, Fame, Influence — not Generation), manifesting 1 dot per night as lucky streaks. The recipient must willing"
    },
    {
      "name": "Net of Shadows",
      "prereqs": "Auspex 2, Obtenebration 3.",
      "xp": "15.",
      "description": "*Auspex 2, Obtenebration 3.* **XP 15.** Spend 1 BP and roll **Manipulation + Occult (6)** to lay a flat shadow trap that springs when a sentient steps on it (can't fool targets with Obfuscate above the creator's Auspex). Arms grapple with **Dexterity + Brawl (5)** using the creator's Obtenebration + Celerity for Dexterity; escape requires equalling"
    },
    {
      "name": "Obscuring Mist",
      "prereqs": "Daimonion 3, Obfuscate 5, Opening the Gates of Mist.",
      "xp": "24.",
      "description": "*Daimonion 3, Obfuscate 5, Opening the Gates of Mist.* **XP 24.** Use Opening the Gates of Mist, then spend 1 WP: the mists densify and channel the user's Obfuscate (1–5) over the whole cloud (Cloak the Gathering's subject cap doubled). Auspex/piercing powers roll as if the vampire's Obfuscate matched them. Lasts a scene; aggressive action by those"
    },
    {
      "name": "Oh Look, I Died",
      "prereqs": "Auspex 1, Celerity 1, Thanatosis 3.",
      "xp": "15.",
      "description": "*Auspex 1, Celerity 1, Thanatosis 3.* **XP 15.** When attacked (perceived), reflexively spend 1 BP (supersedes Ashes to Ashes' cost) to assume ash form the instant the attack lands, making it look like Final Death. All Ashes to Ashes benefits/drawbacks apply."
    },
    {
      "name": "One Side of the Soul",
      "prereqs": "Auspex 4, Dominate 4, Self-Mastery.",
      "xp": "24.",
      "description": "*Auspex 4, Dominate 4, Self-Mastery.* **XP 24.** Spend 1 BP, look at your own reflection, and roll **Charisma + Leadership (6)**: every 2 successes raise 1 Physical Attribute (up to Generational max) for the scene. Lasombra (no reflection) cannot use it."
    },
    {
      "name": "Opening the Gates of Mist",
      "prereqs": "Auspex 3, Daimonion 3, Obfuscate 1, (optional Dominate 1).",
      "xp": "21 (24).",
      "description": "*Auspex 3, Daimonion 3, Obfuscate 1, (optional Dominate 1).* **XP 21 (24).** Spend 1 BP to conjure a thick, odourless mist (1 m radius, controllable 1 m/turn, max height 3 m). It lasts until dispelled, immune to wind/elements below the user's Daimonion; anyone inside counts as touched/seen for Discipline delivery. Filling an area blinds those insid"
    },
    {
      "name": "Panacea",
      "prereqs": "Fortitude 2, Obeah 3 (Valeren – Healer 3).",
      "xp": "15.",
      "description": "*Fortitude 2, Obeah 3 (Valeren – Healer 3).* **XP 15.** Spend 1 WP and roll **Willpower (9)**: successes set the max health levels restored; licking a wound heals any damage (including aggravated) at 1 BP per health level."
    },
    {
      "name": "Perceive the Beast Within",
      "prereqs": "Animalism 3, Auspex 1.",
      "xp": "12.",
      "description": "*Animalism 3, Auspex 1.* **XP 12.** Roll **Perception + Awareness (7)** to sense Beasts: 1 = ghouls (5 yd); 2 = ghouls, Kindred (10 yd); 3 = same (20 yd); 4 = same (40 yd); 5+ = +Garou (80 yd). Does not break Obfuscate or pinpoint location."
    },
    {
      "name": "Phasing",
      "prereqs": "Auspex 3, Vicissitude 3.",
      "xp": "18.",
      "description": "*Auspex 3, Vicissitude 3.* **XP 18.** Spend 1 BP and roll **Intelligence + Body Crafts (6)** to phase through bars/gates you can see (openings ≥ 1 inch/2.5 cm). Mass is redistributed, not reduced; botch = 1 lethal per 1 rolled."
    },
    {
      "name": "Poison of Blood",
      "prereqs": "Protean 2, Quietus 4.",
      "xp": "18.",
      "description": "*Protean 2, Quietus 4.* **XP 18.** Wound a victim to inject vitae (up to health levels dealt, Feral Claws only; Generation limits). With blood inside, use Quietus 2/3 remotely (each attempt burns 1 BP), or roll **contested Willpower (8)** to spend injected BP as **unsoakable aggravated** damage. Injected blood is usable only for the scene."
    },
    {
      "name": "Public Confession",
      "prereqs": "Daimonion 2, Presence 2.",
      "xp": "12.",
      "description": "*Daimonion 2, Presence 2.* **XP 12.** Roll **Manipulation + Empathy (difficulty = victim's Willpower)** while goading them to confess: the victim blurts out their most sinful act, loudly and to any audience/cameras. Usable in combat as an action (not a split action). ## Q"
    },
    {
      "name": "Quash the Alteration of Flesh",
      "prereqs": "Fortitude 2, Vicissitude 2 (Visceratika 2).",
      "xp": "12.",
      "description": "*Fortitude 2, Vicissitude 2 (Visceratika 2).* **XP 12.** Reflexively spend 1 BP when a Vicissitude change is applied to the user: add their Vicissitude (or Visceratika) rating to resist it. ## R"
    },
    {
      "name": "Rage Wind",
      "prereqs": "Celerity 4, Presence 4.",
      "xp": "24.",
      "description": "*Celerity 4, Presence 4.* **XP 24.** Spend 1 WP and roll **Charisma + Leadership (7)**; then a **Self-Control/Instincts (8)** roll governs control. Affects 5 vampires per dot of Leadership. Willing/failed subjects enter a *controlled* frenzy: +1 Physical Attribute (up to 1 above Generational max) for the frenzy's duration, attacking only known enem"
    },
    {
      "name": "Rapid Fire Bones",
      "prereqs": "Celerity 2, Vicissitude 3.",
      "xp": "15.",
      "description": "*Celerity 2, Vicissitude 3.* **XP 15.** Spend 1 BP and roll **Dexterity + Medicine (6)**: fire bone fragments (Strength + 1 lethal, range 5 × Strength meters), one per Celerity action. Bones regrow instantly on firing."
    },
    {
      "name": "Rapid Shift",
      "prereqs": "Celerity 3, Obtenebration 4 (Protean 4, Serpentis 4, Vicissitude 4).",
      "xp": "21.",
      "description": "*Celerity 3, Obtenebration 4 (Protean 4, Serpentis 4, Vicissitude 4).* **XP 21.** Spend 1 BP to assume any possessed form (1–5) in a single turn. Elder forms (6+) unaffected."
    },
    {
      "name": "Read the Sculptor's Clay",
      "prereqs": "Auspex 2, Vicissitude 2.",
      "xp": "12.",
      "description": "*Auspex 2, Vicissitude 2.* **XP 12.** Taste blood (**Perception + Medicine, difficulty 7**) or observe (**1 BP; Perception + Medicine, difficulty 8**, lowered by 1/2/3 per turn for stationary/active/exerting targets) — each success yields one piece of info (illness, supernatural nature, magic, Generation, clan/bloodline, attributes, injury, diabler"
    },
    {
      "name": "Relinquish the Soul's Vessel",
      "prereqs": "Auspex 1, Vicissitude 3.",
      "xp": "12.",
      "description": "*Auspex 1, Vicissitude 3.* **XP 12.** Spend 1 BP and roll **Intelligence + Medicine (7)** to remove a heart (own or another's; failure = 4 aggravated). The heart must be caged in 5+ lb of living flesh. While out, the vampire can't be staked and **−2 difficulty on frenzy-resistance rolls**. The heart needs 1 BP per month (else torpor). Only fire or "
    },
    {
      "name": "Resilient Senses",
      "prereqs": "Auspex 1, Fortitude 1.",
      "xp": "6.",
      "description": "*Auspex 1, Fortitude 1.* **XP 6.** Always on. Add Fortitude to rolls resisting non-supernatural blinding, bedazzlement, or sensory overload."
    },
    {
      "name": "Roy Cohn's Blessing",
      "prereqs": "Daimonion 1, Necromancy 1.",
      "xp": "6.",
      "description": "*Daimonion 1, Necromancy 1.* **XP 6.** Spend 1 BP and roll **Perception + Law (7)**: each success adds automatic successes to find loopholes/manipulations in a legal contract. (Consult damned lawyers' criticism, not drafting help.) ## S"
    },
    {
      "name": "Second Face",
      "prereqs": "Auspex 1, Obfuscate 3.",
      "xp": "12",
      "description": "*Auspex 1, Obfuscate 3.* **XP 12** (each additional mask after the first 6 XP). Pick a single visage; piercing it is +2 difficulty, and the user's Obfuscate counts 1 dot higher for See the Unseen purposes."
    },
    {
      "name": "Second Time is the Charm",
      "prereqs": "Celerity 1, Temporis 3.",
      "xp": "12.",
      "description": "*Celerity 1, Temporis 3.* **XP 12.** Reflexively spend 1 BP to reroll a non-combat roll (once per roll; never a botch)."
    },
    {
      "name": "Self-Mastery",
      "prereqs": "Auspex 3, Dominate 3.",
      "xp": "18.",
      "description": "*Auspex 3, Dominate 3.* **XP 18.** Dominate yourself: roll the Dominate power's Attribute + Ability at **difficulty 10 − (Dominate rating / 2, rounded down)**. Dominate 1/2 forces the self to act and counters other supernatural powers (successes add to the next non-combat action). Also aids frenzy/Rötschreck resistance. Dominate 3 can erase unhealt"
    },
    {
      "name": "Sense Amaranth",
      "prereqs": "Auspex 2, Necromancy 1 (Sepulchre Path).",
      "xp": "9.",
      "description": "*Auspex 2, Necromancy 1 (Sepulchre Path).* **XP 9.** Roll **Perception + Empathy (8)**; success reveals how many times the subject committed diablerie; each extra success shows one victim and roughly when. Requires diablerie marks in the aura."
    },
    {
      "name": "Shadowed Seraph",
      "prereqs": "Celerity 2, Obtenebration 4, Potence 4.",
      "xp": "30.",
      "description": "*Celerity 2, Obtenebration 4, Potence 4.* **XP 30.** Grow black-feathered shadow wings: flight 30 mph / 42 m per turn, carry 20 lb/10 kg."
    },
    {
      "name": "Shatter the Impressions",
      "prereqs": "Auspex 5, Presence 3.",
      "xp": "24.",
      "description": "*Auspex 5, Presence 3.* **XP 24.** After Presence is used on the user, spend 1 WP to shrug it off and be **immune to that vampire's Presence for the scene**. Only vs Presence 1–5 (elder Presence unaffected); can't be used against lower Generation."
    },
    {
      "name": "Smell of Unseelie",
      "prereqs": "Auspex 2, Mytherceria 2.",
      "xp": "12.",
      "description": "*Auspex 2, Mytherceria 2.* **XP 12.** Always on. Within 3 m of an Unseelie Fae the user automatically detects a noxious smell (rotting garbage, burnt flesh, or feces)."
    },
    {
      "name": "Soften the Wild Claws",
      "prereqs": "(OCR heading: \"Soiten the Wild Claws\" — corrected.)",
      "xp": "18.",
      "description": "*(OCR heading: \"Soiten the Wild Claws\" — corrected.)* *Animalism 3, Fortitude 3.* **XP 18.** Reduce soak difficulties vs animal-like attacks by 2. Vs Lupine bite/claw attacks, spend 1 WP for the improved soak for the scene. Covers Protean damage and animal-like attacks (incl. Vicissitude-altered natural creatures); not vampire bites or Vicissitude "
    },
    {
      "name": "Speed of the Bullet",
      "prereqs": "Auspex 1, Celerity 2.",
      "xp": "9.",
      "description": "*Auspex 1, Celerity 2.* **XP 9.** Always on. Dodge any firearm the user is aware of without diving for cover."
    },
    {
      "name": "Spider Climb",
      "prereqs": "Animalism 2, Potence 2, Protean 2 (Vicissitude 2).",
      "xp": "18.",
      "description": "*Animalism 2, Potence 2, Protean 2 (Vicissitude 2).* **XP 18.** Spend 1 BP to adhere to ceilings/walls for hours equal to total Animalism + Potence + Protean (or Vicissitude). Athletic maneuvers use **Dexterity + Athletics (7)**."
    },
    {
      "name": "Spirit of the Eternal Muse",
      "prereqs": "Auspex 4, Presence 3.",
      "xp": "21.",
      "description": "*Auspex 4, Presence 3.* **XP 21.** Roll **Humanity/Path (7)** to inspire a protégé into an ecstatic creative state (both parties share the Toreador weakness for the duration); each success is an automatic success on the protégé's Performance roll. The pupil must have studied with the patron for 12 − Humanity/Path months. Mortals only."
    },
    {
      "name": "Spot the Controlled",
      "prereqs": "Auspex 2, Dominate 2.",
      "xp": "12.",
      "description": "*Auspex 2, Dominate 2.* **XP 12.** After Aura Perception, roll **Perception + Empathy (8)**: more successes than the dominator's Dominate dots confirm the target is under Dominate (not who, what, or past uses). Can't affect lower Generation."
    },
    {
      "name": "Stone Flesh",
      "prereqs": "Fortitude 4, Protean 4.",
      "xp": "24.",
      "description": "*Fortitude 4, Protean 4.* **XP 24.** Spend 2 BP: soak difficulties −1, and soak all aggravated damage (except fire/sunlight) with full Stamina + Fortitude, for a scene. (A duplicate of the elder Fortitude power under Protean prerequisites.)"
    },
    {
      "name": "Stronghold",
      "prereqs": "Fortitude 2, Potence 2.",
      "xp": "12.",
      "description": "*Fortitude 2, Potence 2.* **XP 12.** Spend 1 WP and concentrate (no dodging): add Potence (max 5, no blood-automatics) as extra soak dice vs bashing. If an attacker deals 3+ health levels, the user must make **Courage (9)** or spend 1 WP for any action vs that foe for the scene."
    },
    {
      "name": "Stunning Mask",
      "prereqs": "Obfuscate 3, Presence 1.",
      "xp": "12.",
      "description": "*Obfuscate 3, Presence 1.* **XP 12.** When raising Appearance via Mask of a Thousand Faces, pay a number of BP less equal to the Presence rating (min 1 BP). ## T"
    },
    {
      "name": "Talk to Consumed Souls",
      "prereqs": "Auspex 4, Necromancy (Sepulchre Path) 1, Sense Amaranth.",
      "xp": "15.",
      "description": "*Auspex 4, Necromancy (Sepulchre Path) 1, Sense Amaranth.* **XP 15.** Roll **Intelligence + Subterfuge (difficulty = the diablerizer's Willpower)** to telepathically speak with a diablerized soul (need an image of the target). With Compel Soul, issue commands (the diablerizer counts as a fetter in most cases)."
    },
    {
      "name": "The Beast Mask",
      "prereqs": "Animalism 4, Protean 4.",
      "xp": "24",
      "description": "*Animalism 4, Protean 4.* **XP 24** (each additional mask 24 XP). Enter an animal via Subsume the Spirit, stay 24 h, then ritualize it as a personal guide. The Mask grants a half-animal form with bonuses (Bat/Raven: Dex +3, flight = land move; Bear: Str +2, Dex +1, Sta +2; Fox: Str +1, Dex +2, Sta +2; Rat: Str +1, Dex +3, Sta +1; Tiger: swim = land"
    },
    {
      "name": "The Crazed Beast",
      "prereqs": "Animalism 2, Dementation 3.",
      "xp": "15.",
      "description": "*Animalism 2, Dementation 3.* **XP 15.** Roll **Manipulation + Animal Ken (7)** on one animal: 1–3 successes = it flees; 4+ = it attacks its owner. Duration: 1 = 1 night; 2 = 1 week; 3 = 1 month; 4 = 1 year; 5+ = permanent. Ghouls resist with a **Willpower (7)** roll subtracting successes."
    },
    {
      "name": "The Domineering Mist",
      "prereqs": "Dominate 1, Opening the Gates of Mist.",
      "xp": "3.",
      "description": "*Dominate 1, Opening the Gates of Mist.* **XP 3.** Spend 1 BP per attempt: Dominate 1–5 can be used on targets inside the mist **without eye contact**. Can't affect lower Generation."
    },
    {
      "name": "The Perfect Murder",
      "prereqs": "Daimonion 1, Dominate 2, Presence 3.",
      "xp": "18.",
      "description": "*Daimonion 1, Dominate 2, Presence 3.* **XP 18.** After a 10-minute conversation about how to commit the perfect murder, spend 1 WP and roll **Manipulation + Larceny (difficulty = victim's Willpower)**: the mortal becomes bound to murder someone they hate, dislike, or find annoying. They must spend 1 WP per day or take steps toward the crime; they "
    },
    {
      "name": "The Unseen Noah",
      "prereqs": "Animalism 3, Obfuscate 2.",
      "xp": "15.",
      "description": "*Animalism 3, Obfuscate 2.* **XP 15.** Always on. Obfuscate now works on animals; choose to be hidden from both man and beast, humans only, or animals only."
    },
    {
      "name": "Thick Hide",
      "prereqs": "Fortitude 2, Protean 3.",
      "xp": "15.",
      "description": "*Fortitude 2, Protean 3.* **XP 15.** Spend 1 BP and roll **Stamina (6)**: each success adds 1 point of armor for **Stamina** rounds. Does not soak aggravated."
    },
    {
      "name": "Trap of Vitae",
      "prereqs": "Obfuscate 5, Quietus 3.",
      "xp": "24.",
      "description": "*Obfuscate 5, Quietus 3.* **XP 24.** Spend 1–3 BP in a spot and roll **Wits + Stealth (8)** to conceal a pool of acidic vitae. Anyone stepping in takes **1–3 aggravated** (per BP); damage they soak stays in the pool to hit others. Potent until sunrise. ## U"
    },
    {
      "name": "Understanding the Beast",
      "prereqs": "Animalism 3, Protean 4.",
      "xp": "21.",
      "description": "*Animalism 3, Protean 4.* **XP 21.** Touch a creature and roll **Charisma + Animal Ken (8)** to learn its shape; failure = try again another night; botch = the animal attacks. Transforms only to creatures ≤ the vampire's own weight (min 1 lb)."
    },
    {
      "name": "Unphased Usage",
      "prereqs": "Fortitude 1, Vicissitude 3.",
      "xp": "12.",
      "description": "*Fortitude 1, Vicissitude 3.* **XP 12.** No health-level damage when using Bonecraft on your own body (drawing bones, spikes, talons, quills). ## V"
    },
    {
      "name": "Vapor of Consumption",
      "prereqs": "(OCR variant in the index: \"Vapor of Compulsion\" — the body heading \"Vapor of\nConsumption\" is used here.)",
      "xp": "21.",
      "description": "*(OCR variant in the index: \"Vapor of Compulsion\" — the body heading \"Vapor of Consumption\" is used here.)* *Dominate 2, Protean 5.* **XP 21.** While in Mist Form, spend 1 WP: Dominate 1–2 may be used on any target within the vapor **as though making eye contact**, at +1 difficulty. Can't affect lower Generation."
    },
    {
      "name": "Vile Metamorphosis",
      "prereqs": "Animalism 4, Obfuscate 3.",
      "xp": "21.",
      "description": "*Animalism 4, Obfuscate 3.* **XP 21.** Spend 2 BP to collapse into a swarm (tarantulas, rats, etc.) of **5 creatures per remaining BP** after activation. Each 5 destroyed costs the user 1 BP; when the final 5 are destroyed the user reforms from the last creature in torpor from blood loss. ## W"
    },
    {
      "name": "Ward of Domination",
      "prereqs": "Auspex 3, Dominate 2.",
      "xp": "15.",
      "description": "*Auspex 3, Dominate 2.* **XP 15.** Inscribe a ward and roll **Manipulation + Occult (6)**: anyone touching the object receives a Dominate-2 command/suggestion. Duration: 1 = 1 day; 2 = 1 week; 3 = 1 month; 4 = 1 year; 5+ = permanent. If the vampire is present within 10 m they may issue a substitute command. Can't affect lower Generation."
    },
    {
      "name": "Wear the Bestial Skins",
      "prereqs": "Animalism 3, Vicissitude 3.",
      "xp": "18.",
      "description": "*Animalism 3, Vicissitude 3.* **XP 18.** Fleshcraft skins of feathers, fur, chitin, quills, or scales (1 BP per body part; Dex + Animal Ken roll difficulty 7 after a standard Fleshcraft roll). Grants up to +1 damage, +1 soak, or +1 armor; other effects at ST discretion."
    },
    {
      "name": "Whispering Mists",
      "prereqs": "Auspex 4, Opening the Gates of Mist.",
      "xp": "12.",
      "description": "*Auspex 4, Opening the Gates of Mist.* **XP 12.** Roll **Intelligence + Subterfuge (difficulty = subject's Willpower)** to charge the mist with psychic energy; for a scene the mist silently delivers any Discipline effect that requires the vampire to speak (becoming its focus/source). Other costs/rolls as normal."
    },
    {
      "name": "Winsayers in the Dark",
      "prereqs": "(OCR index variant: \"Whispers in the Dark.\")",
      "xp": "12.",
      "description": "*(OCR index variant: \"Whispers in the Dark.\")* *Dominate 1, Obfuscate 3.* **XP 12.** An Obfuscated vampire can use Dominate on a victim without revealing her presence (Auspex and other piercers still work). Can't affect lower Generation."
    },
    {
      "name": "Winter's Reprieve",
      "prereqs": "Fortitude 3, Protean 3.",
      "xp": "18.",
      "description": "*Fortitude 3, Protean 3.* **XP 18.** Spend 1 BP: immune to cold of any temperature for hours equal to Stamina + Fortitude + Protean. Equipment/clothing not immune."
    },
    {
      "name": "Wipe Out",
      "prereqs": "Dominate 4, Obfuscate 4.",
      "xp": "24.",
      "description": "*Dominate 4, Obfuscate 4.* **XP 24.** With eye contact, roll **Charisma + Intimidation (difficulty = target's Willpower)** to blank a mind: no Skills/Knowledges/non-Physical Disciplines; Attributes/Talents instinctive only. Duration: 1 = 1 scene; 2 = 2 scenes; 3 = 5 scenes + 1 WP loss; 4 = 1 night + 2 WP; 5+ = 1 week + 3 WP. A botch locks the power"
    }
  ],
  "glossary": {
    "sections": [
      {
        "title": "Common Parlance",
        "level": 1
      },
      {
        "title": "Old Form",
      ...
      {
        "title": "Anarch Free State & Los Angeles Terms",
        "level": 1
      },
      {
        "title": "Sabbat & The Sword of Caine",
        "level": 1
      },
      {
        "title": "Occult, Sorcery & Rituals",
        "level": 1
      },
      {
        "title": "LA Campaign: History & Major Operations",
        "level": 1
      },
      {
        "title": "LA Campaign: Factions, Sects & Networks",
        "level": 1
      },
      {
        "title": "LA Campaign: The Coterie & Inner Circle",
        "level": 1
      },
      {
        "title": "LA Campaign: Key Locales & Havens",
        "level": 1
      }
    ],
    "entries": [
      {
        "section": "Common Parlance",
        "title": "Anarch",
        "content": "1) A member of the Anarch Movement. 2) Any Kindred rebel who opposes the tyranny of elders.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Anarch Movement, The",
        "content": "The Sect within the Camarilla comprised of Anarchs who want to reform or overthrow the rule of the elders.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Barrens, The",
        "content": "The areas of a city unfit for life, including graveyards, abandoned buildings, industrial wastelands, and areas of irreversible urban blight.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Beast, The",
        "content": "The inchoate drives and urges that threaten to turn a vampire into a mindless, ravening monster.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Becoming, The",
        "content": "The moment one passes from being a fledgling into 'full' vampire status as a neonate. In the Camarilla, one may not Become until her sire deems her ready and gains the Prince's approval.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Blood",
        "content": "A vampire's heritage; that which makes a vampire a vampire. (e.g., 'I doubt her claims to such esteemed Blood.')",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Blood Bond",
        "content": "A mystical power over another individual engendered by partaking of a particular vampire's blood thrice; accepting blood from a vampire is an acknowledgment of her mastery.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Book of Nod, The",
        "content": "A collection of Kindred legend and history recounting the First City and Caine's wanderings.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Caitiff",
        "content": "A vampire of unknown Clan, or of no Clan at all. Caitiff are typically of high Generation, where Caine's blood is too diluted to pass on any consistent characteristics.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Camarilla, The",
        "content": "A global Sect of vampires devoted primarily to maintaining the Traditions, particularly that of the Masquerade.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Childe",
        "content": "A vampire created through the Embrace — the childe is the progeny of her sire. Often used derogatorily to indicate inexperience. Plural: childer.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Clan",
        "content": "A group of vampires who share common characteristics passed on by the blood. There are 13 known Clans, all of which were reputedly founded by members of the Third Generation.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Coterie",
        "content": "A small group of Kindred, united by the need for support and sometimes common interests. In the Sabbat, coteries are called packs.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Diablerie",
        "content": "The consumption of another Kindred's blood, to the point of the victim's Final Death. Vampires may lower their Generation permanently through this abhorrent practice. Also known as the Amaranth.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Domain",
        "content": "The area of a particular vampire's influence. Princes claim entire cities as their domains, sometimes granting lesser vampires domain within.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Elder",
        "content": "A vampire who has experienced two or more centuries of unlife. Elders are the most active participants in the Jyhad.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Elysium",
        "content": "A place where vampires may gather without fear of harm under the Pax Vampirica. Commonly established in opera houses, theaters, museums, and other locales of culture.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Embrace, The",
        "content": "The act of transforming a mortal into a vampire. The Embrace requires draining the victim and replacing that blood with a bit of vampiric vitae.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Final Death, The",
        "content": "When a vampire ceases to exist, crossing the line from undead into permanent death.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Fledgling",
        "content": "A newly created vampire, still under her sire's tutelage and protection.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Gehenna",
        "content": "The rumored Armageddon when the Antediluvians will rise from their torpor and devour the race of vampires and the world.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Generation",
        "content": "The number of 'steps' between a vampire and the mythical Caine; how far descended from the First Vampire a given vampire is.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Ghoul",
        "content": "A minion created by giving a bit of vampiric vitae to a mortal without draining her of blood first, conferring stopped aging, enhanced strength, and blood dependence.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Haven",
        "content": "A vampire's 'home'; where she finds sanctuary and security from the sun.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Hunger, The",
        "content": "The urge to feed. For vampires, the Hunger replaces all other physical drives with its own powerful call.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Inconnu",
        "content": "A Sect of vampires who have removed themselves from Kindred concerns and, largely, the Jyhad. Many Methuselahs are rumored to exist among the Inconnu.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Jyhad, The",
        "content": "The secret, self-destructive war waged between the Generations. Elder vampires manipulate their lessers, using them as pawns in a terrible game whose rules defy comprehension.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Kindred",
        "content": "The race of vampires as a whole, or a single vampire. Sabbat vampires scorn the term, preferring 'Cainite'.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Kiss, The",
        "content": "To drink blood, especially from a mortal. The Kiss causes feelings of intense ecstasy in those who receive it.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Life, The",
        "content": "A euphemism for mortal blood. Regarded by many Kindred as affected and effete.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Lupine",
        "content": "A werewolf, the natural and mortal enemy of the vampire race.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Lush",
        "content": "A vampire who typically feeds from drugged or drunk mortals in order to experience their inebriation vicariously.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Man, The",
        "content": "The mote of humanity that a vampire maintains; the spark of mortality that distinguishes him from the Beast.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Masquerade, The",
        "content": "The habit (and First Tradition) of hiding the existence of vampires from humanity to prevent persecution.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Prince",
        "content": "A vampire who has claimed a given expanse of domain as her own, generally a city, and supports that claim against all others. Refers to a Kindred of either sex.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Rogue",
        "content": "A vampire who feeds upon the vitae of other Cainites, out of necessity or depravity.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Sabbat, The",
        "content": "A Sect of vampires that rejects humanity, embracing their monstrous natures and waging crusade against the Antediluvians.",
        "source": "V20 Core, p. 32"
      },
      {
        "section": "Common Parlance",
        "title": "Sect",
        "content": "A group of vampires arguably united under a common philosophy. The three primary Sects are the Camarilla, the Sabbat, and the Anarch Movement.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Common Parlance",
        "title": "Sire",
        "content": "A vampire's 'parent'; the Kindred who created her through the Embrace.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Common Parlance",
        "title": "Vessel",
        "content": "A source of vitae for sustenance or pleasure, primarily mortal.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Amaranth",
        "content": "The act of consuming another Kindred's blood and soul; the formal, classical term for diablerie.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Ancilla",
        "content": "A 'proven' vampire, intermediate in age and status between the neonates and the elders (typically 50 to 200 years of unlife). Plural: ancillae.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Antediluvian",
        "content": "A member of the dreaded Third Generation, grandchild of Caine, and progenitor of a major Clan.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Antitribu",
        "content": "An 'anti-Clan'; one who has turned her back on the Sect that her Clan founded (usually by joining the Sabbat).",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Autarkis",
        "content": "A Kindred who remains fiercely outside the larger vampire society of a given city, acknowledging neither Prince, Baron, nor Archbishop.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Blood Oath",
        "content": "The classical and formal term for a blood bond.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Cainite",
        "content": "A vampire; a member of the race of Caine. Favored by elders, scholars, and the Sabbat.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Canaille",
        "content": "The bovine masses of humanity, especially the uncultured and unsavory, viewed primarily as herds for sustenance.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Cauchemar",
        "content": "A vampire who feeds exclusively on sleeping victims, leaving them undisturbed.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Consanguineous",
        "content": "Literally 'of the same blood'; denoting shared lineage or Clan descent.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Cunctator",
        "content": "A vampire who avoids killing when delivering the Kiss, taking only small amounts of blood across multiple prey.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Domitor",
        "content": "A ghoul's master; one who feeds blood and issues commands to an indentured servant.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Footpad",
        "content": "One who feeds from derelicts, vagrants, and the chaff of society, often lacking a permanent haven.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Gentry",
        "content": "Kindred who frequent nightclubs, theaters, and red-light districts to hunt among affluent revelers.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Golconda",
        "content": "A fabled state of vampiric enlightenment and transcendence, mastering the Beast and achieving inner peace.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Humanitas",
        "content": "The extent to which a Kindred preserves mortal conscience, empathy, and ethical restraint.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Kine",
        "content": "A contemptuous archaic term for mortals ('cattle').",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Leech",
        "content": "A mortal who drinks vampire blood yet acknowledges no domitor, or an unbonded rogue ghoul.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Lextalionis",
        "content": "The ancient code of Kindred retributive justice ('an eye for an eye'); the formal decree of a blood hunt.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Lineage",
        "content": "A vampire's genealogical pedigree: sire, sire's sire, and ancestral descent from the Antediluvians.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Methuselah",
        "content": "A vampire of the Fourth or Fifth Generation who has survived for a millennium or more, largely detached from mortal concerns.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Neonate",
        "content": "A young Kindred, recently Embraced and released from their sire's tutelage.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Papillon",
        "content": "The red-light entertainment district of a city, prime hunting grounds where mortal disappearances go unnoticed.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Praxis",
        "content": "The right of Princes to govern and administer their domain, including formal edicts, courts, and policies.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Progeny",
        "content": "All of a given vampire's childer and descendants considered collectively.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Regnant",
        "content": "A Kindred who holds a mystical blood bond over another vampire or ghoul.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Retainer",
        "content": "A mortal servant bound by blood, hypnosis, or loyalty to serve a vampiric master.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Siren",
        "content": "A vampire who seduces prey to feed without violence, taking modest quantities to leave the victim alive.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Suspire",
        "content": "The grueling spiritual ordeal and epiphany experienced on the threshold of achieving Golconda.",
        "source": "V20 Core, p. 33"
      },
      {
        "section": "Old Form",
        "title": "Third Mortal, The",
        "content": "Caine, who slew Abel and was cursed by God to become the First Vampire.",
        "source": "V20 Core, p. 34"
      },
      {
        "section": "Old Form",
        "title": "Thrall",
        "content": "An individual bound by a three-step blood bond to obey a regnant's will.",
        "source": "V20 Core, p. 34"
      },
      {
        "section": "Old Form",
        "title": "Vitae",
        "content": "The mystical life-blood of a vampire that fuels Disciplines and supernatural existence.",
        "source": "V20 Core, p. 34"
      },
      {
        "section": "Old Form",
        "title": "Whelp",
        "content": "A derogatory term for an inexperienced young Kindred, originally referring to one's own disappointing childer.",
        "source": "V20 Core, p. 34"
      },
      {
        "section": "Old Form",
        "title": "Whig",
        "content": "An elder's contemptuous term for a vampire who displays an unbecoming fascination with modern mortal trends.",
        "source": "V20 Core, p. 34"
      },
      {
        "section": "Old Form",
        "title": "Wight",
        "content": "A mortal human; also used for a vampire whose Humanity has dropped to zero, fully consumed by the Beast.",
        "source": "V20 Core, p. 34"
      },
      {
        "section": "Old Form",
        "title": "Witch-Hunter",
        "content": "A dedicated mortal inquisitor or hunter sworn to expose and destroy the undead.",
        "source": "V20 Core, p. 34"
      },
      {
        "section": "Vulgar Argot",
        "title": "Alleycat",
        "content": "A nomadic vampire who keeps no permanent haven, sleeping rough and feeding on the homeless.",
        "source": "V20 Core, p. 34"
      },
      {
        "section": "Vulgar Argot",
        "title": "Banking",
        "content": "The practice of stealing or purchasing refrigerated blood from blood banks or hospitals. Kindred who do this are called Bankers.",
        "source": "V20 Core, p. 34"
      },
      {
        "section": "Vulgar Argot",
        "title": "Black Hand (Slang)",
        "content": "A common Camarilla street misconception that refers to the Sabbat as a whole, rather than its elite internal militia.",
        "source": "V20 Core, p. 34"
      },
      {
        "section": "Vulgar Argot",
        "title": "Blister",
        "content": "A vampiric carrier who contracts human disease and spreads it indiscriminately across victims.",
        "source": "V20 Core, p. 34"
      },
      {
        "section": "Vulgar Argot",
        "title": "Blood Doll",
        "content": "A mortal groupie who willingly offers their veins to vampires for the euphoric high of the Kiss.",
        "source": "V20 Core, p. 34"
      },
      {
        "section": "Vulgar Argot",
        "title": "Bloodline",
        "content": "A lineage of vampires descended from a Clan that possesses distinct Disciplines or flaws without an Antediluvian founder.",
        "source": "V20 Core, p. 34"
      },
      {
        "section": "Vulgar Argot",
        "title": "Butterfly",
        "content": "A vampire who socializes exclusively among high-society elites, celebrities, and politicians to feed.",
        "source": "V20 Core, p. 34"
      },
      {
        "section": "Vulgar Argot",
        "title": "Casanova",
        "content": "A vampire who seduces mortals to feed peacefully, wiping their memories through Dominate or Presence.",
        "source": "V20 Core, p. 34"
      },
      {
        "section": "Vulgar Argot",
        "title": "Change, The",
        "content": "Street slang for the traumatic transformation of the Embrace.",
        "source": "V20 Core, p. 34"
      },
      {
        "section": "Vulgar Argot",
        "title": "Damned, The",
        "content": "All vampires; the undead race.",
        "source": "V20 Core, p. 34"
      },
      {
        "section": "Vulgar Argot",
        "title": "Donor",
        "content": "Sarcastic street slang for a human victim or feeding target.",
        "source": "V20 Core, p. 34"
      },
      {
        "section": "Vulgar Argot",
        "title": "Farmer",
        "content": "A term of derision for vampires who refuse to hunt humans and feed only on livestock or wild animals.",
        "source": "V20 Core, p. 34"
      },
      {
        "section": "Vulgar Argot",
        "title": "Fief",
        "content": "A sarcastic slang term for a Prince's claimed territory or domain.",
        "source": "V20 Core, p. 34"
      },
      {
        "section": "Vulgar Argot",
        "title": "Head",
        "content": "A vampire who feeds on drunk or high mortals to get a second-hand buzz (pothead, juicehead, smackhead).",
        "source": "V20 Core, p. 34"
      },
      {
        "section": "Vulgar Argot",
        "title": "Headhunter",
        "content": "A predatory vampire who tracks and feeds upon other Kindred.",
        "source": "V20 Core, p. 34"
      },
      {
        "section": "Vulgar Argot",
        "title": "Juicebag / Juice Box",
        "content": "Cynical street slang for mortals, reducing them to portable blood containers.",
        "source": "V20 Core, p. 34"
      },
      {
        "section": "Vulgar Argot",
        "title": "Lick",
        "content": "Common street slang for a vampire; a fellow member of the undead.",
        "source": "V20 Core, p. 34"
      },
      {
        "section": "Vulgar Argot",
        "title": "Rack, The",
        "content": "The city's prime nightlife strip (clubs, dive bars, party districts) where hunting is easy and discrete.",
        "source": "V20 Core, p. 35"
      },
      {
        "section": "Vulgar Argot",
        "title": "Rake",
        "content": "A habitual club-hopper who prowls the Rack every night to hunt.",
        "source": "V20 Core, p. 35"
      },
      {
        "section": "Vulgar Argot",
        "title": "Sandman",
        "content": "A vampire who stalks and feeds on sleeping mortals in their beds.",
        "source": "V20 Core, p. 35"
      },
      {
        "section": "Vulgar Argot",
        "title": "Slumming",
        "content": "Feeding on transients, vagrants, and the destitute in back alleys. Those who do so are Slummers.",
        "source": "V20 Core, p. 35"
      },
      {
        "section": "Vulgar Argot",
        "title": "Stalker",
        "content": "Neonate slang for a mortal vampire hunter or private investigator digging into Kindred affairs.",
        "source": "V20 Core, p. 35"
      },
      {
        "section": "Vulgar Argot",
        "title": "Tease",
        "content": "Street slang for a female Casanova who uses flirtation to lure prey.",
        "source": "V20 Core, p. 35"
      },
      {
        "section": "Vulgar Argot",
        "title": "Turf",
        "content": "A gang or coterie's claimed hunting perimeter or city blocks.",
        "source": "V20 Core, p. 35"
      },
      {
        "section": "Vulgar Argot",
        "title": "Vegetary",
        "content": "Sarcastic slang for a vampire living strictly on animal blood (synonymous with Farmer).",
        "source": "V20 Core, p. 35"
      },
      {
        "section": "Anarch Free State & Los Angeles Terms",
        "title": "Baron",
        "content": "An Anarch leader who exercises sway over an established domain, borough, or neighborhood through charisma, respect, or force (e.g., MacNeil, Abrams, Voerman, Nines Rodriguez).",
        "source": "V20 Anarchs Unbound, p. 6"
      },
      {
        "section": "Anarch Free State & Los Angeles Terms",
        "title": "Chancellor",
        "content": "An elected executive in an Anarch commune, overseeing municipal administration and community consensus.",
        "source": "V20 Anarchs Unbound, p. 6"
      },
      {
        "section": "Anarch Free State & Los Angeles Terms",
        "title": "Compact",
        "content": "A mutual-defense agreement or civic fraternity where members stand collective surety for one another. Also called krew, posse, or frankpledge.",
        "source": "V20 Anarchs Unbound, p. 6"
      },
      {
        "section": "Anarch Free State & Los Angeles Terms",
        "title": "Free State",
        "content": "The Anarch Free State, established in California following the 1944 uprising against Don Sebastian; also used generally for any independent Anarch territory lacking a Prince.",
        "source": "V20 Anarchs Unbound, p. 6"
      },
      {
        "section": "Anarch Free State & Los Angeles Terms",
        "title": "La Libertad",
        "content": "An Anarch domain's anniversary celebration, held throughout California on Cinco de Mayo, featuring the swearing-in of new citizens and civic rallies.",
        "source": "V20 Anarchs Unbound, p. 6"
      },
      {
        "section": "Anarch Free State & Los Angeles Terms",
        "title": "Legate",
        "content": "An envoy, diplomat, or undercover strongarm dispatched between baronies to negotiate alliances or conduct reconnaissance (derisively called Cheka).",
        "source": "V20 Anarchs Unbound, p. 6"
      },
      {
        "section": "Anarch Free State & Los Angeles Terms",
        "title": "Libertas",
        "content": "The foundational principle of the Status Perfectus declaring that free will is an inherent spiritual right of all Kindred.",
        "source": "V20 Anarchs Unbound, p. 8"
      },
      {
        "section": "Anarch Free State & Los Angeles Terms",
        "title": "Molotow",
        "content": "A traveling provocateur or insurgent-for-hire employed by Anarch domains to harass Camarilla borders while maintaining plausible deniability.",
        "source": "V20 Anarchs Unbound, p. 8"
      },
      {
        "section": "Anarch Free State & Los Angeles Terms",
        "title": "Old Volunteer",
        "content": "A veteran who distinguished themselves in the historic Anarch revolts (such as the 1944 Los Angeles revolt) and commands deep generational respect.",
        "source": "V20 Anarchs Unbound, p. 8"
      },
      {
        "section": "Anarch Free State & Los Angeles Terms",
        "title": "President",
        "content": "Head of the executive branch in democratic Anarch domains practicing separation of powers.",
        "source": "V20 Anarchs Unbound, p. 8"
      },
      {
        "section": "Anarch Free State & Los Angeles Terms",
        "title": "Reeve",
        "content": "An Anarch domain's head of law enforcement, equivalent to a Camarilla Sheriff but subordinate to popular consent and community warrants.",
        "source": "V20 Anarchs Unbound, p. 8"
      },
      {
        "section": "Anarch Free State & Los Angeles Terms",
        "title": "Rule of Law",
        "content": "The core tenet that even Barons and revolutionary leaders are strictly subordinate to the laws agreed upon by popular consent.",
        "source": "V20 Anarchs Unbound, p. 8"
      },
      {
        "section": "Anarch Free State & Los Angeles Terms",
        "title": "Status Perfectus",
        "content": "The seminal 1944 revolutionary manifesto drafted by the Los Angeles Revolutionary Council declaring a Kindred society free of elder tyranny and clan prejudice.",
        "source": "V20 Anarchs Unbound, p. 8"
      },
      {
        "section": "Anarch Free State & Los Angeles Terms",
        "title": "Sweeper",
        "content": "A scout charged with scouring a barony to register new arrivals, identify unaligned neonates, and watch for Camarilla or Sabbat infiltrators.",
        "source": "V20 Anarchs Unbound, p. 8"
      },
      {
        "section": "Anarch Free State & Los Angeles Terms",
        "title": "Warlord",
        "content": "A tactical military commander elected during active war or siege with rival Sects (often designated 'Red Chief' alongside peacetime 'White Chiefs').",
        "source": "V20 Anarchs Unbound, p. 8"
      },
      {
        "section": "Sabbat & The Sword of Caine",
        "title": "Archbishop",
        "content": "The supreme ruler and spiritual commander of a Sabbat city or diocese, commanding all local packs.",
        "source": "V20 Core, p. 27"
      },
      {
        "section": "Sabbat & The Sword of Caine",
        "title": "Auctoritas Ritae",
        "content": "The 13 sacred, universal rituals practiced by all Sabbat members to maintain sect unity, purge fear, and renew loyalty to the Sword of Caine.",
        "source": "V20 Core, p. 507"
      },
      {
        "section": "Sabbat & The Sword of Caine",
        "title": "Bishop",
        "content": "A high-ranking Sabbat officer assisting the Archbishop, typically overseeing a designated precinct or operational branch of the crusade.",
        "source": "V20 Core, p. 27"
      },
      {
        "section": "Sabbat & The Sword of Caine",
        "title": "Code of Milan",
        "content": "The constitutional treaty of the Sabbat establishing pack autonomy, the right to call councils, the rite of Monomacy, and mutual defense against Antediluvians.",
        "source": "V20 Core, p. 41"
      },
      {
        "section": "Sabbat & The Sword of Caine",
        "title": "Creation Rites",
        "content": "The harrowing trial and test of fire through which a fledgling must survive to be formally recognized as True Sabbat.",
        "source": "V20 Core, p. 43"
      },
      {
        "section": "Sabbat & The Sword of Caine",
        "title": "Ductus",
        "content": "The operational and tactical leader of an individual Sabbat pack, directing combat, haven security, and mission logistics.",
        "source": "V20 Core, p. 42"
      },
      {
        "section": "Sabbat & The Sword of Caine",
        "title": "Ignoblis Ritae",
        "content": "Spontaneous or localized pack rituals created to build camaraderie, celebrate kills, or test bravery (such as the Fire Dance).",
        "source": "V20 Core, p. 508"
      },
      {
        "section": "Sabbat & The Sword of Caine",
        "title": "Loyalist",
        "content": "A member of the rebellious Sabbat faction claiming that each Cainite is their own master, resisting central decrees in the name of absolute freedom.",
        "source": "V20 Core, p. 40"
      },
      {
        "section": "Sabbat & The Sword of Caine",
        "title": "Monomacy",
        "content": "The sacred ritus of combat to the death used by Sabbat members to settle disputes of honor or challenge officers for leadership.",
        "source": "V20 Core, p. 41"
      },
      {
        "section": "Sabbat & The Sword of Caine",
        "title": "Pack",
        "content": "The fundamental family and combat unit of the Sabbat, bound together by the Vinculum and shared survival.",
        "source": "V20 Core, p. 42"
      },
      {
        "section": "Sabbat & The Sword of Caine",
        "title": "Pack Priest",
        "content": "The spiritual leader of a Sabbat pack responsible for conducting ritae, presiding over the Vaulderie, and guiding packmates on their Paths of Enlightenment.",
        "source": "V20 Core, p. 42"
      },
      {
        "section": "Sabbat & The Sword of Caine",
        "title": "Priscus",
        "content": "A venerable elder and advisor to the Sabbat Regent or Archbishop, prized for age and cunning (plural: Prisci).",
        "source": "V20 Core, p. 27"
      },
      {
        "section": "Sabbat & The Sword of Caine",
        "title": "Shovelhead",
        "content": "A mortal hastily Embraced, hit with a shovel, and buried alive in mass graves during wartime assaults to forge feral frontline cannon fodder.",
        "source": "V20 Core, p. 43"
      },
      {
        "section": "Sabbat & The Sword of Caine",
        "title": "Ultra-Conservative",
        "content": "The faction of ancient Sabbat elders who advocate strict military discipline and centralization to win the war of Gehenna.",
        "source": "V20 Core, p. 40"
      },
      {
        "section": "Sabbat & The Sword of Caine",
        "title": "Vaulderie",
        "content": "The core ritual of the Sabbat in which pack members commingle their vitae in a sacred chalice and drink together, forging the Vinculum.",
        "source": "V20 Core, p. 288"
      },
      {
        "section": "Sabbat & The Sword of Caine",
        "title": "Vinculum",
        "content": "The mystical loyalty bond formed between members of a pack through the Vaulderie, shattering existing blood bonds and replacing them with pack solidarity.",
        "source": "V20 Core, p. 288"
      },
      {
        "section": "Occult, Sorcery & Rituals",
        "title": "Akhu",
        "content": "The classical school of Setite blood sorcery drawn from the ancient religious and funeral rites of pharaonic Egypt.",
        "source": "V20 Rites of the Blood, p. 16"
      },
      {
        "section": "Occult, Sorcery & Rituals",
        "title": "Apprentice",
        "content": "The lowest rank in the Tremere hierarchy, ranging from newly Embraced fledglings to veteran researchers bound to their chantry.",
        "source": "V20 Rites of the Blood, p. 16"
      },
      {
        "section": "Occult, Sorcery & Rituals",
        "title": "Ashipu",
        "content": "A practitioner of Dur-An-Ki, traditionally an Assamite sorcerer adhering to the Mesopotamian mystical covenants.",
        "source": "V20 Rites of the Blood, p. 16"
      },
      {
        "section": "Occult, Sorcery & Rituals",
        "title": "Chantry",
        "content": "A protected redoubt and laboratory where Tremere gather to guard secrets, conduct Thaumaturgical research, and commune with the Pyramid.",
        "source": "V20 Rites of the Blood, p. 16"
      },
      {
        "section": "Occult, Sorcery & Rituals",
        "title": "Council of Seven",
        "content": "The seven highest-ranking Tremere Methuselahs, each directing Clan operations across an entire global hemisphere under Tremere himself.",
        "source": "V20 Rites of the Blood, p. 16"
      },
      {
        "section": "Occult, Sorcery & Rituals",
        "title": "Diabolist / Demonologist",
        "content": "An infernalist who summons, bargains with, or studies demonic entities in exchange for dark investments.",
        "source": "V20 Rites of the Blood, p. 16"
      },
      {
        "section": "Occult, Sorcery & Rituals",
        "title": "Dur-An-Ki",
        "content": "Ancient blood magic originating in Mesopotamia, practiced by Banu Haqim sorcerers channeling celestial covenants and planetary deities.",
        "source": "V20 Rites of the Blood, p. 16"
      },
      {
        "section": "Occult, Sorcery & Rituals",
        "title": "Houngan",
        "content": "A priest in Afro-Caribbean Voudoun traditions, applicable in the context of both Wanga and Voudoun Necromancy.",
        "source": "V20 Rites of the Blood, p. 16"
      },
      {
        "section": "Occult, Sorcery & Rituals",
        "title": "Nahuallotl",
        "content": "The Mesoamerican blood sorcery practiced primarily by the Tlacique bloodline, rooted in heart sacrifices and solar renewal.",
        "source": "V20 Rites of the Blood, p. 16"
      },
      {
        "section": "Occult, Sorcery & Rituals",
        "title": "Necromancer",
        "content": "A generic descriptor for any practitioner of Necromancy, the art of manipulating corpses, spirits, and the energies of the Underworld.",
        "source": "V20 Rites of the Blood, p. 16"
      },
      {
        "section": "Occult, Sorcery & Rituals",
        "title": "Pyramid, The",
        "content": "The worldwide, rigidly disciplined hierarchy that controls all Tremere chantries, councils, and apprentices across the globe.",
        "source": "V20 Rites of the Blood, p. 17"
      },
      {
        "section": "Occult, Sorcery & Rituals",
        "title": "Regent",
        "content": "The middle management of Clan Tremere who oversees a regional chantry, monitors apprentices, and enforces Clan policy.",
        "source": "V20 Rites of the Blood, p. 17"
      },
      {
        "section": "Occult, Sorcery & Rituals",
        "title": "Sadhana",
        "content": "The Indian school of blood sorcery drawn from Vedic beliefs and ascetic disciplines, practiced by the Daitya bloodline.",
        "source": "V20 Rites of the Blood, p. 17"
      },
      {
        "section": "Occult, Sorcery & Rituals",
        "title": "Thaumaturge",
        "content": "A generic term for a Kindred practicing blood magic, originating from Hermetic traditions and popularized by the Camarilla.",
        "source": "V20 Rites of the Blood, p. 17"
      },
      {
        "section": "Occult, Sorcery & Rituals",
        "title": "Voudoun",
        "content": "A religion and spiritual framework integrated with Necromancy and Wanga, popular among Caribbean and Louisiana Kindred.",
        "source": "V20 Rites of the Blood, p. 17"
      },
      {
        "section": "Occult, Sorcery & Rituals",
        "title": "Wanga",
        "content": "A diverse collection of magical practices and curse-craft stemming from Caribbean slave communities and spirit pacts.",
        "source": "V20 Rites of the Blood, p. 17"
      },
      {
        "section": "LA Campaign: History & Major Operations",
        "title": "1944 Anarch Free State Revolt & Fall of Don Sebastian",
        "content": "In 1944, Brujah revolutionary Jeremy MacNeil led a ferocious armed rebellion against Los Angeles' tyrannical Camarilla Prince, Don Sebastian Juan Dominguez, after Sebastian ordered MacNeil beaten for minor insolence. The ensuing popular uprising purged the Camarilla court from the basin, drove Sebastian to his Final Death, and permanently established Los Angeles as the global capital of the Anarch Free State.",
        "source": "V20 Anarchs Unbound, p. 8; Campaign Lore"
      },
      {
        "section": "LA Campaign: History & Major Operations",
        "title": "Battle of the Memorial Coliseum",
        "content": "A massive psychic and social clash staged during an NFL game between the LA Rams and SF 49ers at Exposition Park. With over 70,000 mortals acting as an emotional furnace, Anarch figures Jeremy MacNeil, Smiling Jack, and Misty Vane rallied crowd frenzy to sharpen revolutionary fervor. The spectacle drew a tense confrontation with Archon Theo Bell, revealing deep fractures between Anarch factions and Camarilla overseers.",
        "source": "Session 15 & 16 Plot"
      },
      {
        "section": "LA Campaign: History & Major Operations",
        "title": "Burbank Airport Private Hangar Summit",
        "content": "A secretive, high-level debriefing conducted inside a private executive hangar at Burbank Airport. Archon Theo Bell and Prince Meredith Vereira confronted the coterie following the Lynn Ranch Sabbat raid and the daylight sniper murder of Jade Nguyen. In exchange for the coterie's intelligence on Tzimisce shipping at the docks, the Camarilla sanctioned their territorial claim over the West Covina Church domain.",
        "source": "Session 23 Plot"
      },
      {
        "section": "LA Campaign: History & Major Operations",
        "title": "CS Volga Spirit Incident",
        "content": "A major maritime intelligence operation at the Port of Los Angeles (WBCT Berth 09). The Russian container ship CS Volga Spirit arrived from Vladivostok carrying container 090482, loaded with six bulk polypropylene bags of native soil from Tzimisce homelands, fraudulent identity papers, and a classified German police report linking identical bite-mark homicides across 80 years, proving a direct Camarilla Masquerade breach.",
        "source": "Session 10 Plot & Church Land.json"
      },
      {
        "section": "LA Campaign: History & Major Operations",
        "title": "Daylight Assassination of Jade Nguyen",
        "content": "A catastrophic breach and tragedy in Downtown Los Angeles. Jade Nguyen, an aspiring young actress and Toreador/Ventrue ghoul close to Elliot 'Shane' Mercer, was executed in broad daylight by an elite mortal sniper team outside the Stellaris Conservatory. The assassination confirmed that organized mortal hunter cells (First Light / SAD) are operating with advanced military weaponry within the city.",
        "source": "Session 23 Plot"
      },
      {
        "section": "LA Campaign: History & Major Operations",
        "title": "Fall of House Crimson Sigils",
        "content": "A devastating assault by Sabbat shock troops against the Tremere chantry of House Crimson Sigils. Led by Archbishop Delacroix, Marcus 'Ironfist', and a massive fleshcrafted Vozhd, the Sabbat shattered the exterior ward stones. Sentinel Gareth MacDougal and the 200-year-old granite Gargoyle Stoneheart made a bloody final stand in the great foyer before the chantry was entirely annihilated.",
        "source": "The Last Stand at House Crimson Sigils.json"
      },
      {
        "section": "LA Campaign: History & Major Operations",
        "title": "Harrison Residence Fleshcrafting Horror",
        "content": "A horrifying scene investigated by Balthazar in South Central. Tzimisce fleshcrafter Arsenio Hall confiscated the suburban home of the mortal Harrison family, mutilating them into structural biological traps and keeping a dormant Vozhd alongside shotgun-wielding fleshcrafted sentinels in a reinforced subterranean vault.",
        "source": "Session 5 Plot"
      },
      {
        "section": "LA Campaign: History & Major Operations",
        "title": "Lynn Ranch Abduction & Extraction",
        "content": "A high-stakes tactical raid in the equestrian hills near Thousand Oaks. Reverend Frederik King was ambushed and captured on the church grounds by Lasombra shadow-wielder Rafael de Andueza and Bishop Sébastién Debs. After being held at the fortified Lynn Ranch Sabbat compound, Frederik was liberated in a synchronized assault by the coterie, leaving the enemy safehouse heavily damaged by fire.",
        "source": "Session 17, 18 & 22 Plot"
      },
      {
        "section": "LA Campaign: History & Major Operations",
        "title": "Neon Temple Street Riot",
        "content": "A volatile midnight brawl outside the Neon Temple club in Hollywood. Over twenty vampires clashed on the street, pitting Anarch leaders Jeremy MacNeil and Smiling Jack against Antifa-styled Caitiff agitators waving red-and-black flags. The melee escalated into gunfire when a rooftop sniper with the Quietus discipline opened fire, drawing immediate LAPD attention.",
        "source": "Session 4, 5 & 6 Plot"
      },
      {
        "section": "LA Campaign: History & Major Operations",
        "title": "Operation Bayside Blue",
        "content": "A high-precision luxury vehicle heist executed in Palos Verdes Estates. Orchestrated by Liam Johnson, the coterie breached the cliffside mansion of paranoid crypto-millionaire Devon 'Vandal' Vance, evading motion-tracking security cameras to liberate a pristine, factory-original Bayside Blue Nissan Skyline GT-R (R34) for South Central smuggler contacts.",
        "source": "Liam GTA Mission 1.json"
      },
      {
        "section": "LA Campaign: History & Major Operations",
        "title": "Status Perfectus (The Perfect State)",
        "content": "The historic 1944 revolutionary manifesto drafted by the Los Angeles Revolutionary Council following the fall of Don Sebastian. It codified the principles of the Anarch Free State: absolute rejection of elder hegemony, mutual defense regardless of clan, popular accountability for Barons, and the spiritual sanctity of Kindred libertas.",
        "source": "V20 Anarchs Unbound, p. 8"
      },
      {
        "section": "LA Campaign: History & Major Operations",
        "title": "West Covina Bastion Fortification",
        "content": "The systematic engineering of the former Presbyterian church in West Covina into an impregnable Haven for the coterie. Funded by $400k in foundational backing and $15k in debris clearance, the site features two subterranean bunker floors, four concentric defensive rings of gasoline and explosives laid by George Michael, and a natural gas connection to explain away potential explosions.",
        "source": "Session 11, 22 & 23 Plot"
      },
      {
        "section": "LA Campaign: Factions, Sects & Networks",
        "title": "Anarch Free State Council",
        "content": "The decentralized alliance of territorial Barons, neighborhood warlords, and revolutionary veterans presiding over the greater Los Angeles basin. Anchored by figures like Jeremy MacNeil, Nines Rodriguez (Downtown), and Victor Temple, the council struggles to balance libertarian freedom against encroaching Camarilla embassies and violent Sabbat incursions.",
        "source": "Campaign Lore & Session 15 Plot"
      },
      {
        "section": "LA Campaign: Factions, Sects & Networks",
        "title": "Bar Afterlife & Rams Syndicate",
        "content": "The primary philosophical and tactical center for Downtown Kindred, located on Central Avenue. Managed by Brujah Primogen Salvador Garcia alongside Seneschal 'Big' Ed Hurley, the sports bar doubles as an intense game-day sanctuary for LA Rams fans and a neutral ground for political arbitration between Anarch ancillae and Camarilla diplomats.",
        "source": "Session 13 Plot & locations.json"
      },
      {
        "section": "LA Campaign: Factions, Sects & Networks",
        "title": "Camarilla Court of Los Angeles",
        "content": "The sovereign Ivory Tower administration maintaining a precarious, heavily armed foothold across the metropolitan area. Governed from the Dorothy Chandler Pavilion by Ventrue Prince Meredith Vereira, the court relies on Seneschal Ed Hurley, Sheriff Anthohimondrona Tsuoranoannddy, Keeper Amanda Byers, and Harpy Audrey Horne to enforce the Traditions.",
        "source": "Chronology.json & locations.json"
      },
      {
        "section": "LA Campaign: Factions, Sects & Networks",
        "title": "Clan Tremere Chantry of the Angels",
        "content": "The official Camarilla chantry in Los Angeles, currently grappling with occult instability and security paranoia following the catastrophic destruction of House Crimson Sigils. Its Hermetic sorcerers aggressively monitor unusual magical surges and black-market relic trading.",
        "source": "House Crimson Sigils.json & Campaign Lore"
      },
      {
        "section": "LA Campaign: Factions, Sects & Networks",
        "title": "Latin Kings Auto Theft Network",
        "content": "A powerful South Central street and auto-smuggling syndicate liaised by David Martinez and senior operative Hernando Fabregas. The organization works closely with Liam Johnson to fence exotic stolen vehicles, procure untraceable transport, and provide street-level muscle.",
        "source": "Latin Kings.json & Session 8 Plot"
      },
      {
        "section": "LA Campaign: Factions, Sects & Networks",
        "title": "Mortal Hunter Enclave (First Light / SAD)",
        "content": "A lethal, highly coordinated cell of mortal witch-hunters and government special agents operating covertly within Los Angeles. Led by tactical operatives like Erica '5ynaps3' Milton, Sir Isaac Townsend, Joshua Preston, and Jacob Singer, the cell demonstrated its reach with the daylight sniper assassination of Jade Nguyen.",
        "source": "npcs.json & Session 23 Plot"
      },
      {
        "section": "LA Campaign: Factions, Sects & Networks",
        "title": "Sabbat Simi Valley / Lynn Ranch Diocese",
        "content": "A violent, covert Sword of Caine cell entrenched in Thousand Oaks, Simi Valley, and the northern hills. Led by Lasombra Bishop Sébastién Debs, shadow-infiltrator Rafael de Andueza, and Irina Kozlov, the pack specializes in grave looting, psychological terror, and haven raids.",
        "source": "Session 17, 18 & npcs.json"
      },
      {
        "section": "LA Campaign: Factions, Sects & Networks",
        "title": "The Sabbat Sire Syndicate",
        "content": "The chilling revelation uncovered by the coterie that their respective sires—Clayton White, Philip Zambardo, and Keith Brown—are not merely rogue elders, but high-ranking Sabbat ideologues and operational architects running deep-cover infiltration missions across Los Angeles.",
        "source": "Sires.json & npcs.json"
      },
      {
        "section": "LA Campaign: Factions, Sects & Networks",
        "title": "West Covina Flock (Church of the New Dawn)",
        "content": "Reverend Frederik King's rapidly expanding mortal congregation and veteran community. Based at the renovated West Covina sanctuary, the flock is administered by ghouls John Carmac and George Michael with pastoral coordination by Mrs. Martha Gable, giving the coterie an impassioned mortal shield and loyal herd.",
      ...
      },
      {
        ...
        "source": "Balthazar's availability.json & Session 2 Plot"
      },
      {
        "section": "LA Campaign: The Coterie & Inner Circle",
        "title": "Bernard Tulle ('DJ Warlock')",
        "content": "An Auspex-gifted occult specialist and techno-shaman allied with Balthazar. Operating under the alias 'DJ Warlock', Bernard uses his psychic sensitivities (Spirit's Touch) and dockside connections to inspect suspect cargo containers and monitor occult artifacts.",
        "source": "Session 10 Plot & Balthazar's availability.json"
      },
      {
        "section": "LA Campaign: The Coterie & Inner Circle",
        "title": "Chris Partlow",
        "content": "A disciplined, stone-faced retired soldier bound as a trusted ghoul to Elliot 'Shane' Mercer. Partlow provides professional executive protection, surveillance detection, and military discipline, ensuring Shane's artistic pursuits remain secure from street interference.",
        "source": "pcs.json"
      },
      {
        "section": "LA Campaign: The Coterie & Inner Circle",
        "title": "Clayton White",
        "content": "An 8th Generation Brujah and sire of Liam Johnson. An emancipated slave from 1870 harboring an enduring hatred for white racial institutions, Clayton operates as a formidable revolutionary architect in the Sabbat, selecting Liam after spotting him stealing vehicles from neo-Nazis.",
        "source": "Sires.json & npcs.json"
      },
      {
        "section": "LA Campaign: The Coterie & Inner Circle",
        "title": "Elliot 'Shane' Mercer",
        "content": "8th Generation Toreador player character. Formerly a neglected street urchin, Shane rose to prominence as a brilliant modern artist and cultural icon. His unlife was shattered by the daylight sniper assassination of his beloved ghoul Jade, driving him toward vengeance.",
        "source": "pcs.json & Session 23 Plot"
      },
      {
        "section": "LA Campaign: The Coterie & Inner Circle",
        "title": "Frederic King",
        "content": "8th Generation Malkavian player character. An excommunicated Amish preacher whose divine delusions and potent Dementation led him to found the Church of the New Dawn in West Covina, where he presides over a devoted flock under a solemn vow of silence.",
        "source": "pcs.json & Session 11, 14, 22 Plot"
      },
      {
        "section": "LA Campaign: The Coterie & Inner Circle",
        "title": "George Michael",
        "content": "An Amish military combat veteran suffering from severe PTSD, now bound as a devoted ghoul to Frederic King. George manages the coterie's heavy firearms, defensive explosive rings, and tactical fortifications around the West Covina church property.",
        "source": "pcs.json & Session 17, 22 Plot"
      },
      {
        "section": "LA Campaign: The Coterie & Inner Circle",
        "title": "Isabel Turner",
        "content": "8th Generation Ventrue player character. A sharp, elegant corporate litigator and estate strategist maneuvering through high-society boardrooms. She balances domain politics while shielding her dominated mortal husband Kevin from predatory elder schemes.",
        "source": "pcs.json & Session 5, 8 Plot"
      },
      {
        "section": "LA Campaign: The Coterie & Inner Circle",
        "title": "Jade Nguyen (In Memoriam)",
        "content": "An aspiring young actress and Toreador/Ventrue ghoul studying at the Stellaris Conservatory, deeply beloved by Shane Mercer. Her brutal daylight assassination by mortal snipers in Downtown Los Angeles catalyzed the coterie's investigation into citywide hunter networks.",
        "source": "pcs.json & Session 23 Plot"
      },
      {
        "section": "LA Campaign: The Coterie & Inner Circle",
        "title": "John Carmac",
        "content": "A savvy modern Amish marketing freelancer bound as a primary ghoul to Frederic King. John manages the daytime bureaucracy, banking accounts, contractor negotiations, and public relations for the Church of the New Dawn.",
        "source": "pcs.json & Session 11, 14, 22 Plot"
      },
      {
        "section": "LA Campaign: The Coterie & Inner Circle",
        "title": "Katrine Sterling",
        "content": "A disgraced aerospace drone technician and skilled hacker bound as a ghoul to Frederic King. She oversees electronic warfare, forensic camera scrubbing, encrypted communications, and aerial drone surveillance for the coterie.",
        "source": "pcs.json & Session 14, 22 Plot"
      },
      {
        "section": "LA Campaign: The Coterie & Inner Circle",
        "title": "Keith Brown",
        "content": "An 8th Generation Ventrue and sire of Isabel Turner. Known publicly as an executive producer of gritty grindhouse films, Keith is secretly a major Sabbat media mogul pulling strings behind independent production houses and cinematic distribution.",
        "source": "Sires.json & npcs.json"
      },
      {
        "section": "LA Campaign: The Coterie & Inner Circle",
        "title": "Liam Johnson ('L.J.')",
        "content": "8th Generation Brujah player character. An elite wheelman and criminal GTA specialist with 5 dots in Drive and potent Celerity. Liam won his signature muscle car in a street race against Hector and maintains close ties with the Latin Kings auto theft syndicate.",
        "source": "pcs.json & Session 4 Plot"
      },
      {
        "section": "LA Campaign: The Coterie & Inner Circle",
        "title": "Mrs. Martha Gable",
        "content": "A warm, devout mortal matriarch and church volunteer coordinator managing prayer chains, food drives, and charity bake sales at the Church of the New Dawn. She reveres Frederik King as a holy, ascetic man of God recovering from a severe spiritual trial.",
        "source": "pcs.json & Session 23 Plot"
      },
      {
        "section": "LA Campaign: The Coterie & Inner Circle",
        "title": "Philip Zambardo",
        "content": "An 8th Generation Malkavian and sire of Frederic King. A disgraced academic psychologist involved in the Stanford prison experiment, Zambardo was Embraced late in natural life and is feared within the Sabbat as 'The Hollow Saint' for his terrifying psychological conditioning.",
        "source": "Sires.json & npcs.json"
      },
      {
        "section": "LA Campaign: The Coterie & Inner Circle",
        "title": "Princess Donna Delore",
        "content": "An 8th Generation Toreador and sire of Shane Mercer. Embraced in the early 1980s, Donna made a fortune producing early home video and adult films before reinventing herself as an elite body artist, now operating an exclusive tattoo haven in Arcadia.",
        "source": "Sires.json"
      },
      {
        "section": "LA Campaign: The Coterie & Inner Circle",
        "title": "Rachel Teller",
        "content": "An exceptionally beautiful and resourceful woman bound as a loyal ghoul to Liam Johnson. She assists Liam with surveillance, target scouting, and liaison work across Los Angeles.",
        "source": "pcs.json & Session 4, 8, 17 Plot"
      },
      {
        "section": "LA Campaign: Key Locales & Havens",
        "title": "Arcadia Tattoo Parlor",
        "content": "Princess Donna Delore's vibrant, warded studio and haven in Arcadia. Combining neon aesthetics, sacred geometry, and high-end artistic tattoo equipment, it serves as a secure sanctuary where Toreador artists and discreet guests congregate.",
        "source": "Sires.json & Session 2 Plot"
      },
      {
        "section": "LA Campaign: Key Locales & Havens",
        "title": "Bar Afterlife",
        "content": "A high-end sports bar and lounge on Central Avenue in Downtown Los Angeles. Featuring dark brick, leather booths, and an intimate backroom, it serves as Salvador Garcia's philosophical salon and the primary rallying hub for passionate LA Rams tailgaters.",
        "source": "locations.json & Session 13 Plot"
      },
      {
        "section": "LA Campaign: Key Locales & Havens",
        "title": "Church of the New Dawn (West Covina Bastion)",
        "content": "The coterie's fortified primary haven in West Covina, situated on a former Presbyterian church property. Engineered with two reinforced subterranean bunker crypts, heavy blast doors, and concentric defensive fuel trenches, all masked behind an active Christian ministry.",
        "source": "locations.json & Session 11, 22 Plot"
      },
      {
        "section": "LA Campaign: Key Locales & Havens",
        "title": "Dorothy Chandler Pavilion",
        "content": "The grand, sweeping cultural centerpiece of Downtown Los Angeles. Built with glass, polished marble, and crystal chandeliers, it operates as Prince Meredith Vereira's primary formal Elysium under the protection of the Pax Vampirica.",
        "source": "locations.json"
      },
      {
        "section": "LA Campaign: Key Locales & Havens",
        "title": "Iron Curtain Bunker & Silver Lake Laundromat",
        "content": "The subterranean Haven and electronic listening post of Nosferatu Primogen Silas 'Root' Thorne. Concealed behind a commercial laundromat in Silver Lake, the facility houses air-gapped mainframes monitoring traffic cameras, telephone trunks, and municipal telemetry.",
        "source": "chronology.json & locations.json"
      },
      {
        "section": "LA Campaign: Key Locales & Havens",
        "title": "Lynn Ranch Compound",
        "content": "A secluded equestrian property nestled in the hills near Thousand Oaks and the Ventura County line. Utilized by Sabbat Bishop Sébastién Debs and Rafael de Andueza as an interrogation base and safehouse until heavily scorched during the coterie's rescue raid.",
        "source": "Session 17, 18, 22 Plot"
      },
      {
        "section": "LA Campaign: Key Locales & Havens",
        "title": "Neon Temple",
        "content": "A pulsing, multi-tier industrial gothic nightclub in Hollywood. Known for ear-shattering electronic music, strobe-lit dance floors, and private VIP lounges, it serves as a premier hunting ground for fledglings, ghouls, and Anarch youth.",
        "source": "Session 4, 5, 6 Plot"
      },
      {
        "section": "LA Campaign: Key Locales & Havens",
        "title": "Pinnacle Vault Gallery",
        "content": "An ultra-modern, fortified art gallery on Camden Drive in Beverly Hills constructed from black granite and tempered glass. Owned and curated for exclusive Toreador exhibitions, high-stakes auctions (Ewald Borsod), and private Kindred diplomacy.",
        "source": "Ewald's Performance opening.json & Chronology.json"
      },
      {
        "section": "LA Campaign: Key Locales & Havens",
        "title": "The Bleeding Heart",
        "content": "A discrete, low-lit gentlemen's club in West Covina. Operating well into the early morning hours, it serves as the coterie's primary local feeding ground and suburban rumor mill after 3:00 AM.",
        "source": "Session 22 Plot"
      },
      {
        "section": "LA Campaign: Key Locales & Havens",
        "title": "WBCT Berth 09 (Port of Los Angeles)",
        "content": "A massive deep-water shipping berth at the West Basin Container Terminal in San Pedro. Dominated by towering gantry cranes and endless stacks of shipping containers, it was the site of the CS Volga Spirit interception.",
        "source": "Session 10 Plot & Church Land.json"
      }
    ]
  },
  "mechanics": [
    {
      ...
      "filename": "appendix_combat_systems.md",
      "content": "# Appendix — Combat Systems & Maneuvers (V20 Core)\n\nSource: **V20 Core Rulebook** Chapter Six: Systems and Drama, pp. 271–281. Light\nformat: turn structure, initiative, attack, maneuvers, damage resolution, armor,\nand weapons. Combat rules are guidelines — the Storyteller is the final arbiter.\n\n## Types of combat (p. 271)\n\n- **Close combat** — unarmed (Dexterity + Brawl; within 1 yard/m) and melee\n  (Dexterity + Melee; within 2 yards/m).\n- **Ranged combat** — projectile weapons (Dexterity + Firearms for guns,\n  Dexterity + Athletics for thrown); needs sight and range.\n\n## Combat turns (pp. 271–273)\n\nCombat is divided into **three-second turns**, each with three stages:\n\n**Stage One: Initiative**\n- Roll **one die** and add it to the **initiative rating (Dexterity + Wits)**;\n  Celerity adds its dots to Dexterity-related rolls, including initiative\n  (confirmed by the example of play, p. 302). Highest total acts first.\n- **Everyone declares their actions** in reverse order of initiative; actions\n  may be delayed to any later point in the order.\n- **Declare multiple actions** (splitting pools) at this stage, and **declare\n  Discipline activation and Willpower expenditure**.\n- Actions can be **aborted** to a defensive action (block/dodge/parry) at any\n  time before the character acts, via a successful Willpower roll (diff 6) or by\n  spending 1 WP.\n- **Yielding**: a character may allow the next-highest initiative to act; if\n  everyone yields, nothing happens that turn.\n\n**Stage Two: Attack**\n- Unarmed: Dexterity + Brawl. Melee: Dexterity + Melee. Ranged: Dexterity +\n  Firearms (or Athletics for thrown).\n- **Each extra success on the attack roll adds one automatic die to the damage\n  dice pool** (the \"cinematic\" combat escalator).\n\n**Stage Three: Resolution**\n- Determine total damage effect (weapon type or maneuver) plus the extra dice\n  from attack successes.\n- **Targets may attempt to soak** (reflexive, no pool split).\n\n## Damage types (p. 272)\n\n- **Bashing** — punches, clubs, blunt trauma; vs mortals soaked with full\n  Stamina; marked with \"/\".\n- **Lethal** — knives, bullets, swords; mortals may NOT soak it; vampires soak\n  with Stamina; marked with \"X\".\n- **Aggravated** — fire, sunlight, teeth and claws of vampires/werewolves/\n  supernaturals; **soakable only with Fortitude**; marked with \"*\".\n- Damage dice pools can never drop below **1 die**. Damage and soak rolls\n  **cannot botch** — a \"botch\" damage roll just glances harmlessly.\n\n## Soak (p. 272)\n\n- Soak pool = **Stamina** (+ **Fortitude** against bashing and lethal; against\n  aggravated, **only Fortitude**).\n- Soak is **reflexive** (no action, no pool split). Default difficulty **6**.\n- Each soak success subtracts one die's worth of damage. Soak rolls only fail,\n  never botch.\n\n## Armor (pp. 272, 280)\n\n- Armor **adds its rating to the soak dice pool** against bashing, lethal, and\n  aggravated (from teeth/claws). **No protection vs fire or sunlight.**\n- Armor is destroyed if a single attack's damage roll equals **twice the armor's\n  rating**.\n- Armor penalty subtracts dice from Dexterity-based pools.\n- Targeting unprotected areas (typically +1 or +2 difficulty) bypasses armor.\n\n| Class | Rating | Penalty |\n|---|---|---|\n| Class One (reinforced clothing) | 1 | 0 |\n| Class Two (armor T-shirt) | 2 | 1 |\n| Class Three (Kevlar vest) | 3 | 1 |\n| Class Four (flak jacket) | 4 | 2 |\n| Class Five (full riot gear) | 5 | 3 |\n\n## General maneuvers (p. 274)\n\n- **Aborting actions** — drop your declared action for block/dodge/parry if you\n  haven't acted yet; needs a Willpower roll (diff 6) or 1 WP (declared at abort).\n- **Ambush** — Dexterity + Stealth (resisted) vs Perception + Alertness; win =\n  one free attack, extra successes added to the attack pool; tie = attacker still\n  first but target may defend; target win = spotted, normal initiative. Targets\n  already in combat can't be ambushed.\n- **Blind fighting** — +2 difficulty; ranged attacks can't be made accurately at\n  all (Heightened Senses, Eyes of the Beast mitigate).\n- **Flank attacks** +1 attack die; **rear attacks** +2 attack dice.\n- **Movement** — move up to half running speed and still act; each yard moved\n  while acting subtracts 1 die from that action.\n- **Targeting** — aim for a specific location: +1 diff (medium: limb, briefcase,\n  no damage mod); +2 diff (small: hand, head — +1 damage); +3 diff (precise:\n  eye, heart — +2 damage).\n- **Multiple opponents** — +1 difficulty (cumulative, max +4) to attack AND\n  defend per extra opponent.\n\n## Defensive maneuvers (pp. 274–275)\n\nAll are **resisted against the attack roll** — the attacker needs more successes\nthan the defender to hit; the defender's successes reduce the attacker's net\nsuccesses even if she can't fully stop the attack. Declare any time before the\nattacker rolls, if you have an action left (or abort).\n\n- **Block** — Dexterity + Brawl; body deflects a hand-to-hand **bashing** attack\n  only; lethal/aggravated need Fortitude or armor.\n- **Dodge** — Dexterity + Athletics; avoids any attack type. No room to maneuver\n  → must block/parry. Vs gunfire: move ≥1 yard and get behind cover (or drop\n  prone); cover rules then apply.\n- **Parry** — Dexterity + Melee; uses a weapon vs Brawl/Melee. If the parry beats\n  the attacker's successes, the attacker may take the weapon's base damage plus\n  the parry's extra successes.\n- **Full defense turn** — don't split pools; first defense uses full pool, each\n  subsequent defense −1 die cumulative.\n\n## Close combat maneuvers (pp. 275–276)\n\n| Maneuver | Traits | Accuracy | Difficulty | Damage |\n|---|---|---|---|---|\n| Bite | Dex + Brawl | +1 | Normal | Str +1 (aggravated) |\n| Block | Dex + Brawl | Special | Normal | None (reduces attack) |\n| Claw | Dex + Brawl | Normal | Normal | Str +1 (aggravated if Feral Claws) |\n| Clinch | Str + Brawl | Normal | Normal | Str (carries over turns) |\n| Disarm | Dex + Melee | Normal | +1 | Special |\n| Dodge | Dex + Athletics | Special | Normal | None (reduces attack) |\n| Hold | Str + Brawl | Normal | Normal | None (carries over) |\n| Kick | Dex + Brawl | Normal | +1 | Str +1 |\n| Parry | Dex + Melee | Special | Normal | None (reduces attack) |\n| Strike | Dex + Brawl | Normal | Normal | Str |\n| Sweep | Dex + Brawl/Melee | Normal | +1 | Str + knockdown |\n| Tackle | Str + Brawl | Normal | +1 | Str +1 + knockdown |\n| Weapon Strike | Dex + Melee | Normal | Normal | Weapon |\n\nDetails:\n- **Bite / Kiss**: A bite needs a successful clinch/hold/tackle first, then bites\n  next turn; aggravated. A **Kiss** does no damage but lets the vampire drain\n  blood at the normal rate (victim usually helpless); the wound can be licked\n  closed.\n- **Claw**: aggravated if from Feral Claws; lethal if Vicissitude-constructed.\n- **Clinch**: first turn Strength damage; each subsequent turn either Strength\n  damage automatically or escape via resisted **Strength + Brawl**.\n- **Hold**: immobilizes until the target wins a resisted Strength + Brawl.\n- **Sweep**: target rolls **Dexterity + Athletics (diff 8)** or is knocked down.\n- **Tackle**: both parties roll **Dexterity + Athletics (diff 7)** or knockdown;\n  even a successful target is at +1 difficulty next turn.\n- **Disarm**: attack at +1 difficulty; if successes exceed the opponent's\n  Strength, no damage but they're disarmed. Botch = you drop your weapon or get\n  hit.\n- **Weapon length**: a shorter-weapon attacker must close 1 yard (losing 1 die).\n\n## Ranged combat maneuvers (pp. 277–278)\n\n| Maneuver | Traits | Accuracy | Difficulty | Damage |\n|---|---|---|---|---|\n| Aiming | — | +1/turn (max Perception) | Normal | — |\n| Automatic Fire | Dex + Firearms | +10 | +2 | Special |\n| Multiple Shots | Dex + Firearms | Special | Normal | Weapon |\n| Strafing | Dex + Firearms | +10 | +2 | Special |\n| Three-Round Burst | Dex + Firearms | +2 | +1 | Weapon |\n| Two Weapons | Dex + Firearms | Normal | +1 (off-hand) | Weapon |\n\n- **Aiming** — +1 die per turn spent aiming, max = Perception (Firearms 1+\n  required; a scope adds +2 on the first turn). Can't aim at a target moving\n  faster than a walk.\n- **Automatic fire** — unloads the clip on one target: +10 accuracy, +2\n  difficulty (recoil), damage treated as one bullet; clip must be ≥ half full;\n  can't target specific body areas.\n- **Cover** — light (prone) +1, good (behind wall) +2, superior (only head\n  exposed) +3 to hit; firing back from cover is −1 difficulty vs listed; cover\n  penalties are cumulative between combatants.\n- **Range** — difficulty 6 at short range; difficulty 8 out to twice the listed\n  range; **point blank (≤2 m) = difficulty 4**.\n- **Reloading** — one full turn (can be part of a multiple action).\n- **Strafing** — +10 accuracy, empties the clip over up to 3 yards; successes\n  divided among targets; Dodge vs strafing at +1 difficulty.\n- **Three-round burst** — +2 dice, +1 difficulty (recoil), 3 shots, damage of\n  one bullet.\n- **Two weapons** — multiple action (split lowest pool) + +1 difficulty off-hand\n  (unless ambidextrous).\n\n## Maneuver complications (pp. 278–279)\n\n- **Blinded** — +2 dice to hit a blinded target; a blinded character is at +2\n  difficulty on all actions.\n- **Dazed** — if damage successes exceed the target's Stamina (mortal) or\n  Stamina + 2 (vampire/supernatural), the victim must spend her next turn shaking\n  it off. Only soak-penetrating successes count.\n- **Immobilization** — +2 dice to hit an immobilized-but-struggling target;\n  attacks auto-hit a completely immobilized target.\n- **Knockdown** — Dexterity + Athletics: success = get up (initiative −2 next\n  turn); failure = spend next action rising; botch = 1 automatic bashing.\n- **Stake Through Heart** — target the heart (**difficulty 9**); 3+ health levels\n  of damage immobilizes a vampire (conscious, Auspex usable, can't move or spend\n  blood) until the stake is removed.\n\n## Weapons (p. 280)\n\n**Melee:**\n| Weapon | Damage | Conceal |\n|---|---|---|\n| Sap+ | Str +1 | P (pocket) |\n| Club+ | Str +2 | T (trenchcoat) |\n| Knife | Str +1 | J (jacket) |\n| Sword | Str +2 | T |\n| Axe | Str +3 | N (none) |\n| Stake* | Str +1 | T |\n\n+ Blunt objects inflict bashing unless head-targeted (then lethal).\n* May paralyze a vampire through the heart (diff 9, 3 damage successes).\n\n**Ranged** (Damage / Range / Rate / Capacity / Conceal):\n- Revolver, Lt. (SW Bodyguard .38) 4 / 12 / 3 / 6 / P\n- Revolver, Hvy. (Ruger Redhawk .44) 6 / 35 / 2 / 6 / J\n- Pistol, Lt. (HK USP 9mm) 4 / 20 / 4 / 15+1 / P\n- Pistol, Hvy. (Springfield XDM .45) 5 / 25 / 3 / 13+1 / J\n- Rifle (Beretta Tikka T3 30.06) 8 / 200 / 1 / 3+1 / N\n- SMG, Small (Glock 18)* 4 / 20 / 3 / 17+1 / J\n- SMG, Large (HK MP5)* 4 / 50 / 3 / 30+1 / T\n- Assault Rifle (FN SCAR)* 7 / 150 / 3 / 30+1 / N\n- Shotgun (Remington 870) 8 / 20 / 1 / 5+1 / T\n- Shotgun, Semi-auto (Benelli M4) 8 / 20 / 3 / 6+1 / T\n- Crossbow** 5 / 20 / 1 / 1 / T\n\n* Capable of 3-round burst, full-auto, and spray. ** For staking; 5-turn\nreload; bashing vs Kindred unless aimed at head/heart, lethal vs mortals.\n\n**Firearms vs vampires:** considered **bashing** unless the head is targeted\n(difficulty 8), then **lethal**. Vs mortals, always lethal.\n"
    },
    {
      "title": "Damage, Health & Blood",
      "filename": "appendix_damage_health_blood.md",
      "content": "# Appendix — Damage, Soak, Health, Blood Pool, Willpower (V20 Core)\n\nSource: **V20 Core Rulebook** Chapter Six: Systems and Drama, pp. 266–295. Light\nformat: cost, pool, difficulty, and effect. This appendix covers the Scholar's\n**resource economy** — blood, Willpower, health, and damage — which interacts\nwith every Discipline power in Parts I–IV.\n\n## Damage types (pp. 272, 284)\n\nThree types; applied to the Health chart in order: aggravated on top, lethal\nbelow it, bashing below that (aggravated always marked above lethal above\nbashing; normal damage is marked last and heals first).\n\n| Type | Mark | Soak (mortal) | Soak (vampire) | Healing |\n|---|---|---|---|---|\n| Bashing | / | full Stamina | Stamina (+ Fortitude), then **halved** (round down) | fast |\n| Lethal | X | none | Stamina (+ Fortitude) | blood (1 BP/level) |\n| Aggravated | * | (treated as lethal) | **only Fortitude** | 5 BP + full day rest |\n\n- Damage dice pools never drop below **1 die**; damage and soak rolls can't\n  botch.\n- **Firearms vs vampires** = bashing unless head-targeted (diff 8), then lethal.\n- Incapacitated + more bashing/lethal → **torpor**; Incapacitated + aggravated →\n  **Final Death**.\n\n## Soak (p. 272)\n\nSoak pool = **Stamina**, plus **Fortitude** vs bashing/lethal; **only Fortitude**\nvs aggravated. Reflexive, default difficulty **6**, each success subtracts one die\nof damage. Never botches, only fails.\n\n## Health levels (pp. 282–283)\n\nSeven levels: Bruised, Hurt, Injured, Wounded, Mauled, Crippled, Incapacitated.\n\n| Health Level | Dice Pool Penalty | Movement |\n|---|---|---|\n| Bruised | 0 | none |\n| Hurt | −1 | none |\n| Injured | −1 | halve max running speed |\n| Wounded | −2 | may not run (walk only); move *or* attack, not both |\n| Mauled | −2 | hobble 3 yds/m per turn |\n| Crippled | −5 | crawl 1 yd/m per turn |\n| Incapacitated | — | no movement; only spend blood to heal |\n\nThe wound penalty subtracts from every action pool **except reflexive actions**\nsuch as soak. **Incapacitated**: collapses; further damage → torpor (or Final\nDeath if aggravated). **Torpor**: deathlike trance, cannot act or spend blood.\n\n**Torpor length** (from wounds) by Humanity/Path: 10 = 1 day; 9 = 3 days; 8 =\n1 week; 7 = 2 weeks; 6 = 1 month; 5 = 1 year; 4 = 1 decade; 3 = 5 decades; 2 =\n1 century; 1 = 5 centuries; 0 = millennium+. Rise requires a **Perception\n(diff 8)** roll to notice disturbances and a **Humanity/Path (diff 8)** roll to\nwake; each success = 1 turn of activity, 5 = fully awake for the scene. A vampire\nwoken from torpor is at **Crippled** and must feed or spend blood immediately.\nVoluntary torpor: half the mandatory time, needs an Awakening roll.\n\n**Optional rule — Extras**: nameless STC thugs get only 4 health levels (Hurt −1,\nMaimed −3, Incapacitated, Dead).\n\n## Vampire healing (pp. 268, 285)\n\n- **Bashing/lethal**: spend **1 blood point per health level**, 1 BP per turn\n  (or more per turn by Generation). Requires concentration/rest — healing while\n  acting needs a reflexive **Stamina + Survival (diff 8)**; failure wastes the\n  blood, botch also costs an extra BP + an extra health level.\n- **Aggravated**: a full day of rest + **5 blood points** per level; additional\n  aggravated levels after the first day cost **5 BP + 1 Willpower** each.\n- Blood is the **only** way vampires heal; they never recover naturally.\n\n## Mortal healing times (pp. 285–286)\n\n**Bashing** (Bruised to Wounded 1 hour; Maimed 3 hours; Crippled 6 hours;\nIncapacitated 12 hours). **Lethal** (Bruised 1 day; Hurt 3 days; Injured 1 week;\nWounded 1 month; Maimed 2 months; Crippled 3 months; Incapacitated 5 months).\nUntreated lethal wounds past Hurt worsen 1 level/day; Crippled/Incapacitated need\nmedical care to recover.\n\n## Blood pool (pp. 268–270)\n\n- Spend **1 BP every night** on rising (whether or not the vampire goes out).\n- A vampire may spend only a **certain number of BP per turn** by Generation\n  (the Scholar, 8th gen: **15 BP pool, 3 BP/turn** — established project canon).\n- **Healing** = 1 BP per bashing/lethal level (see above).\n- **Physical Attributes**: spend 1 BP to raise one Physical Attribute\n  (Strength/Dexterity/Stamina) **+1 for the scene**, up to **one above the\n  Generational max** (8th gen max 5 → freely up to 6). Each dot above the max\n  lasts **3 turns** after blood stops being spent. **No attribute may exceed 10.**\n  Spend up to the per-turn limit; announce at the start of the turn.\n- **Disciplines** and **blood magic** fuel from the pool.\n- **Appearing human**: spend (8 − Humanity) BP for a scene (automatic for\n  Humanity 8+; Humanity-path only, not Paths).\n- **Ghouls**: gifting vitae makes a mortal/animal a ghoul while it's in their\n  system. **Blood bonds**: three drinks over three nights = a blood bond.\n- **Feeding**: up to **3 BP per turn** from a vessel; a human holds 10 BP (take\n  2 safely, 5 = hospitalization, 10 = death). The **Kiss** makes most victims\n  helpless (Willpower 9+ may resist; Kindred can resist with **Self-Control/\n  Instincts diff 8**).\n- **Frenzy cap**: a Self-Control/Instincts roll may never use more dice than the\n  character's **current blood pool**.\n\n**Blood pool of vessels** (BP): vampire 10+, werewolf 20, average human 10,\nchild 5, cow 5, dog 2, cat 1, plasma bag 1, bird ½, bat/rat ¼. Wounded humans\nhold 1 fewer BP per health level; they regain 1 BP/day.\n\n**Elder/animal/werewolf blood**: elder or werewolf blood is so concentrated that\neach BP taken may count as 2+ normal BP. Animal blood yields less than volume.\n\n## Willpower (pp. 266–267)\n\nWillpower has a **permanent rating** (rolled) and a **temporary pool** (spent).\nThe Scholar: **WP 5 / 5**.\n\n**Spending:**\n- **1 WP = 1 automatic success** on a single action (once per turn; cannot be\n  canceled by botches; declared before rolling; ST may forbid on some actions).\n- **1 WP** to avoid an instinctive/reactive action (leaping back from a chasm,\n  sunlight, etc.).\n- **1 WP** to suppress a derangement for a time (Malkavians can never overcome\n  their initial one).\n- **1 WP** to **ignore wound penalties for one turn** (incapacitated/torpid\n  vampires can't).\n- **1 WP** to abort to a defensive action in combat.\n\n**Regaining:** pool refills fully at the **end of a story** (not session); ST\noptions: +1/night on rising, rewards for extraordinary goals, +1–3 for fulfilling\nthe Nature archetype. The pool can never exceed the rating; the rating rises only\nwith experience.\n\n## Frenzy & Rötschreck (pp. 297–299)\n\n**Frenzy** — the Beast takes over: ignore wound penalties until it ends; +2\ndifficulty to Dominate/mentally control a frenzied vampire (and −2 to resist such\ncontrol); immune to Rötschreck; no Willpower rolls needed.\n\n- Resist with **Self-Control** (or Instincts) vs difficulty 6–8 (or **9 −\n  Conscience** if the act is blatantly evil). **5 successes** = fully resist;\n  fewer = resist 1 turn per success (re-roll to keep resisting); **failure** =\n  frenzy; **botch** = frenzy until ST decides + possible derangement.\n- During frenzy, 1 WP lets the player control one action for one turn.\n- Frenzy difficulty by provocation: smell of blood (hungry) 3; sight of blood 4;\n  harassment 4; life-threatening 4; malicious taunts 4; physical provocation 6;\n  taste of blood 6; loved one in danger 7; public humiliation 8.\n\n**Rötschreck (Red Fear)** — fear of fire/sunlight: resist with **Courage** (5\nsuccesses to fully ignore; fewer = overcome for a time). Failure = mad flight,\ntearing through anything in the way; restraint triggers an attack; 1 WP controls\none action for a turn; botched Courage = frenzy until ST decides. Difficulty by\nprovocation: lighting a cigarette 3; sight of a torch 5; bonfire 6; obscured\nsunlight 7; being burned 7; direct sunlight 8; trapped in a burning building 9.\n\n## Sunlight & fire (pp. 296, 301–302)\n\n- **Fire**: aggravated damage. Fortitude soaks; other vampires may frenzy from\n  fire.\n- **Sunlight**: aggravated; only **Fortitude** soaks (pool = Fortitude rating);\n  difficulty and damage depend on light intensity and protection. Direct\n  sunlight sears to ash; any vampire looking directly into it is **blinded\n  instantly**. Diffuse/obscured sunlight still burns (Courage diff 7). Vampires\n  submerged in shallow water have cloud-cover-equivalent protection.\n\n## Blood bond (pp. 286–287)\n\nThree drinks over three nights = full blood bond to the regnant.\n- **1st drink**: strong feelings, no mechanical effect (all childer are 1-drink\n  bonded to sires).\n- **2nd drink**: behavior influence; Willpower roll needed for directly harmful\n  actions; social rolls vs the thrall at −1 difficulty.\n- **3rd drink**: full bond — regnant may Dominate the thrall **without eye\n  contact** (voice is enough); the thrall resists mental control at +2\n  difficulty (Generation limits still apply). Lesser bonds are wiped out.\n- **Resisting**: Willpower roll (typically diff 8, max 9) accumulating successes\n  equal to the number of drinks, then spend 1 WP; negates the bond for a scene\n  (plotting) to a turn (physical attack).\n- **Breaking**: no contact for **(12 × Willpower) months** reduces the bond one\n  level; repeated reductions to zero unlink it. Killing the regnant shatters the\n  bond (ST discretion on the aftermath).\n\n## The Vaulderie / Vinculum (pp. 288–289)\n\nSabbat rite mixing all pack members' vitae; creates Vinculi (blood-ties), rated\n1–10 per relationship. Ratings change on each rite (roll a die; higher than the\nscore = +1, a 1 = −1). Effects at 10 = willing to give/life take life; 9 = nearly\nanything; 8 = resources/assistance; 7 = moderate risk, may kill for; 6 = fight\nfor; 5 = help if convenient; 4 = aid if no risk; 3 = loyalty that doesn't\ninterfere; 2 = minor kinship; 1 = don't care. Vinculi **never fade**; a Vaulderie\n(with ≥1 BP left and 6 points of Vaulderie vitae drunk) can erode a blood bond,\nbut blood bonds can't easily erase Vinculi.\n\n## Diablerie (pp. 293–294)\n\n- Drain the victim of all blood, then an **extended Strength roll (diff 9)**;\n  each success = 1 automatic aggravated health level on the victim (cannot soak).\n- The diablerist is **vulnerable**: all attacks vs them at difficulty 2.\n- Success: **Self-Control/Instincts (diff 10 − Humanity/Path)** to avoid losing\n  control; if the victim was lower Generation, the diablerist's **Generation\n  drops by one permanently**.\n"
    },
    {
      "title": "Actions & Turn Sequence",
      "filename": "appendix_actions.md",
      "content": "# Appendix — Action Resolution: Simple, Extended, Resisted, Reflexive, Multiple, Teamwork (V20 Core)\n\nSource: **V20 Core Rulebook** Chapter Five (pp. 246, 248, 251–253) and Chapter\nSix (p. 257). Light format: what each action type is, when to use it, and the\nexact resolution rule. The Scholar's own action economy lives here.\n\n## Simple actions (p. 246)\n\nOne action = one turn, resolved with one roll; one success is usually enough\n(marginal). Anything that could produce an interesting outcome is an action;\nspeaking and conversation are generally free.\n\n## Reflexive actions (pp. 246, 250)\n\nA significant action that takes no appreciable time and doesn't count as \"taking\nan action.\" You may perform **any number** of reflexive actions per turn **with\nno penalty**, breaking the normal action sequence as needed. Only requirement:\nbe conscious/able to choose.\n\n**Examples from the core rules:**\n- **Spending blood** to raise an Attribute (no roll, under a second).\n- **Soaking** damage from an attack.\n- **Humanity / Path rolls** (they may then lead to standard actions).\n- **Aborting** to a defensive action (a Willpower roll to abort is reflexive).\n- A **Stamina + Survival reflexive roll (difficulty 8)** if the vampire tries to\n  heal *while doing other things* (instead of concentrating one full turn).\n\n## Multiple actions (pp. 248, 257)\n\nTo do more than one thing in a turn: **declare the total number of actions**,\ntake the **smallest dice pool among them**, and **divide that many dice among all\nthe actions** as you see fit.\n\n- **Celerity**: extra actions (up to Celerity dots, 1 BP each) are taken\n  **without subtracting dice** from the pools. These extra actions may not\n  themselves be split, and must be physical.\n- ST discretion: wildly disparate combinations may add a difficulty increase,\n  and some splits may be flatly impossible.\n- Defensive-only turns: use block/dodge/parry rules instead of splitting (first\n  defense full pool, **−1 die cumulative** per subsequent defense in the turn).\n- Multiple opponents in close combat: attack **and** defense difficulties +1\n  cumulative per extra opponent (max +4).\n- Ready a weapon or get to your feet while doing something else = a multiple\n  action (Dexterity + Melee/Firearms diff 4 to ready; Dexterity + Athletics diff\n  4 to rise).\n\n## Extended actions (pp. 251–252)\n\nUsed when a task needs **multiple successes** (more than a marginal success) or\ntakes longer than one interval. Roll the dice pool **repeatedly at successive\nintervals**, accumulating successes toward the target number.\n\n- **The interval is whatever the ST sets** — a turn, an hour, a night, a week\n  (e.g., one Wits + Finance roll per night to raise money).\n- **A botch** usually forces starting over from scratch (plus a catastrophe),\n  and the ST may rule you can't retry at all.\n- Extended + resisted: each turn, only the successes **in excess of the rival's\n  total** that turn are added to a running tally; first to the target total wins\n  (chases, debates, races).\n\n## Resisted actions (p. 252)\n\nTwo characters roll against each other; **the most successes wins**, but you only\nscore **the amount by which you exceed the opponent's successes** (their\nsuccesses cancel yours exactly like 1s). So 4 vs 3 = 1 net success (marginal).\nThe loser's roll still diminishes the winner's result.\n\n- **Difficulty** for a resisted roll is often **one of the opponent's Traits**\n  (e.g., difficulty = the target's Willpower).\n- Sneaking = Dexterity + Stealth vs Perception + Alertness (both diff 6 unless\n  modified).\n- Fast-talk = Manipulation + Subterfuge vs target's Willpower (both diff 6).\n- Ambush = Dexterity + Stealth vs Perception + Alertness; extra successes add to\n  the attacker's attack pool.\n\n## Teamwork (pp. 252–253)\n\nTwo or more characters each roll their **own** dice pool (never combine Traits\ninto one pool) and **add their successes together**. Usually for extended\nactions (staking out a target, decoding an inscription, restraining a frenzied\nGangrel, lifting something together).\n\n- **Hindrance** in most social interaction (fast-talking, seducing) — too many\n  people overwhelm a single subject.\n- **One person's botch can bollix the whole attempt.**\n\n## The four action types (p. 253, summary)\n\n| Type | When | How |\n|---|---|---|\n| **Simple** | task completes in one roll | ST sets difficulty; roll; automatic success possible |\n| **Extended** | a given number of successes needed | roll at intervals, accumulate successes (more botch chances) |\n| **Resisted** | a contest of skill | compare successes; most wins, excess only |\n| **Extended + Resisted** | a contest needing a target total | running tally of net-successes-per-turn; first to total wins |\n\n## Automatic feats (p. 257)\n\nThings that take an action but normally need no roll: **blood use** (healing,\naugmenting Attributes — see blood appendix), **getting to your feet**, **walking/\njogging/running**, **reading a weapon**, **starting a car**, **yielding**.\n"
    },
    {
      "title": "Dice & Difficulties",
      "filename": "appendix_rules_dice.md",
      "content": "# Appendix — Dice Pools, Difficulties & Automatic Success (V20 Core)\n\nSource: **V20 Core Rulebook** Chapter Five: Rules (pp. 245–255). Light format:\npool, difficulty, and effect for each core mechanic. **No example dice** — these\nare the Scholar's *own usable* core mechanics, and the fixed rolling convention\nis described in the master index header (`SCHOLAR_MECHANICS.md`).\n\n## Rolling dice (v20_core pp. 246–247)\n\n- Vampire uses **10-sided dice**. You roll dice whenever the outcome of an\n  action is in doubt; if a roll can't create multiple interesting outcomes, the\n  Storyteller should skip it.\n- A die result **equal to or greater than the difficulty** is a success. A\n  **10 always succeeds**, no matter the difficulty.\n- **1s cancel successes** one-for-one. If more 1s than successes and **no**\n  successes at all → **botch**. If at least one success was scored, even if\n  canceled to net zero, it's a plain **failure**, not a botch.\n- **One success** = marginal success (you barely manage). **Three or more** =\n  complete success. Degrees: 1 marginal, 2 moderate, 3 complete, 4 exceptional,\n  5+ phenomenal.\n\n## Dice pools (p. 247)\n\n- Roll **one die per dot** of the relevant Trait. Most rolls combine an\n  **Attribute + Ability** (e.g. Manipulation 3 + Subterfuge 2 = 5 dice).\n- Pure rolls (Strength to lift, Humanity to test degeneration, Willpower) use\n  the single Trait alone.\n- **A dice pool involving a Trait whose max rating is 10 (Humanity, Path,\n  Willpower) cannot be combined with any other Trait** — normal characters can\n  never roll more than 10 dice.\n- The Scholar's standard pools: Attribute + Ability = **10 dice** (all 5s);\n  pure Attribute / pure Willpower = **5 dice**.\n\n## Difficulties (pp. 247, 250)\n\nDifficulty is always between 2 and 10 (usually 3–9). **6 is the default** if no\ndifficulty is given. A 10 result is always a success regardless.\n\n| Difficulty | Meaning | Example |\n|---|---|---|\n| 3 | Trivial | scanning a small crowd for a familiar face |\n| 4 | Easy | following a trail of blood |\n| 5 | Straightforward | seducing someone already \"in the mood\" |\n| 6 | Standard (default) | firing a gun |\n| 7 | Challenging | locating where the whispers come from |\n| 8 | Difficult | convincing a cop it isn't your cocaine |\n| 9 | Extremely difficult | walking a tightrope |\n\nAt difficulty 10 the probability curve becomes anomalous (botch likelihood can\nrise with bigger pools) — assign with care.\n\n## Degrees of success (p. 247)\n\n| Successes | Degree | Example |\n|---|---|---|\n| 1 | Marginal | keeping a broken fridge running until the repairman arrives |\n| 2 | Moderate | a handicraft that's ugly but useful |\n| 3 | Complete | fixing something good as new |\n| 4 | Exceptional | improving efficiency while repairing |\n| 5+ | Phenomenal | creating a masterwork |\n\n## Failure (p. 249)\n\nZero net successes = the action fails. Failure is *just* failure — the attempt\ndidn't produce the desired result; it doesn't automatically hurt the character\nunless circumstances say otherwise.\n\n## Botches (pp. 249–250)\n\nBotch = **no successes AND one or more 1s**. A botch is dramatic misfortune,\nruled by the Storyteller (dropped gun, enraged animal, revealing a lie, a chase\ngone wrong). Optional: the ST may give everyone one \"free\" botch per session\nthat doesn't count.\n\n## Automatic success (p. 250)\n\n- If **dice pool ≥ difficulty**, the character succeeds automatically **without\n  rolling** — for mundane tasks only. **Never works in combat or other\n  stressful situations.** It counts as a marginal (1-success) result; you may\n  still roll to chase extra successes.\n- **Willpower**: spending **1 Willpower point** grants **1 automatic success**\n  on a single roll. Once per turn. The success **cannot be canceled, even by\n  botches** (1s). Must be declared **before** rolling; cannot be used to\n  retroactively cancel a botch. The ST may disallow it on certain actions\n  (e.g., attacking in combat).\n- A **10** may also count as 2 successes if the action falls within the\n  character's **specialty** (p. 96).\n\n## Trying it again (p. 251)\n\nFailed a roll you may retry? Then each subsequent attempt in the same endeavor\nsuffers **+1 difficulty** (first retry +1, second +2, etc.) until impossible.\nST discretion: doesn't apply to stress-situations (missing a gunshot, failing to\ndetect an ambush), where retries are expected.\n\n## Ratings (p. 247)\n\nTraits are rated in **dots 1–5** (0 = never learned; some exceptions like a\nNosferatu's Appearance). 1 poor, 2 average, 3 good, 4 exceptional, 5 superb.\n\n## Time units (p. 254)\n\n- **Turn** — 3 seconds to ~3 minutes, one simple action.\n- **Scene** — action at one location; as many turns as it takes.\n- **Chapter** — one game-session segment; scenes linked by downtime.\n- **Story** — a full tale (may span chapters).\n- **Chronicle** — the connected series of stories.\n- **Downtime** — time glossed over with description rather than played turn by\n  turn.\n\n## Skill defaulting (p. 257)\n\nFor rolls using **Talents and Skills**, a character lacking the Ability may\n**default to the base Attribute**, but **Skill-based actions are at +1\ndifficulty**. (Knowledges can't be defaulted.)\n"
    },
    {
      "title": "Social & Influence Rolls",
      "filename": "appendix_social_rolls.md",
      "content": "# Appendix — Social Rolls & Social Combat (V20 Core)\n\nSource: **V20 Core Rulebook** Chapter Six: Systems and Drama, pp. 263–266 (Social\nFeats), plus the resisted-action rules from Chapter Five (p. 252). Light format:\npool, difficulty, resisted-vs, and effect. **Roleplaying supersedes rolls** — the\nrules are a fallback when a social moment is genuinely in doubt.\n\n## General principles (pp. 263, 252)\n\n- Social tasks use a **Social Attribute + Ability** pool, usually resisted\n  against a target Trait (most often **Willpower**).\n- **Resisted action**: net successes = your successes minus the opponent's;\n  extra successes often add detail/leverage.\n- If **extra successes exceed the target's permanent Willpower**, the target\n  \"folds completely\" (full confession, total submission, etc.).\n- **Teamwork hurts** most social attempts (too many cooks overwhelm one subject).\n- On a botch the character looks foolish/credible-loss; the ST rules the\n  outcome.\n\n## Social feats (pp. 263–266)\n\n### Carousing — Charisma + Empathy\nDifficulty typically **6** (higher for large/surly groups; certain Natures\nadjust it). Relax targets, loosen tongues, make instant allies. Botch = you come\noff as an obnoxious boor (people wonder why you never touch food/drink).\n\n### Credibility — Manipulation + Subterfuge (perpetrate) / Perception + Subterfuge (detect)\nScam or detect one (impersonation, forged papers, false credentials).\nDifficulty typically **7** for both sides; the \"marks\" must roll higher than the\nperpetrator to detect the deception. Props/forgeries raise the difficulty of\nuncovering it; teamwork can help reveal it. Botch = the plan falls apart.\n\n### Fast-Talk — Manipulation + Subterfuge vs target's Willpower\n**Resisted** (both difficulty **6**); whoever scores more successes wins. Tie =\nmore babbling needed. Botch = you anger the target and ramble to no effect.\n\n### Interrogation\n- **Peaceful (Manipulation + Empathy)** — resisted vs the subject's Willpower\n  (both diff **6**). Rolls at key points of questioning.\n- **Violent (Manipulation + Intimidation)** — resisted vs the target's\n  **Stamina + 3 or Willpower (whichever is higher)**. Physical torture costs the\n  subject **1 health level per turn**; mental torture **1 temporary WP per\n  turn**; both together is devastating. Botch can destroy the subject's body or\n  mind.\n- Two interrogators may combine successes (good cop/bad cop works even mixing\n  Empathy and Intimidation). Extra successes = additional revealed information;\n  exceeding the victim's permanent Willpower = full confession.\n\n### Intimidation — Manipulation + Intimidation, or Strength + Intimidation\n- **Passive**: no roll; higher Intimidation = wider berth in public.\n- **Subtle** (perceived threat): **Manipulation + Intimidation** resisted vs the\n  subject's **Willpower** (both diff **6**); the subject must beat your successes\n  or be cowed.\n- **Blatant** (direct physical threat): **Strength + Intimidation** (diff **6**)\n  resisted vs the subject's **Willpower or Strength + Intimidation (higher)**.\n  Botch = you look patently ridiculous for the rest of the scene.\n\n### Oration — Charisma + Leadership\nDifficulty typically **6**, raised for huge/cynical/hostile audiences. Hit or\nmiss. Preparing a speech (Intelligence + Expression, diff 7) lowers the oration\ndifficulty by 1 on success (raises it on a botch).\n\n### Performance — Charisma + Performance\nDifficulty **7** (raised by audience mood / complexity). 1 success = enjoyable\nbut uninspired; more = truly memorable. Botch = forgotten lines, wrong chord,\nflub.\n\n### Seduction — three-stage resisted process\n1. **Approach** — Appearance + Subterfuge vs difficulty (subject's **Wits + 3**);\n   each success beyond the first adds a die to the next roll.\n2. **Witty repartee** — Wits + Subterfuge vs difficulty (subject's\n   **Intelligence + 3**); each success beyond the first adds a die to the final\n   roll.\n3. **Intimate conversation** — Charisma + Empathy vs difficulty (subject's\n   **Perception + 3**); success = the subject is enamored and goes somewhere\n   private.\n\nBotch at any stage usually ends with a drink in the vampire's face.\n\n## Example social rolls (p. 255)\n\n- Dexterity + Etiquette (diff 8) — flawless manners at a formal dinner.\n- Charisma + Intimidation, resisted by the rival's Charisma + Intimidation —\n  a glare-off with the gang leader.\n- Manipulation + Intimidation (diff 8) — a veiled threat at Elysium.\n- Perception + Intimidation (diff 5) — reading whether a Lick just threatened you.\n- Manipulation + Expression, resisted by a rival's Manipulation + Expression —\n  whose story the Prince believes.\n- Charisma + Law (diff 8) — pleading for release before sunrise.\n- Charisma + Streetwise (diff 8) — picking up word on a new gang (extended, one\n  roll per night).\n\n## Social conflict at scale\n\n- **Extended + resisted** social contests (a long seduction, a debate before\n  assembled Elysium, a cat-and-mouse negotiation): net-successes-per-turn are\n  tallied; the first to the target total wins (p. 252).\n- **Blood bond / Presence leverage**: a 2-drink bond makes social rolls vs the\n  thrall at **−1 difficulty**; a full bond allows Dominate by voice alone and\n  mental-control resistance at **+2 difficulty** (see the damage/blood appendix).\n- **Derangement effects** (from the states-of-being section, pp. 290–293) modify\n  social rolls: **Paranoia** adds +1 difficulty to all interaction rolls;\n  **Megalomania** adds an extra die to all Willpower rolls; **Schizophrenia**\n  adds +3 difficulty to frenzy-resistance rolls and removes 3 dice from all\n  Willpower rolls.\n"
    }
  ],
  "items": [
    {
    ...
    },
    {
      ...
      "conceal": "J",
      "rating": "",
      "notes": "Defensive truncheon-dagger"
    },
    {
      "id": 13,
      "name": "Hook Sword(s)",
    ...
    },
    {
      ...
      "conceal": "P",
      "rating": "",
      "notes": "Armored glove with spikes"
    },
    {
      "id": 26,
      "name": "Hand Claws (Small)",
      "category": "weapon_melee",
      "type": "Fist Extension",
      "damage": "Str+1",
      "damage_type": "L",
      ...
      "conceal": "J",
      "rating": "",
      "notes": "Wolverine-style"
    },
    {
      "id": 27,
      "name": "Hand Claws (Large)",
      "category": "weapon_melee",
      "type": "Fist Extension",
      "damage": "Str+2",
      "damage_type": "L",
    ...
    },
    {
      ...
      "conceal": "N",
      "rating": "",
      "notes": "Gas-powered saw"
    },
    {
      "id": 41,
      "name": "Chair (Improvised)",
      "category": "weapon_melee",
      "type": "Improvised",
      "damage": "Str+2",
      "damage_type": "B",
      ...
      "conceal": "N",
      "rating": "",
      "notes": "Swung at an opponent"
    },
    {
      "id": 42,
      "name": "Table (Improvised)",
      "category": "weapon_melee",
      "type": "Improvised",
      "damage": "Str+3",
      "damage_type": "B",
      ...
      "conceal": "N",
      "rating": "",
      "notes": "Heavy furniture"
    },
    {
      "id": 43,
      "name": "Throwing Knife",
      "category": "weapon_thrown",
      "type": "Thrown",
      "damage": "Str",
      "damage_type": "L",
      "diff": 6,
    ...
    },
    {
      ...
      "conceal": "P",
      "rating": "",
      "notes": "Throwing star; fixed 3 damage"
    },
    {
      "id": 45,
      "name": "Spear",
    ...
    },
    {
      ...
      "conceal": "J",
      "rating": "",
      "notes": "Balanced throwing axe"
    },
    {
      "id": 49,
      "name": "Revolver, Light (.38 Special)",
      ...
      "conceal": "P",
      "rating": "",
      "notes": "Standard snub-nose revolver"
    },
    {
      "id": 50,
      "name": "Revolver, Heavy (.44 Magnum)",
      "category": "weapon_ranged",
      "type": "Pistol",
      "damage": 6,
      "damage_type": "",
      ...
      "conceal": "J",
      "rating": "",
      "notes": "Dirty Harry special"
    },
    {
      "id": 51,
      "name": "Semi-Auto, Light (Glock 17)",
      "category": "weapon_ranged",
      "type": "Pistol",
      "damage": 4,
      "damage_type": "",
    ...
    {
      "id": 52,
      "name": "Semi-Auto, Heavy (Desert Eagle .50)",
      "category": "weapon_ranged",
      "type": "Pistol",
      "damage": 5,
      "damage_type": "",
      ...
      "conceal": "J",
      "rating": "",
      "notes": ".50 AE hand cannon"
    },
    {
      "id": 53,
      "name": "Rifle (Remington M-700)",
      "category": "weapon_ranged",
      "type": "Rifle",
      "damage": 8,
      "damage_type": "",
      ...
      "conceal": "N",
      "rating": "",
      "notes": "Bolt-action sniper rifle"
    },
    {
      "id": 54,
      "name": "SMG, Small (MAC-10)",
      "category": "weapon_ranged",
      "type": "SMG",
      "damage": 4,
      "damage_type": "",
    ...
    },
    {
      ...
      "conceal": "J",
      "rating": "",
      "notes": "Double-barrel, short"
    },
    {
      "id": 58,
      "name": "Shotgun (Ithaca M-37)",
      "category": "weapon_ranged",
      "type": "Shotgun",
      "damage": 8,
      "damage_type": "",
    ...
    },
    {
      ...
      "conceal": "N",
      "rating": "",
      "notes": "Combat shotgun"
    },
    {
      "id": 60,
      "name": "Shotgun, Assault (AA-12)",
      "category": "weapon_ranged",
      "type": "Shotgun",
      "damage": 8,
      "damage_type": "",
      ...
      "conceal": "N",
      "rating": "",
      "notes": "Full-auto shotgun"
    },
    {
      "id": 61,
      "name": "Biggs X-5 Model R",
      "category": "weapon_ranged",
      "type": "Technocracy",
      "damage": 5,
      "damage_type": "",
      ...
      "conceal": "J",
      "rating": "",
      "notes": "Standard Technocracy sidearm"
    },
    {
      "id": 62,
      "name": "Biggs X-5 Model A",
      "category": "weapon_ranged",
      "type": "Technocracy",
      "damage": 5,
      "damage_type": "",
    ...
    },
    {
      ...
      "conceal": "J",
      "rating": "",
      "notes": "Compact tactical crossbow"
    },
    {
      "id": 71,
      "name": "Crossbow",
    ...
    },
    {
      ...
      "conceal": "N",
      "rating": "",
      "notes": "Single-shot grenade launcher"
    },
    {
      "id": 76,
      ...
      "conceal": "N",
      "rating": "",
      "notes": "Automatic grenade launcher"
    },
    {
      "id": 77,
      "name": "Flamethrower",
    ...
    },
    {
      ...
      "conceal": "P",
      "rating": "",
      "notes": "Chemical sedative"
    },
    {
      "id": 82,
      "name": "Ectoplasmic Disruptors",
      "category": "ammo",
      "type": "Special",
      "damage": "5 A",
      "damage_type": "",
      ...
      "conceal": "",
      "rating": "",
      "notes": "Aggravated to spirits/vampires; normal to physical"
    },
    {
      "id": 83,
      ...
      "conceal": "",
      "rating": "",
      "notes": "Mini-grenades; -1 die/yd (max -6); shotguns/Technocrat"
    },
    {
      "id": 84,
      "name": "Flechettes",
      ...
      "conceal": "",
      "rating": "",
      "notes": "Armor -2 vs modern; double vs thick armor; shotguns"
    },
    {
      "id": 85,
      ...
      "conceal": "",
      "rating": "",
      "notes": "2 dice agg for 1 turn after; ignites flammables"
    },
    {
      "id": 86,
      "name": "Rubber Bullets",
    ...
    },
    {
      ...
      "conceal": "",
      "rating": "",
      "notes": "Electrical; Technocratic only"
    },
    {
      "id": 88,
      "name": "Tear Gas Rounds",
      "category": "ammo",
      "type": "Special",
      "damage": "see gas",
      "damage_type": "",
      ...
      "conceal": "",
      "rating": "",
      "notes": "2m radius tear gas; shotguns/Technocratic"
    },
    {
      "id": 89,
      "name": "Teflon Bullets",
      ...
      "conceal": "",
      "rating": "",
      "notes": "Reduce armor protection by 1"
    },
    {
      "id": 90,
      "name": "Laser Sight",
      ...
      "conceal": "",
      "rating": "",
      "notes": "Reduces ranged difficulty by 1"
    },
    {
      "id": 91,
      "name": "Sniper Scope",
      ...
      "conceal": "",
      "rating": "",
      "notes": "+2 dice to first shot pool"
    },
    {
      "id": 92,
      ...
      "conceal": "",
      "rating": "",
      "notes": "Dark only; also see in darkness"
    },
    {
      "id": 93,
      "name": "Computer Targeting",
      "category": "sight",
      "type": "Electronic",
      "damage": "",
      "damage_type": "",
      ...
      "conceal": "",
      "rating": "",
      "notes": "High-tech targeting system"
    },
    {
      "id": 94,
      "name": "Tough Hide",
      ...
      "conceal": "",
      "rating": 1,
      "notes": "Thick skin, fur, or scales"
    },
    {
      "id": 95,
      "name": "Tough Hide (2)",
    ...
    },
    {
      ...
      "conceal": "",
      "rating": "1-4",
      "notes": "Implanted subdermal armor"
    },
    {
      "id": 98,
      ...
      "conceal": "",
      "rating": "1-2",
      "notes": "Kevlar-lined normal clothes"
    },
    {
      "id": 99,
    ...
    },
    {
      ...
      "conceal": "",
      "rating": 5,
      "notes": "Full medieval plate armor"
    },
    {
      "id": 106,
      "name": "Kevlar Vest",
    ...
    },
    {
      ...
      "conceal": "",
      "rating": 7,
      "notes": "Dragon Skin or equivalent"
    },
    {
      "id": 110,
      ...
      "clip": "",
      "conceal": "",
      "rating": "3 (soak) / +1 diff",
      "notes": "Technocratic full body armor"
    },
    {
      "id": 111,
      "name": "Trash Can Lid",
      ...
      "conceal": "",
      "rating": 1,
      "notes": "+1 difficulty to hit wielder"
    },
    {
      "id": 112,
      "name": "Wooden Shield",
      ...
      "conceal": "",
      "rating": 2,
      "notes": "+2 difficulty to hit wielder"
    },
    {
      "id": 113,
      "name": "Metal Shield",
    ...
    },
    {
      ...
      "conceal": "",
      "rating": "",
      "notes": "Armor at half protection"
    },
    {
      "id": 117,
    ...
    {
      "id": 122,
      "name": "Car Bomb (professionally built)",
      "category": "explosive",
      "type": "Vehicle",
      "damage": "",
      "damage_type": "L",
    ...
    },
    {
      ...
      "conceal": "",
      "rating": "",
      "notes": "+ blinding effect"
    },
    {
      "id": 125,
      "name": "Dynamite (per stick)",
      "category": "explosive",
      "type": "Demolition",
      "damage": "",
      "damage_type": "L",
    ...
    },
    {
      ...
      "conceal": "",
      "rating": "",
      "notes": "Burns 10 turns; water won't extinguish"
    },
    {
      "id": 129,
      "name": "Small Rocket (RPG)",
      "category": "explosive",
      "type": "Rocket",
      "damage": "",
      "damage_type": "L",
    ...
    },
    {
      ...
      "conceal": "",
      "rating": "",
      "notes": "Howitzer or mortar round"
    },
    {
      "id": 131,
      "name": "Alcohol",
    ...
    },
    {
      ...
      "conceal": "",
      "rating": 1,
      "notes": "Stimulant; +1 die to physical for scene, then crash"
    },
    {
      "id": 133,
    ...
    },
    {
      ...
      "conceal": "",
      "rating": 4,
      "notes": "Bacterial food poisoning"
    },
    {
      "id": 138,
      "name": "Ammonia",
      ...
      "conceal": "",
      "rating": 4,
      "notes": "Household cleaner; respiratory"
    },
    {
      "id": 139,
      "name": "Bleach",
    ...
    },
    {
      ...
      "conceal": "",
      "rating": 7,
      "notes": "Hemorrhagic fever; cloud transmission"
    },
    {
      "id": 146,
      "name": "Anthrax",
    ...
    },
    {
      ...
      "conceal": "",
      "rating": "",
      "notes": "Full body engulfed"
    },
    {
      "id": 154,
      "name": "Molten Lava / Metal",
      "category": "hazard",
      "type": "Fire",
      "damage": "10/turn",
      "damage_type": "",
      ...
      "conceal": "",
      "rating": "",
      "notes": "Total immolation"
    },
    {
      "id": 155,
      "name": "Wall Socket (electrocution)",
      "category": "hazard",
      "type": "Electrical",
      "damage": "2/turn",
      "damage_type": "",
      ...
      "conceal": "",
      "rating": "",
      "notes": "Household current"
    },
    {
      "id": 156,
      "name": "Protective Fence (electrocution)",
      "category": "hazard",
      "type": "Electrical",
      "damage": "4/turn",
      "damage_type": "",
      ...
      "conceal": "",
      "rating": "",
      "notes": "Security fence"
    },
    {
      "id": 157,
      "name": "Junction Box (electrocution)",
      "category": "hazard",
      "type": "Electrical",
      "damage": "6/turn",
      "damage_type": "",
    ...
    {
      "id": 158,
      "name": "Subway Rail (electrocution)",
      "category": "hazard",
      "type": "Electrical",
      "damage": "8/turn",
      "damage_type": "",
    ...
    },
    {
      ...
      "conceal": "N",
      "rating": "",
      "notes": "M2 Browning heavy machine gun"
    },
    {
      "id": 160,
      "name": "Chemical Fire",
      ...
      "conceal": "",
      "rating": "",
      "notes": "Chemical fire; hard to extinguish"
    },
    {
      "id": 161,
      ...
      "conceal": "",
      "rating": "",
      "notes": "Electrical fire"
    },
    {
      "id": 162,
      "name": "Obsidian Scrying Mirror",
      "category": "ritual_supplies",
      ...
      "conceal": "J",
      "rating": "",
      "notes": "Wrapped in black silk. Used as a focus for Vision of Shadow and Abyss scrying rituals."
    },
    {
      "id": 163,
      "name": "Abyssal Ritual Knife",
      "category": "ritual_supplies",
      "type": "Ritual Supplies",
      "damage": "Str+1",
      "damage_type": "L",
      ...
      "conceal": "P",
      "rating": "",
      "notes": "Dedicated silver-inlaid obsidian blade used for Claiming the Dark and other blood-rites."
    },
    {
      "id": 164,
      "name": "Rosary & Clerical Vestments",
      "category": "ritual_supplies",
      "type": "Ritual Supplies",
      "damage": null,
      "damage_type": null,
      ...
      "conceal": "N",
      "rating": "",
      "notes": "Roman Catholic cassock and collar worn without irony; features an inverted obsidian crucifix and stole embroidered in pre-Vulgate Abyssal script."
    },
    {
      "id": 165,
      "name": "Chest of Confessional Notes",
      "category": "ritual_supplies",
      "type": "Ritual Supplies",
      "damage": null,
      "damage_type": null,
      ...
      "conceal": "J",
      "rating": "",
      "notes": "Blackmail material and intimate sins collected from half the Sabbat pack under the seal of confession."
    }
  ]
};
