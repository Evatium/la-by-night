window.CODEX_DATA = {
  ...
  "npcs": [
    ...
    {
      "id": 22,
      "name": "Victor Temple — Music Mogul Baron",
      "aliases": "The Self-Made Mogul, The Baron of the Valley",
      "concept": "Ventrue music entrepreneur and charismatic Anarch Baron of the San Fernando Valley.",
      "faction": "Anarch",
      "clan": "Ventrue",
      ...
      "tropes": [
        "The Self-Made Mogul",
        "The Maverick Leader",
        "The Father with Secrets"
      ],
      "functions": [
        "Anarch financial engine in the San Fernando Valley.",
        "Club Maharani and Temple of Boom label are his true domains.",
        "Provides sanctuary for Thin-Bloods and Caitiff.",
        "His mortal children are a Masquerade vulnerability."
      ]
    }
  ],
  "locations": [
    {
      ...
      "physical_description": "The Pavilion is a grand, sweeping structure of glass, marble, and curved concrete. Inside, plush red carpets, crystal chandeliers, and wide staircases provide an opulent setting, contrasting the stark realities of Kindred existence.",
      "history": "Established in the 1960s, the Dorothy Chandler Pavilion has stood as a beacon of Los Angeles culture and high society. Under the glittering chandeliers, Kindred elites whisper secrets and broker deals that shape the city's future. It operates as the Prince's primary Elysium, a neutral ground where the Masquerade is paramount and violence is strictly forbidden. Over decades, it has witnessed the rise and fall of countless Kindred factions, cementing its place as the center of formal Kindred society.",
      "characters": [
        {
          "id": 1,
    ...
    },
    {
      ...
      "physical_description": "Hidden behind an unmarked steel door in an alley, the bar features exposed brick walls, dim incandescent lighting, and leather booths. A small stage occasionally hosts spoken-word poetry or jazz.",
      "history": "Opening its doors in the late 1990s as a speakeasy, Bar Afterlife quickly evolved into a high-end downtown establishment. Salvador Garcia curates its operations as an exclusive philosophical salon for the Camarilla. Here, neonates and ancillae alike debate the finer points of the Traditions and Kindred philosophy, free from mortal eavesdropping.",
      "characters": [
        {
          "id": 7,
    ...
    },
    {
      ...
      "physical_description": "A gritty, dimly lit dive bar with scuffed hardwood floors, a battered mahogany bar, and vintage neon beer signs buzzing faintly. Pool tables dominate the back room, and the air is heavy with the smell of stale smoke, spilled liquor, and old blood.",
      "history": "A legendary Anarch stronghold, The Last Round is a local working-class bar serving as a front for community defense militias. Armando 'Nines' Rodriguez established it as a safe haven and rallying point for Kindred who reject the Camarilla's strictures. The bar has weathered numerous raids and skirmishes, its walls bearing the scars of past conflicts. It remains the beating heart of the Anarch movement in LA, where political debates turn into brawls and revolutionary plans are hatched over cheap beer and blood. It is fiercely defended by a loyal cadre of Brujah and unaligned neonates.",
      "characters": [
        {
          "id": 33,
